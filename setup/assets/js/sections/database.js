            ...
            Ext.Ajax.request({
                ...
                success: function (r) {
                    ...
                    if (r.success) {
                        ...
                        Ext.select(
                            "#modx-db-step1-msg span.connect-msg"
                        ).update(r.message);
                        step2.fadeIn();
                        ...
                        if (ch) {
                            ...
                            if (r.object.charsets) {
                                for (
                                    var i = 0;
                                    i < r.object.charsets.length;
                                    i++
                                ) {
                                    MODx.DB.optionTpl.append(
                        ...
                        if (c) {
                            ...
                            if (r.object.collations) {
                                for (
                                    var i = 0;
                                    i < r.object.collations.length;
                                    i++
                                ) {
                                    MODx.DB.optionTpl.append(
                                        "database-collation",
                                        r.object.collations[i]
                                    );
                                }
                            } else {
        ...
        testCollation: function () {
            ...
            Ext.Ajax.request({
                ...
                success: function (r) {
                    ...
                    Ext.select("#modx-db-step2-msg span.result").update(
                        r.message
                    );
                    if (r.success) {
