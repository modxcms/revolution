...
(function () {
                    ...
                    if (el.getBoundingClientRect) {
                        ...
                        while (p) {
                            ...
                            if (Ext.isGecko) {
                                y += bt =
                                    PARSEINT(
                                        pe.getStyle("borderTopWidth"),
                                        10
                                    ) || 0;
                                x += bl =
                                    PARSEINT(
                                        pe.getStyle("borderLeftWidth"),
                                        10
                                    ) || 0;
                        ...
                        if (Ext.isGecko && !hasAbsolute) {
                            dbd = fly(bd);
                            x +=
                                PARSEINT(dbd.getStyle("borderLeftWidth"), 10) ||
                                0;
                            y +=
                                PARSEINT(dbd.getStyle("borderTopWidth"), 10) ||
                                0;
                        }
    ...
    Ext.lib.Event = (function () {
        ...
        var pub = {
            ...
            addListener: function (el, eventName, fn) {
                ...
                if (el && fn) {
                    if ("unload" == eventName) {
                        ret = !!(unloadListeners[unloadListeners.length] = [
                            el,
                            eventName,
                            fn,
                        ]);
        ...
        function handleTransactionResponse(o, callback, isAbort, isTimeout) {
            ...
            if (
                ...
                switch (httpStatus) {
                    ...
                    case 12152:
                    case 13030:
                        responseObject = createExceptionObject(
                            o.tId,
                            callback.argument,
            ...
            request: function (method, uri, cb, data, options) {
                if (options) {
                    ...
                    if (xmlData || jsonData) {
                        initHeader(
                            "Content-Type",
                            xmlData ? "text/xml" : "application/json"
                        );
                        data =
                            xmlData ||
                            (Ext.isObject(jsonData)
                                ? Ext.encode(jsonData)
                                : jsonData);
                    }
                }
    ...
    (function () {
        ...
        EXTLIB.AnimBase.prototype = {
            ...
            getAttr: function (attr) {
                ...
                return !!a[2] ||
                    (el.getStyle("position") == "absolute" && !!a[3])
                    ? el.dom[
                        "offset" +
            ...
            init: function (el, attributes, duration, method) {
                ...
                var onTween = function () {
                    ...
                    for (var attr in ra) {
                        this.setAttr(
                            attr,
                            me.doMethod(attr, ra[attr].start, ra[attr].end),
                            ra[attr].unit
                        );
                    }
                ...
                (me._onComplete = new Ext.util.Event(me)).addListener(
                    onComplete
                );
            },
        };
        ...
        EXTLIB.Bezier = new (function () {
            this.getPosition = function (points, t) {
                ...
                for (j = 1; j < n; ++j) {
                    for (i = 0; i < n - j; ++i) {
                        tmp[i][0] =
                            c * tmp[i][0] + t * tmp[parseInt(i + 1, 10)][0];
                        tmp[i][1] =
                            c * tmp[i][1] + t * tmp[parseInt(i + 1, 10)][1];
                    }
                }
        ...
        (function () {
            EXTLIB.Motion = function (el, attributes, duration, method) {
                if (el) {
                    EXTLIB.Motion.superclass.constructor.call(
                        this,
                        el,
                        attributes,
                        duration,
            ...
            Ext.apply(EXTLIB.Motion.prototype, {
                ...
                doMethod: function (attr, start, end) {
                    ...
                    return pointsRe.test(attr)
                        ? EXTLIB.Bezier.getPosition(
                            me.runAttrs[attr],
                            me.method(me.curFrame, 0, 100, me.totalFrames) /
                                100
                        )
                    ...
                    if (pointsRe.test(attr)) {
                        ...
                        if (isset(to)) {
                            ...
                            for (i = 0, len = control.length; i < len; ++i) {
                                control[i] = translateValues.call(
                                    me,
                                    control[i],
                                    start
                                );
    ...
    (function () {
        ...
        Ext.apply(EXTLIB.Easing, {
            ...
            bounceBoth: function (t, b, c, d) {
                return t < d / 2
                    ? EXTLIB.Easing.bounceIn(t * 2, 0, c, d) * 0.5 + b
                    : EXTLIB.Easing.bounceOut(t * 2 - d, 0, c, d) * 0.5 +
                        c * 0.5 +
                        b;
            },
        });
    ...
    (function () {
        ...
        EXTLIB.ColorAnim = function (el, attributes, duration, method) {
            EXTLIB.ColorAnim.superclass.constructor.call(
                this,
                el,
                attributes,
                duration,
        ...
        Ext.apply(EXTLIB.ColorAnim.prototype, {
            getAttr: function (attr) {
                ...
                if (colorRE.test(attr)) {
                    while (
                        el &&
                        transparentRE.test((val = Ext.fly(el).getStyle(attr)))
                    ) {
                        el = el.parentNode;
                        val = "fff";
                    }
    ...
    (function () {
        ...
        EXTLIB.Scroll = function (el, attributes, duration, method) {
            if (el) {
                EXTLIB.Scroll.superclass.constructor.call(
                    this,
                    el,
                    attributes,
                    duration,
            ...
            addListener: function (eventName, fn, scope, o) {
                ...
                if (ISOBJECT(eventName)) {
                    ...
                    if (typeof ce == "boolean") {
                        me.events[eventName] = ce = new EXTUTIL.Event(
                            me,
                            eventName
                        );
                    }
    ...
    function createHtml(o) {
        ...
        if (typeof o == "string") {
            ...
            for (attr in o) {
                val = o[attr];
                if (
                    !/tag|children|cn|html$/i.test(attr) &&
                    !Ext.isFunction(val)
                ) {
                    if (Ext.isObject(val)) {
                        b += " " + attr + "='";
                        ...
                        b +=
                            " " +
                            ({ cls: "class", htmlFor: "for" }[attr] || attr) +
                            "='" +
                            val +
                            "'";
                    }
    ...
    pub = {
        ...
        insertHtml: function (where, el, html) {
            ...
            if (el.insertAdjacentHTML) {
                ...
                setStart =
                    "setStart" + (/end/i.test(where) ? "After" : "Before");
                if (hash[where]) {
                    range[setStart](el);
                    ...
                    return el[
                        (where == beforebegin ? "previous" : "next") + "Sibling"
                    ];
                } else {
                    rangeEl =
                        (where == afterbegin ? "first" : "last") + "Child";
                    if (el.firstChild) {
    ...
    return {
        ...
        pseudos: {
            ...
            contains: function (c, v) {
                ...
                for (var i = 0, ci; (ci = c[i]); i++) {
                    if (
                        (ci.textContent || ci.innerText || "").indexOf(v) != -1
                    ) {
                        r[++ri] = ci;
                    }
                }
    ...
    El.fly = function (el, named) {
        ...
        if ((el = Ext.getDom(el))) {
            (El._flyweights[named] =
                El._flyweights[named] || new El.Flyweight()).dom = el;
    ...
    (function () {
        ...
        return {
            ...
            findParentNode: function (simpleSelector, maxDepth, returnEl) {
                ...
                return p
                    ? p.findParent(simpleSelector, maxDepth, returnEl)
                    : null;
            },
    ...
    (function () {
        ...
        return {
            ...
            insertAfter: function (el) {
                (el = GETDOM(el)).parentNode.insertBefore(
                    this.dom,
                    el.nextSibling
                );
                return this;
        ...
        return {
            ...
            clearOpacity: function () {
                ...
                if (Ext.isIE) {
                    ...
                    style.opacity = style["-moz-opacity"] = style[
                        "-khtml-opacity"
                    ] = "";
                }
                return this;
...
(function () {
    ...
    Ext.Element.addMethods({
        ...
        setX: function (x, animate) {
            return this.setXY(
                [x, this.getY()],
                animTest.call(this, arguments, animate, 1)
            );
        },
        ...
        setLocation: function (x, y, animate) {
            return this.setXY(
                [x, y],
                animTest.call(this, arguments, animate, 2)
            );
        },
        ...
        getLeft: function (local) {
            return !local
                ? this.getX()
                : parseInt(this.getStyle(LEFT), 10) || 0;
        },
        ...
        getBottom: function (local) {
            var me = this;
            return !local
                ? me.getY() + me.getHeight()
                : me.getTop(true) + me.getHeight() || 0;
        },
                ...
                if (!animate || !me.anim) {
                    ...
                    me.anim(
                        ...
                        function () {
                            if (!visible) {
                                dom.style[
                                    isDisplay ? DISPLAY : VISIBILITY
                                ] = isDisplay ? NONE : HIDDEN;
    ...
    Ext.Fx = {
        ...
        slideIn: function (anchor, o) {
            ...
            me.queueFx(o, function () {
                ...
                arguments.callee.anim = fly(wrap).fxanim(
                    args,
                    o,
                    MOTION,
                    0.5,
        ...
        fadeOut: function (o) {
            ...
            me.queueFx(o, function () {
                arguments.callee.anim = fly(dom).fxanim(
                    ...
                    function () {
                        if (to == 0) {
                            Ext.Element.data(dom, "visibilityMode") ==
                                Ext.Element.DISPLAY || o.useDisplay
                                ? (style.display = "none")
    ...
    Ext.extend(Ext.data.Connection, Ext.util.Observable, {
        ...
        request: function (o) {
            ...
            if (me.fireEvent(BEFOREREQUEST, me, o)) {
                ...
                p = Ext.urlEncode(
                    me.extraParams,
                    typeof p == "object" ? Ext.urlEncode(p) : p
                );
                ...
                return (me.transId = Ext.lib.Ajax.request(
                    method,
                    url,
                    cb,
                    p,
                ...
                return o.callback
                    ? o.callback.apply(o.scope, [o, UNDEFINED, UNDEFINED])
                    : null;
            }
        },
...
Ext.util.JSON = new (function () {
    var useHasOwn = !!{}.hasOwnProperty,
        isNative =
            Ext.USE_NATIVE_JSON && JSON && JSON.toString() == "[object JSON]";
    ...
    this.encode = isNative
        ...
        : function (o) {
            if (typeof o == "undefined" || o === null) {
                ...
                Object.prototype.toString.apply(o) === "[object Date]"
            ) {
