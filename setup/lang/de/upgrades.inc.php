...
$_lang['change_column'] = 'Feld `[[+old]]` in `[[+new]]` geändert in Tabelle `[[+table]]`.';
$_lang['change_default_value'] = 'Standardwert für Spalte `[[+column]]` in [[+value]] geändert in der Tabelle `[[+table]]`.';
...
$_lang['data_remove_error'] = 'Fehler beim Löschen der Daten für Klasse `[[+class]]`.';
$_lang['data_remove_success'] = 'Daten aus der Tabelle für Klasse `[[+class]]` erfolgreich gelöscht.';
$_lang['drop_column'] = 'Spalte `[[+column]]` der Tabelle `[[+table]]` entfernt.';
$_lang['drop_index'] = 'Index `[[+index]]` der Tabelle `[[+table]]` entfernt.';
