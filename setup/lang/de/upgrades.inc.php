 ...
 * @subpackage lexicon
 */
$_lang['add_column'] = 'Neue Spalte `%s` zu `%s` hinzugefügt.';
$_lang['add_index'] = 'Neuen Index für `%s` in der Tabelle `%s` hinzugefügt.';
$_lang['add_moduser_classkey'] = 'Feld `class_key` hinzugefügt, um von modUser abgeleitete Klassen zu unterstützen.';
$_lang['added_cachepwd'] = 'cachepwd-Feld hinzugefügt, das in frühen Revolution-Releases fehlte.';
...
$_lang['allow_null_properties'] = 'Passe allow null für `%s`.`properties` an.';
...
$_lang['change_column'] = 'Feld `%s` in `%s` geändert in Tabelle `%s`.';
$_lang['change_default_value'] = 'Standardwert für Spalte `%s` in %s geändert in der Tabelle `%s`.';
...
$_lang['data_remove_error'] = 'Fehler beim Löschen der Daten für Klasse `%s`.';
$_lang['data_remove_success'] = 'Daten aus der Tabelle für Klasse `%s` erfolgreich gelöscht.';
$_lang['drop_column'] = 'Spalte `%s` der Tabelle `%s` entfernt.';
$_lang['drop_index'] = 'Index `%s` der Tabelle `%s` entfernt.';
$_lang['lexiconentry_createdon_null'] = 'modLexiconEntry: Feld `createdon` geändert, um NULL zu erlauben.';
$_lang['lexiconentry_focus_alter'] = 'modLexiconEntry: `focus` von VARCHAR(100) in INT(10) geändert.';
...
$_lang['rename_column'] = 'Spalte `%s` in `%s` umbenannt in der Tabelle `%s`.';
$_lang['rename_table'] = 'Tabelle `%s` umbenannt in `%s`.';
$_lang['remove_fulltext_index'] = 'Volltext-Index `%s` entfernt.';
$_lang['systemsetting_xtype_fix'] = 'xtypes für modSystemSettings erfolgreich angepasst.';
$_lang['transportpackage_manifest_text'] = 'Spalte `manifest` von MEDIUMTEXT in TEXT geändert in `%s`.';
$_lang['update_closure_table'] = 'Daten der Closure-Tabelle für Klasse `%s` aktualisiert.';
