...
$_lang['test_mysql_version_client_nf_msg'] = 'مادایکس به وسیله تابع ()mysql_get_client_info، موفق به تشخیص نسخه‌ی MySQL client شما نشد. لطفا قبل از ادامه‌ی مراحل، بصورت دستی نسخه‌ی MySQL client خود را پیدا کرده و اطمینان حاصل کنید که برابر یا جدیدتر از نسخه‌ی 4.1.20 باشد.';
...
$_lang['test_mysql_version_client_start'] = 'بررسی نسخه‌ی MySQL client:';
$_lang['test_mysql_version_fail'] = 'مادایکس نیاز به نسخه 4.1.20 یا بالاترِ MySQL دارد. شما در حال حاضر از نسخه‌ی [[+version]] استفاده میکنید. لطفا آن را حداقل به نسخه‌ی 4.1.20 ارتقاء دهید.';
$_lang['test_mysql_version_server_nf'] = 'Could not detect MySQL server version!';
$_lang['test_mysql_version_server_nf_msg'] = 'مادایکس به وسیله تابع ()mysql_get_server_info، موفق به تشخیص نسخه‌ی MySQL server شما نشد. لطفا قبل از ادامه‌ی مراحل، بصورت دستی نسخه‌ی MySQL server خود را پیدا کرده و اطمینان حاصل کنید که برابر یا جدیدتر از نسخه‌ی 4.1.20 باشد.';
$_lang['test_mysql_version_server_start'] = 'بررسی نسخه‌ی MySQL server:';
$_lang['test_mysql_version_success'] = 'بسیار خوب! نسخه‌ی کنونی: [[+version]]';
...
$_lang['test_php_version_success'] = 'بسیار خوب! نسخه‌ی کنونی: [[+version]]';
