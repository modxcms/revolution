...
$_lang['mysql_err_pdo'] = 'MODx membutuhkan driver pdo_mysql ketika asli PDO sedang digunakan dan tidak muncul untuk dimuat.';
$_lang['mysql_version_5051'] = 'MODX akan punya masalah pada MySQL versi ([[+version]]) Anda, karena banyak bug yang berkaitan dengan driver PDO pada versi ini. Silakan upgrade MySQL untuk menambal masalah ini. Bahkan jika Anda memilih untuk tidak menggunakan MODX, dianjurkan Anda meng-upgrade ke versi ini untuk keamanan dan stabilitas dari situs Anda sendiri.';
...
$_lang['mysql_version_client_old'] = 'MODX mungkin memiliki masalah karena Anda menggunakan versi klien MySQL sangat lama ([[+version]]). MODX akan memungkinkan instalasi menggunakan versi klien MySQL ini, tetapi kami tidak dapat menjamin semua fungsi akan tersedia atau bekerja dengan baik ketika menggunakan versi MySQL klien Perpustakaan.';
$_lang['mysql_version_fail'] = 'Anda menjalankan pada MySQL [[+version]], dan MODX revolusi memerlukan MySQL 4.1.20 atau yang lebih baru. Silakan upgrade MySQL ke setidaknya 4.1.20.';
