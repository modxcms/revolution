 ...
 * @subpackage lexicon
 */
$_lang['add_column'] = 'Ditambahkan baru \'[[+ kolom]]\' kolom \'[[+ meja]]\'.';
$_lang['add_index'] = 'Ditambahkan baru indeks pada \' [[+ indeks]]\' untuk tabel \'[[+ meja]]\'.';
...
$_lang['allow_null_properties'] = 'Memperbaiki mengijinkan null untuk \' [[+ kelas]]\'. \'properti\'.';
...
$_lang['change_column'] = 'Berubah \'[[+ tua]]\' bidang untuk \'[[+ baru]]\' di meja \'[[+ meja]]\'.';
$_lang['change_default_value'] = 'Mengubah nilai default untuk kolom \'[[+ kolom]]\' "[[+ nilai]]" pada tabel \'[[+ meja]]\'.';
...
$_lang['data_remove_error'] = 'Error menghapus data untuk kelas \'[[+ kelas]]\'.';
$_lang['data_remove_success'] = 'Berhasil dihapus data dari tabel untuk kelas \'[[+ kelas]]\'.';
$_lang['drop_column'] = 'Menjatuhkan kolom \'[[+ kolom]]\' di meja \'[[+ meja]]\'.';
$_lang['drop_index'] = 'Menjatuhkan indeks \'[[+ indeks]]\' di meja \'[[+ meja]]\'.';
...
$_lang['modify_column'] = 'Diubah kolom \'[[+ kolom]]\' dari \'[[+ tua]]\' untuk \'[[+ baru]]\' di meja \'[[+ meja]]\'';
$_lang['rename_column'] = 'Nama kolom \'[[+ tua]]\' ke \'[[+ baru]]\' di meja \'[[+ meja]]\'.';
$_lang['rename_table'] = 'Mengganti nama tabel \'[[+ tua]]\' ke \'[[+ baru]]\'.';
$_lang['remove_fulltext_index'] = 'Dihapus indeks teks lengkap \'[[+ indeks]]\'.';
$_lang['systemsetting_xtype_fix'] = 'Berhasil tetap xtypes untuk modSystemSettings.';
$_lang['transportpackage_manifest_text'] = 'Dimodifikasi kolom \'nyata\' teks dari MEDIUMTEXT pada \'[[+ kelas]]\'.';
$_lang['update_closure_table'] = 'Memperbarui data tabel penutupan untuk kelas \'[[+ kelas]]\'.';
$_lang['update_table_column_data'] = 'Diperbarui data di kolom [[+ kolom]] meja [[+ meja]] ([[+ kelas]])';