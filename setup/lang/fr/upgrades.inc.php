 ...
 * @subpackage lexicon
 */
$_lang['add_column'] = 'Ajout d\'une nouvelle colonne `%s` à `%s`.';
$_lang['add_index'] = 'Ajout d\'un nouvel index sur `%s` pour la table `%s`.';
...
$_lang['allow_null_properties'] = 'Autorisation de null pour `%s`.`properties` fixée.';
...
$_lang['change_column'] = 'Champ `%s` changé à `%s` dans la table `%s`.';
$_lang['change_default_value'] = 'Valeur par défaut de la colonne `%s` changée en %s dans la table `%s`.';
...
$_lang['data_remove_error'] = 'Erreur de suppression des données de la classe `%s`.';
$_lang['data_remove_success'] = 'Suppression des données de la table pour la classe `%s` effectuée.';
$_lang['drop_column'] = 'Abandon de la colonne `%s` dans la table `%s`.';
$_lang['drop_index'] = 'Abandon de l\'index `%s` dans la table `%s`.';
...
$_lang['rename_column'] = 'Colonne `%s` renommée en `%s` dans la table `%s`.';
$_lang['rename_table'] = 'Table `%s` renommée en `%s`.';
$_lang['remove_fulltext_index'] = 'Index full-text `%s` supprimé.';
$_lang['systemsetting_xtype_fix'] = 'xtypes pour modSystemSettings corrigés avec succès.';
$_lang['transportpackage_manifest_text'] = 'Colonne `manifest` modifiée en TEXT au lieu de MEDIUMTEXT dans `%s`.';
$_lang['update_closure_table'] = 'Mise à jour des données de table de fermeture pour la classe `%s`.';
