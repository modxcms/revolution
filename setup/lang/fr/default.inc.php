...
$_lang['all_languages'] = 'Toutes les langues';
$_lang['only_popular'] = 'Seulement populaire';
...
$_lang['config_key_override'] = 'Si vous souhaitez exécuter le setup sur une autre clé de configuration que celle actuellement spécifiée dans votre <code>setup/includes/config.core.php</code>, veuillez le spécifier ci-dessous.';
...
$_lang['step_welcome'] = 'Bienvenue';
$_lang['step_options'] = 'Options';
$_lang['step_connect'] = 'Connexion';
$_lang['step_test'] = 'Test';
$_lang['step_contexts'] = 'Contextes';
$_lang['step_install'] = 'Installer';
$_lang['step_complete'] = 'Terminé';
$_lang['modx_installer'] = 'Installation de MODX';
...
$_lang['upgrade_version_unsupported'] = 'La mise à jour de MODX [[+version]] n\'est pas prise en charge par cette version. Vous devrez mettre à jour vers MODX 2.6 ou plus avant la mise à jour vers cette version.';
