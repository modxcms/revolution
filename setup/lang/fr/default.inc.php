...
$_lang['context_connector_url'] = 'URL pour le contexte connnecteurs';
...
$_lang['err_update_table'] = 'Erreur de mise à jour de la table pour la classe %s';
...
$_lang['modx_footer1'] = '&copy; 2005-2010 Le projet de Framework de Gestion de Contenu (CMF) <a href="http://www.modxcms.com/" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;"  style="color: green; text-decoration:underline">MODx</a>. Tous droits réservés. MODx est licencié sous GNU GPL.';
...
$_lang['package_err_install'] = 'Impossible d\'installer le paquet %s.';
$_lang['package_err_nf'] = 'Impossible de récupérer les fichiers d\'installation du paquet %s.';
$_lang['package_installed'] = 'Paquet %s installé avec succès.';
...
$_lang['password_err_short'] = 'Votre mot de passe doit contenir au moins 6 caractères.';
...
$_lang['request_handler_err_nf'] = 'Impossible de charger le gestionnaire de demande (à/dans) %s. Vérifiez que vous avez uploadé l\'ensemble des fichiers nécessaires.';
...
$_lang['setup_err_core_comp'] = 'Votre répertoire core/components/ n\'a pas été créé dans: [[+path]] <br />Vous allez devoir créer ce répertoire et le rendre accessible en écriture si vous souahitez utiliser le Gestionnaire de Paquets ou des Composants tierces.';
$_lang['skip_to_bottom'] = 'Dérouler jusqu\'en bas';
$_lang['success'] = 'Succès';
$_lang['table_created'] = 'Table créée avec succès pour la classe %s';
$_lang['table_err_create'] = 'Une erreur est survenue lors de la création de la table pour la classe %s';
$_lang['table_updated'] = 'Table mise à jour avec succès pour la classe %s';
$_lang['test_class_nf'] = 'Impossible de trouver la classe "Install Test" dans: %s <br />Veuillez vérifier que vous avec uploadé l\'ensemble des fichiers nécessaires.';
$_lang['test_version_class_nf'] = 'Impossible de trouver la classe "Install Test Versioner" dans: %s <br />Veuillez vérifier que vous avec uploadé l\'ensemble des fichiers nécessaires.';
...
$_lang['versioner_err_nf'] = 'Impossible de trouver le "Install Versioner" dans: %s <br />Veuillez vérifier que vous avec uploadé l\'ensemble des fichiers nécessaires.';
$_lang['xpdo_err_ins'] = 'Impossible d\'instancier xPDO.';
$_lang['xpdo_err_nf'] = 'MODx n\'a pu trouver la classe xPDO dans %s. Veuillez vérifier qu\'il a été uploadé correctement.';
$_lang['preload_err_cache'] = 'Veuillez vérifier que le répertoire %scache existe et est accessible en écriture par le processus PHP.';
