...
$_lang['options_nocompress_note'] = 'Cochez ceci si le manager ne fonctionne pas avec la compression CSS/JS.';
...
$_lang['package_execute_err_retrieve'] = 'L\'installation a échouée parce que MODX ne peut pas ouvrir le fichier "[[+path]]packages/core.transport.zip". Veuillez vérifier que ce fichier existe et qu\'il est bien inscriptible. De plus, vérifiez que vous avez aussi rendu inscriptible le dossier "[[+path]]packages/".';
