...
$_lang['modx_footer1'] = '&copy; 2005-2011 Le projet de Framework de Gestion de Contenu (CMF) <a href="http://modx.com/" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;"  style="color: green; text-decoration:underline">MODX</a>. Tous droits réservés. MODX est licencié sous GNU GPL.';
