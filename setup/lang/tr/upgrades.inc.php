 ...
 * @subpackage lexicon
 */
$_lang['add_column'] = '`[[+table]]`\'ye `[[+column]] eklenmiştir.';
$_lang['add_index'] = 'Yeni dizin eklendi \' [[+index]] \' tablo için \' [[+table]] \'.';
...
$_lang['change_column'] = 'Değiştirilen \'[[+old]]\' alan \'[[+new]]\' masada \'[[+table]]\'.';
$_lang['change_default_value'] = 'Sütun için varsayılan değer değiştirildi \'[[+column]] \' için "[[+value]]" masada \'[[+table]]\'.';
...
$_lang['drop_column'] = 'Bırakılan sütün \'[[+column]]\' masada \'[[+table]]\'.';
$_lang['drop_index'] = 'Bırakılan dizin \'[[+index]]\' masada \'[[+table]]\'.';
...
$_lang['modify_column'] = 'Değiştirilmiş sütun \'[[+column]]\' itibaren \'[[+old]]\' için \'[[+new]]\' masada \'[[+table]]\'';
$_lang['rename_column'] = 'Yeniden adlandırılmış sütun \'[[+old]]\' için \'[[+new]]\' üstünde \'[[+table]]\'.';
