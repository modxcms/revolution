<?php
/**
 * Test-related Brazilian Portuguese Lexicon Topic for Revolution setup.
 *
 * @package setup
 * @subpackage lexicon
 */
...
$_lang['test_db_setup_create'] = 'Instalação tentará criar o banco de dados.';
$_lang['test_dependencies'] = 'Verificando PHP para dependência zlib: ';
$_lang['test_dependencies_fail_zlib'] = 'Sua instalação do PHP não tem a extensão "zlib" instalada. Essa extensão é necessária para MODX executar. Ative-a para continuar.';
...
$_lang['test_memory_limit'] = 'Verificar se o limite de memória é definida como pelo menos 24M: ';
...
$_lang['test_mysql_version_client_nf_msg'] = 'MODX não conseguiu detectar a sua versão do cliente MySQL através de mysql_get_client_info(). Por favor, faça manualmente certeza de que sua versão do cliente MySQL é pelo menos 4.1.20 antes de prosseguir.';
...
$_lang['test_mysql_version_server_nf_msg'] = 'MODX não conseguiu detectar a sua versão do servidor MySQL através de mysql_get_server_info(). Por favor certifique manualmente de que sua versão do servidor MySQL é pelo menos 4.1.20 antes de prosseguir.';
...
$_lang['test_php_version_516'] = 'MODX terá problemas em sua versão do PHP ([[+version]]), por causa dos muitos erros relacionados aos drivers PDO nesta versão. Por favor, atualize para a versão 5.3.0 do PHP ou superior, que corrige esses problemas. MODX recomenda a atualização para pelo menos 5.3.2+. Mesmo se você optar por não usar MODX, é recomendado que você atualize para esta versão para a segurança e estabilidade do seu próprio site.';
$_lang['test_php_version_520'] = 'MODX terá problemas em sua versão do PHP ([[+version]]), por causa dos muitos erros relacionados aos drivers PDO nesta versão. Por favor, atualize para a versão 5.3.0 do PHP ou superior, que corrige esses problemas. MODX recomenda a atualização para pelo menos 5.3.2+. Mesmo se você optar por não usar MODX, é recomendado que você atualize para esta versão para a segurança e estabilidade do seu próprio site.';
$_lang['test_php_version_start'] = 'Verificando versão do PHP:';
$_lang['test_php_version_success'] = 'OK! Executando: [[+version]]';
$_lang['test_safe_mode_start'] = 'Verificando se o safe_mode está off:';
...
$_lang['test_sessions_start'] = 'Verificando sessões estão configurados corretamente:';
...
$_lang['test_suhosin_max_length'] = 'Suhosin GET valor máximo muito baixo!';
...
$_lang['test_zip_memory_limit'] = 'Verificar se o limite de memória é definida como pelo menos 24M para extensões zip: ';
$_lang['test_zip_memory_limit_fail'] = 'MODX encontrado sua configuração memory_limit estar abaixo a configuração recomendada de 24M. MODX tentou definir o memory_limit para 24M, mas não teve sucesso. Por favor, defina a configuração memory_limit no seu arquivo php.ini para 24M ou superior antes de prosseguir, de modo que as extensões zip pode funcionar corretamente.';