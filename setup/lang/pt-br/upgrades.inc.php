<?php
/**
 * Brazilian Portuguese Upgrades Lexicon Topic for Revolution setup.
 *
 * @package setup
 * @subpackage lexicon
 */
$_lang['add_column'] = 'Adicionada nova coluna `[[+column]]` para a tabela `[[+table]]`.';
$_lang['add_index'] = 'Adicionado novo índice `[[+index]]` para a tabela `[[+table]]`.';
$_lang['add_moduser_classkey'] = 'Campo adicionado class_key apoiar derivados modUser.';
...
$_lang['change_column'] = 'Alterado campo `[[+old]]` para `[[+new]]` na tabela `[[+table]]`.';
$_lang['change_default_value'] = 'Alteardo valor padrão da coluna `[[+column]]` para "[[+value]]" na tabela `[[+table]]`.';
...
$_lang['connector_ctx_not_removed'] = 'Não foi possível remover contexto conector.';
...
$_lang['drop_column'] = 'Caiu coluna `[[+column]]` na tabela `[[+table]]`.';
$_lang['drop_index'] = 'Caiu índice `[[+index]]` na tabela `[[+table]]`.';
...
$_lang['modify_column'] = 'Modificada coluna `[[+column]]` de `[[+old]]` para `[[+new]]` na tabela `[[+table]]`';
$_lang['rename_column'] = 'Renomeada coluna `[[+old]]` de `[[+new]]` na table `[[+table]]`.';
