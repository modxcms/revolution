<?php
/**
 * Brazilian Portuguese language files for Revolution 2.3.0 setup
 *
 * @package setup
 */
...
$_lang['cache_manager_err'] = 'O Gerenciador de Cache MODX não pode ser carregado.';
$_lang['choose_language'] = 'Escolher Língua';
$_lang['cleanup_errors_title'] = 'Aviso Importante:';
$_lang['cli_install_failed'] = 'Instalação Falhou! Erros: [[+errors]]';
$_lang['cli_no_config_file'] = 'MODX não pode encontrar o arquivo de configuração (algo como config.xml) para sua instalação do CLI. Para rodar a instalação do MODX da linha de comando, você deve prover um arquivo de configuração xml. Veja a documentação oficial para mais informações.';
$_lang['cli_tests_failed'] = 'Testes de pré-instalação falharam! Erros: [[+errors]]';
$_lang['close'] = 'fechar';
$_lang['config_file_err_w'] = 'Erro ao escrever arquivo de configuração.';
$_lang['config_file_perms_notset'] = 'Permissões do arquivo de configuração não foram atualizados. Você pode querer mudar as permissões em seu arquivo de configuração para maior segurança contra adulteração.';
$_lang['config_file_perms_set'] = 'Permissões do arquivo de configuração atualizados com sucesso.';
$_lang['config_file_written'] = 'Arquivo de configuração escrito com sucesso.';
$_lang['config_key'] = 'MODX Chave de Configuração';
$_lang['config_key_change'] = 'Se você gostaria de mudar a chave de configuração MODX, <a id="cck-href" href="javascript:void(0);">por favor, clique aqui.</a>';
$_lang['config_key_override'] = 'Se você deseja executar a instalação em uma chave de configuração que não seja o atualmente especificado no seu setup/includes/config.core.php, por favor especifique abaixo.';
$_lang['config_not_writable_err'] = 'Você tentou alterar uma configuração no setup/includes/config.core.php mas o arquivo não é gravável. Faça o arquivo gravável ou edite o arquivo manualmente antes de continuar.';
$_lang['connection_character_set'] = 'Conjunto de caracteres de conexão:';
$_lang['connection_collation'] = 'Agrupamento:';
$_lang['connection_connection_and_login_information'] = 'Conexão de banco de dados e informações de login';
...
$_lang['connection_database_host'] = 'Host Base de dados::';
...
$_lang['connection_default_admin_email'] = 'Email do Administrador:';
...
$_lang['connection_default_admin_password'] = 'Senha do administrador:';
$_lang['connection_default_admin_password_confirm'] = 'Confirmar senha:';
$_lang['connection_default_admin_user'] = 'Usuário Padrão Admin';
$_lang['connection_table_prefix'] = 'Prefixo da tabela:';
$_lang['connection_test_connection'] = 'Testar conexão';
$_lang['connection_title'] = 'Informações da conexão';
$_lang['context_connector_options'] = '<strong>Opções de Conectores</strong> (Serviços de conexão AJAX)';
...
$_lang['dau_err_save'] = 'Erro salvando o usuário administrador padrão.';
$_lang['dau_saved'] = 'Criado usuário administrador padrão.';
$_lang['db_check_db'] = 'Verificando banco de dados:';
$_lang['db_connecting'] = 'Conectando com o servidor de banco de dados:';
$_lang['db_connected'] = 'Conexão com banco de dados bem-sucedida!';
$_lang['db_created'] = 'O banco de dados foi criado com sucesso.';
$_lang['db_err_connect'] = 'Não foi possível conectar ao banco de dados.';
$_lang['db_err_connect_upgrade'] = 'Não foi possível conectar ao banco de dados existente para atualização.  Verifique as propriedades da conexão e tente novamente.';
...
$_lang['db_err_create_database'] = 'MODX não conseguiu criar seu banco de dados. Por favor, crie manualmente o banco de dados e, em seguida, tente novamente.';
$_lang['db_err_show_charsets'] = 'MODX não pôde obter os conjuntos de caracteres disponíveis a partir de seu servidor MySQL.';
$_lang['db_err_show_collations'] = 'MODX não pôde obter os agrupamentos disponíveis a partir de seu servidor MySQL.';
$_lang['db_success'] = 'Sucesso!';
$_lang['db_test_coll_msg'] = 'Criar ou testar a seleção de seu banco de dados.';
$_lang['db_test_conn_msg'] = 'Teste a conexão com o servidor de banco de dados e visualizar agrupamentos.';
$_lang['default_admin_user'] = 'Usuário Padrão Admin.';
...
$_lang['install'] = 'Instalação';
$_lang['install_packages'] = 'Instalar Pacotes';
$_lang['install_packages_desc'] = 'Você pode optar por instalar os pacotes add-on individuais. Depois de ter instalado todos os pacotes opcionais desejadas, pressione Concluir para concluir o processo.';
$_lang['install_packages_options'] = 'Opções de Instalação de Pacote';
$_lang['install_success'] = 'Instalação do Núcleo foi bem sucedida. Clique ao lado para completar o processo de instalação.';
...
$_lang['license'] = '<p class="title">Você deve concordar com a licença antes de continuar a instalação.</p>
    ...
    General Public Licence, não acima. A descrição acima é apenas um resumo da GNU General Public Licence,
...
$_lang['modx_footer1'] = '&copy; 2005-2013 o projeto <a href="http://www.modx.com/" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;">MODX</a> Content Management Framework (CMF). Todos os direitos reservados. MODX está licenciado sob a GNU GPL.';
$_lang['modx_footer2'] = 'MODX é software livre. Nós encorajamos você a ser criativo e fazer uso de MODX da maneira que achar melhor. Apenas certifique-se de que se você fizer alterações e decidir redistribuir seu MODX modificado, que mantenha o código fonte livre!';
$_lang['modx_install'] = 'Instalação MODX';
$_lang['modx_install_complete'] = 'MODX Instalação Concluída';
...
$_lang['please_select_login'] = 'Por favor selecione o botão de "Login" para acessar a tela de gerenciamento.';
...
$_lang['restarted_msg'] = 'MODX tive que reiniciar o processo de instalação como uma medida de segurança porque a instalação estava inativa por mais de 15 minutos. Por favor volte a tentar executar a instalação neste momento.';
$_lang['retry'] = 'Tentar novamente';
$_lang['security_notice'] = 'Aviso de Segurança';
$_lang['select'] = 'Selecionar';
$_lang['settings_handler_err_nf'] = 'MODX não conseguia encontrar a classe modInstallSettings em: [[+path]]. Por favor, certifique-se de ter carregado todos os arquivos.';
...
$_lang['test_version_class_nf'] = 'Could not find the Install Test Versioner class at: [[+path]]<br />Por favor, verifique se você fez upload de todos os arquivos necessários.';
...
$_lang['toggle_success'] = 'Ligar Success Messages';
$_lang['toggle_warnings'] = 'Ligar Warnings';
