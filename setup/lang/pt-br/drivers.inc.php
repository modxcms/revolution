<?php
/**
 * Brazilian Portuguese Drivers Lexicon Topic for Revolution setup
 *
 * @package setup
 * @subpackage lexicon
 */
$_lang['mysql_err_ext'] = 'MODX requer a extensão mysql para o PHP e não parece ter sido carregado.';
$_lang['mysql_err_pdo'] = 'MMODX requer o driver pdo_mysql quando PDO nativo está sendo usado e não parece ter sido carregado.';
