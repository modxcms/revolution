...
$_lang['add_index'] = 'Se añadió el nuevo índice `[[+index]]` a la tabla `[[+table]]`.';
...
$_lang['change_default_value'] = 'Se cambió el valor por defecto para la columna `[[+column]]` a "[[+value]]" en la tabla `[[+table]]`.';
...
$_lang['drop_column'] = 'Se eliminó la columna `[[+column]]` en la tabla `[[+table]]`.';
$_lang['drop_index'] = 'Se eliminó el índice `[[+index]]` en la tabla `[[+table]]`.';
...
$_lang['modify_column'] = 'Se modificó la columna `[[+column]]` de `[[+old]]` a `[[+new]]` en la tabla `[[+table]]`';
