...
$_lang['modx_footer1'] = '© 2005–[[+current_year]] проєкт <a href="https://www.modx.com/" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;">MODX</a> — система керування контентом (CMF). Усі права захищені. MODX ліцензовано відповідно до GNU GPL.';
