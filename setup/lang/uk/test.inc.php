...
$_lang['test_php_version_516'] = 'MODX працюватиме з помилками на Вашій версії PHP  ([[+version]]) через велику кількість помилок у драйверах PDO цієї версії. Будь ласка, оновіть PHP до версії 5.3.0 або вище щоб усунути ці проблеми. MODX рекомендує оновити хоча б до версії 5.3.2+. Навіть якщо Ви не будете використовувати MODX, радимо Вам оновити до цієї версії для збільшення стабільності і безпеки Вашого сайту.';
$_lang['test_php_version_520'] = 'MODX працюватиме з помилками на Вашій версії PHP  ([[+version]]) через велику кількість помилок у драйверах PDO цієї версії. Будь ласка, оновіть PHP до версії 5.3.0 або вище щоб усунути ці проблеми. MODX рекомендує оновити хоча б до версії 5.3.2+. Навіть якщо Ви не будете використовувати MODX, радимо Вам оновити до цієї версії для збільшення стабільності і безпеки Вашого сайту.';
