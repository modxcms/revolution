...
$_lang['authority_unique_index_error'] = 'Виявлено кілька записів modUserGroup з однаковим значенням authority. Необхідно оновити їх так, щоб вони мали унікальні значення authority, після чого повторно запустити оновлення.';
...
$_lang['menu_remove_success'] = 'Пункт меню `[[+text]]` видалено.';
$_lang['menu_remove_failed'] = 'Пункт меню `[[+text]]` не вдалося видалити.';
$_lang['menu_update_success'] = 'Пункт меню `[[+text]]` оновлено.';
$_lang['menu_update_failed'] = 'Пункт меню `[[+text]]` не вдалося оновити.';
...
$_lang['transport_package_installed_update_invalid_dates_failure'] = 'Не вдалося виправити некоректні дати у стовпці Встановлено для Транспортного пакету.';
$_lang['transport_package_installed_update_invalid_dates_success'] = 'Успішно виправлено некоректні дати у стовпці Встановлено для Транспортного пакету.';
