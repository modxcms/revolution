...
$_lang['test_php_version_516'] = 'سيواجه مودكس مشاكل مع نسخة PHP ([[+version]]) بسبب العديد من الأخطاء ذات الصلة ببرامج تشغيل PDO على هذا الإصدار. الرجاء ترقية إصدار PHP إلى 5.3.0 أو أعلى، الذي يحل هذه المشاكل. مودكس ينصح بالترقية على الأقل إلى 5.3.2+. حتى إذا اخترت عدم استخدام مودكس، من المستحسن الترقية إلى هذا الإصدار من أجل الأمن والاستقرار لموقع الويب الخاص بك.';
$_lang['test_php_version_520'] = 'سيواجه مودكس مشاكل مع نسخة PHP ([[+version]]) بسبب العديد من الأخطاء ذات الصلة ببرامج تشغيل PDO على هذا الإصدار. الرجاء ترقية إصدار PHP إلى 5.3.0 أو أعلى، الذي يحل هذه المشاكل. مودكس ينصح بالترقية على الأقل إلى 5.3.2+. حتى إذا اخترت عدم استخدام مودكس، من المستحسن الترقية إلى هذا الإصدار من أجل الأمن والاستقرار لموقع الويب الخاص بك.';
