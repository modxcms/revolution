 ...
 * @subpackage lexicon
 */
$_lang['add_column'] = 'إضاف عمود جديد `[[+column]]`للجدول `[[+table]]`.';
$_lang['add_index'] = 'إضاف فهرس جديد `[[+index]]`للجدول `[[+table]]`.';
...
$_lang['change_column'] = 'تغيير حقل \'[[old+]]\' ل \'[[new+]]\' على الجدول \'[[table+]]\'.';
$_lang['change_default_value'] = 'تغيير القيمة الافتراضية للعمود \'[[column+]]\' ل 
 "[[value+]]" في الجدول \'[[table+]]\'.';
...
$_lang['drop_column'] = 'إسقاط العمود \'[[column+]]\' من الجدول \'[[table+]]\'.';
$_lang['drop_index'] = 'اسقاط الفهرس \'[[index+]]\' على الجدول \'[[table+]]\'.';
...
$_lang['modify_column'] = 'تعديل عمود \'[[column+]]\' من \'[[old+]]\' إلى \'[[new+]]\' على الجدول \'[[table+]]\'';
$_lang['rename_column'] = 'إعادة تسمية العمود \'[[column+]]\' من \'[[old+]]\' إلى \'[[new+]]\' على الجدول \'[[table+]]\'.';
