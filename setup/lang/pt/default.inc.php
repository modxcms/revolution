...
$_lang['all_languages'] = 'Todos os idiomas';
$_lang['only_popular'] = 'Somente popular';
...
$_lang['config_key_override'] = 'Se você deseja executar a instalação em uma chave de configuração diferente da especificada atualmente em seu <code>setup/includes/config. ore.php</code>, por favor, especificá-lo abaixo.';
...
$_lang['modx_footer1'] = '&copy; 2005-[[+current_year]] o projeto <a href="https://modx.com/" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;">MODX</a> Content Management Framework (CMF). Todos os direitos reservados. MODX está licenciado sob a GNU GPL.';
...
$_lang['step_welcome'] = 'Bem-vindo(a)';
$_lang['step_options'] = 'Opções';
$_lang['step_connect'] = 'Conectar';
$_lang['step_test'] = 'Teste';
$_lang['step_contexts'] = 'Contextos';
$_lang['step_install'] = 'Instalar';
$_lang['step_complete'] = 'Concluído';
$_lang['modx_installer'] = 'Instalação do MODX';
...
$_lang['upgrade_version_unsupported'] = 'O upgrade do MODX [[+version]] não é suportado por esta versão. Você precisará atualizar para o MODX 2.6 ou superior, antes de atualizar para esta versão.';
