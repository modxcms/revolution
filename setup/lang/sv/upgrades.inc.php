...
$_lang['menu_remove_success'] = 'Menyobjektet `[[+text]]` borttaget.';
$_lang['menu_remove_failed'] = 'Menyobjektet `[[+text]]` kunde inte tas bort.';
$_lang['menu_update_success'] = 'Menyobjektet `[[+text]]` uppdaterades.';
$_lang['menu_update_failed'] = 'Menyobjektet `[[+text]]` kunde inte uppdateras.';
...
$_lang['transport_package_installed_update_invalid_dates_failure'] = 'Det gick inte att reparera ogiltiga datum i transportpaketets installerat-kolumn.';
$_lang['transport_package_installed_update_invalid_dates_success'] = 'Ogiltiga datum i transportpaketets installerat-kolumn reparerades.';
