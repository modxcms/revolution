...
$_lang['connection_connection_note'] = 'Ange namnet på databasen som skapats för MODx. Om det inte finns någon databas än kommer installationsprogrammet att försöka skapa en åt dig. Det här kan komma att misslyckas beroende på MySQL-konfigurationen eller databasens åtkomsträttigheter för din domän/installation.';
...
$_lang['context_connector_options'] = '<strong>Alternativ för kopplingens kontext</strong> (kopplingstjänster för AJAX)';
$_lang['context_connector_path'] = 'Filsystemets sökväg för kopplingens kontext';
$_lang['context_connector_url'] = 'URL för kopplingens kontext';
...
$_lang['db_connecting'] = 'Ansluter till MySQL-servern:';
...
$_lang['err_update_table'] = 'Ett fel inträffade när tabellen för klassen %s uppdaterades';
...
$_lang['options_core_inplace_note'] = 'Bocka för här om du exporterade MODx från SVN eller extraherade programmet från det kompletta MODx-paketet till servern innan installationen.';
...
$_lang['package_err_install'] = 'Kunde inte installera paketet %s.';
$_lang['package_err_nf'] = 'Kunde inte hämta installationen för paketet %s.';
$_lang['package_installed'] = 'Installerade paketet %s.';
...
$_lang['password_err_short'] = 'Ditt lösenord måste vara minst sex tecken långt.';
...
$_lang['request_handler_err_nf'] = 'Kunde inte ladda anropshanteraren vid %s. Kontrollera att du har laddat upp alla de nödvändiga filerna.';
...
$_lang['table_created'] = 'Skapade tabell för klassen %s';
$_lang['table_err_create'] = 'Ett fel inträffade när tabell skulle skapas för klassen %s';
$_lang['table_updated'] = 'Tabellen för klassen %s uppgraderades';
$_lang['test_class_nf'] = 'Kunde inte hitta installationens testklass vid: %s <br />Kontrollera att du har laddat upp alla nödvändiga filer.';
$_lang['test_version_class_nf'] = 'Kunde inte hitta installationstestets Versioner-klass vid: %s <br />Kontrollera att du har laddat upp alla de nödvändiga filerna.';
...
$_lang['versioner_err_nf'] = 'Kunde inte hitta installationens Versioner-klass vid: %s <br />Kontrollera att du har laddat upp alla de nödvändiga filerna.';
$_lang['xpdo_err_ins'] = 'Kunde inte skapa en instans av xPDO.';
$_lang['xpdo_err_nf'] = 'MODx kunde inte hitta xPDO-klassen. Kontrollera att den laddades upp korrekt.';

$_lang['preload_err_cache'] = 'Kontrollera att din %scache-katalog existerar och att den är skrivbar av PHP-processen.';
...
$_lang['test_php_version_fail'] = 'Du kör PHP-versionen %s och MODx Revolution kräver version 4.3.0 eller senare';
$_lang['test_php_version_sn'] = 'Även om MODx kommer att fungera på din version av PHP så rekommenderas det inte att köra MODx på den versionen. Din version av PHP är sårbar på grund av ett flertal säkerhetshål. Uppgradera PHP till version 4.3.11 eller senare vilket fixar dessa hål. Du rekommenderas uppgradera till denna version för att din webbplats ska vara säker.';
