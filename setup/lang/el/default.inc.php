...
$_lang['back'] = 'Προηγούμενο';
$_lang['btn_test'] = 'Δοκιμή';
...
$_lang['all_languages'] = 'Όλες οι γλώσσες';
$_lang['only_popular'] = 'Μόνο δημοφιλής';
...
$_lang['step_welcome'] = 'Καλώς ήρθατε';
$_lang['step_options'] = 'Επιλογές';
$_lang['step_connect'] = 'Σύνδεση';
$_lang['step_test'] = 'Δοκιμή';
$_lang['step_contexts'] = 'Contexts';
$_lang['step_install'] = 'Εγκατάσταση';
$_lang['step_complete'] = 'Ολοκληρώθηκε';
$_lang['modx_installer'] = 'Εγκαταστάτης Του MODX';
...
$_lang['upgrade_version_unsupported'] = 'Η αναβάθμιση από το MODX [[+version]] δεν υποστηρίζεται από αυτήν την έκδοση. Θα χρειαστεί να αναβαθμίσετε σε MODX 2.6 ή νεότερη έκδοση πριν την αναβάθμιση σε αυτήν την έκδοση.';
