...
$_lang['test_memory_limit'] = 'यदि स्मृति सीमा कम से कम 24 मीटर करने के लिए सेट है की जाँच: ';
...
$_lang['test_php_version_516'] = 'ModX अपने PHP संस्करण पर मुद्दों क्योंकि इस संस्करण पर पीडीओ चालकों से संबंधित बहुत से bugs का ([[+version]]) होगा। इन समस्याओं पैच जो संस्करण 5.3.0 या उच्चतर, करने के लिए PHP अपग्रेड करें। ModX कम से कम 5.3.2+ के उन्नयन की सिफारिश की। आप ModX उपयोग करने के लिए नहीं चुनते हैं, भले ही यह है कि आप अपनी स्वयं की वेबसाइट की सुरक्षा और स्थिरता के लिए इस संस्करण में नवीनीकृत की सिफारिश की है।';
$_lang['test_php_version_520'] = 'ModX अपने PHP संस्करण पर मुद्दों क्योंकि इस संस्करण पर पीडीओ चालकों से संबंधित बहुत से bugs का ([[+version]]) होगा। इन समस्याओं पैच जो संस्करण 5.3.0 या उच्चतर, करने के लिए PHP अपग्रेड करें। ModX कम से कम 5.3.2+ के उन्नयन की सिफारिश की। आप ModX उपयोग करने के लिए नहीं चुनते हैं, भले ही यह है कि आप अपनी स्वयं की वेबसाइट की सुरक्षा और स्थिरता के लिए इस संस्करण में नवीनीकृत की सिफारिश की है।';
...
$_lang['test_table_prefix_inuse'] = 'Table prefix इस डेटाबेस में उपयोग में पहले से ही है!';
