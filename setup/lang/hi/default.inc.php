...
$_lang['all_languages'] = 'सभी भाषाएं';
$_lang['only_popular'] = 'केवल लोकप्रिय';
...
$_lang['config_key_override'] = 'यदि आप अपनें <code>setup/includes/config.core.php</code>,में बर्तमान मैं निर्दिष्ट कॉन्फ़िगरेशन कुंजी के अलावा किसी अन्य कॉन्फ़िगरेशन कुंजी पर सेटअप चलाना चाहते हैं, तो कृपया इसे नीचे निर्दिष्ट करें!';
...
$_lang['modx_footer1'] = '&प्रतिलिपि; 2005-[[+current_year]] <a href="https://modx.com/" onclick="window.open(this.href); रिटर्न झूठा;" onkeypress="window.open(this.href); return false;">MODX</a> कंटेंट मैनेजमेंट फ्रेमवर्क (CMF) प्रोजेक्ट। सर्वाधिकार सुरक्षित। MODX को GNU GPL के तहत लाइसेंस प्राप्त है!';
...
$_lang['step_welcome'] = 'स्वागत है';
$_lang['step_options'] = 'विकल्प';
$_lang['step_connect'] = 'जुड़े';
$_lang['step_test'] = 'जांच';
$_lang['step_contexts'] = 'संदर्भों';
$_lang['step_install'] = 'स्थापित करें';
$_lang['step_complete'] = 'पूर्ण';
$_lang['modx_installer'] = 'MODX इंस्टॉलर';
$_lang['success'] = 'सफलता';
...
$_lang['upgrade_version_unsupported'] = 'MODX [[+संस्करण]] से अपग्रेड करना इस रिलीज़ द्वारा समर्थित नहीं है। इस रिलीज़ में अपग्रेड करने से पहले आपको MODX 2.6 या बाद के संस्करण मे अपडेट करना होगा.';
