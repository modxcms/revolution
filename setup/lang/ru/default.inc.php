...
$_lang['setup_err_assets'] = 'Папка assets/ не была созданна в: [[+path]] <br />You will need to create this directory and make it writable if you want to use Package Management or 3rd Party Components.';
$_lang['setup_err_assets_comp'] = 'Папка assets/components/ не была созданна в: [[+path]] <br />You will need to create this directory and make it writable if you want to use Package Management or 3rd Party Components.';
$_lang['setup_err_core_comp'] = 'Папка core/components/ не была созданна в: [[+path]] <br />You will need to create this directory and make it writable if you want to use Package Management or 3rd Party Components.';
...
$_lang['preload_err_cache'] = 'Удостоверьтесь, что папка [[+path]] существует и доступна для записи процессами PHP.';
...
$_lang['test_config_file_nw'] = 'Для новой установки на Linux/Unix системах, создайте пустой файл с именем <span class="mono">[[+file]].inc.php</span> в папке<span class="mono">config/</span>.Выставьте ему права на запись (обычно 0666).';
