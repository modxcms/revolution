...
$_lang['authority_unique_index_error'] = 'Найдено несколько записей modUserGroup с такими же полномочиями. Вам нужно будет обновить их, чтобы иметь уникальные значения доступа, а затем перезапустить обновление.';
...
$_lang['menu_remove_success'] = 'Пункт меню `[[+text]]` обновлен.';
$_lang['menu_remove_failed'] = 'Пункт меню `[[+text]]` не может быть обновлен.';
$_lang['menu_update_success'] = 'Пункт меню `[[+text]]` обновлен.';
$_lang['menu_update_failed'] = 'Пункт меню `[[+text]]` не может быть обновлен.';
...
$_lang['transport_package_installed_update_invalid_dates_failure'] = 'Не удалось восстановить некорректные даты в колонке установленного транспортного пакета.';
