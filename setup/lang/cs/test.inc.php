...
$_lang['test_mysql_version_client_nf_msg'] = 'MODX se nepodařilo zjistit verzi Vašeho MySQL klienta pomocí mysql_get_client_info(). Před tím než budete pokračovat se prosím ujistěte, že verze Vašeho MySQL klienta je 4.1.20 nebo novější.';
...
$_lang['test_mysql_version_server_nf_msg'] = 'MODX se nepodařilo zjistit verzi vašeho MySQL serveru pomocí mysql_get_server_info(). Před tím než budete pokračovat se prosím ujistěte, že verze vašeho MySQL serveru je 4.1.20 nebo novější.';
$_lang['test_mysql_version_server_start'] = 'Kontroluji verzi MySQL serveru:';
$_lang['test_mysql_version_success'] = 'OK! Běží na: [[+version]]';
...
$_lang['test_php_version_fail'] = 'Váš server beží na PHP verze [[+version]], MODX Revolution vyžaduje verzi PHP [[+required]] nebo novější. Prosím aktualizujte PHP aslespoň na verzi [[+required]]. MODX doporučuje aktualizaci na verzi [[+recommended]] nebo novější.';
$_lang['test_php_version_start'] = 'Kontroluji verzi PHP:';
$_lang['test_php_version_success'] = 'OK! Běží na: [[+version]]';
$_lang['test_session_gc'] = 'Zkontrolujte, zda je <a href="https://www.php.net/manual/en/session.configuration.php#ini.session.gc-probability" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;"> sessions garbage collector</a> správně nakonfigurován: ';
