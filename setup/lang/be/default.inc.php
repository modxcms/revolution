...
$_lang['context_override'] = 'Калі вы хочаце змяніць параметр, то пастаўце галачку насупраць гэтага параметру і адрэдагуйце яго ўручную. Калі вы не паставіце галачку насупраць параметра, то сістэма будзе выкарыстоўваць параметр,  вызначаны аўтаматычна.';
...
$_lang['license'] = '<p class="title">Вы павінны пагадзіцца з ліцэнзіяй, перш чым працягнуць ўстаноўку.</p>
    <p> Выкарыстанне гэтага праграмнага забеспячэння рэгулюецца ліцэнзіяй GPL. Каб дапамагчы вам зразумець,
    што такое ліцэнзія GPL і як гэта ўплывае на вашу здольнасць выкарыстоўваць праграмнае забеспячэнне, мы
    прадугледзелі наступнае рэзюмэ: </p>
    <h4> The GNU General Public license з\'яўляецца свабоднай ліцэнзіяй. </h4>
    <p> Як і любая вольная ліцэнзія праграмнага забеспячэння, яна дае вам чатыры наступныя свабоды: </p>
    <ul>
        <li> Свабода запускаць праграму ў любых мэтах. </li>
        <li> Свабода вывучаць, як праграма працуе, і адаптаваць яе да вашых патрэбаў. </li>
        <li> Свабода распаўсюджваць копіі, так што вы можаце дапамагчы свайму бліжняму. </li>
        <li> Свабода паляпшаць праграму і публікаваць вашыя паляпшэння ў
        грамадскасці, так як будзе выгадна ўсёй абшчыне. </li>
    </ul>
    <p> Вы можаце ажыццяўляць свабоды, названыя тут пры ўмове, што вы выконваеце
    экспрэс ўмовы дадзенай ліцэнзіі. Асноўнымі ўмовамі з\'яўляюцца: </p>
    <ul>
        <li> Вы павінны прыкметна і адпаведна публікаваць на кожнай копіі раздаў
        адпаведнае апавяшчэнне аб аўтарскіх правах і адмову ад гарантый і захаваць некранутымі ўсё
        апавяшчэнні, якія адносяцца да дадзенай Ліцэнзіі і да адсутнасці якіх-небудзь гарантый; і даць
        любыя іншыя атрымальнікі Праграмы копію GNU General Public license
        разам з Праграмай. Любы пераклад GNU General Public license павінны
        суправаджацца GNU General Public license. </li>

        <li> Калі вы зменіце сваю копію або копіі праграмы або любую яе частка, або
        распрацаваць праграму, заснаваную на ёй, вы можаце распаўсюджваць атрыманае ў выніку твор пры ўмове
        вы робіце гэта пад GNU General Public license. Любы пераклад GNU
        General Public license павінен суправаджацца GNU General Public license. </li>

        <li> Капірваць або распаўсюджваць праграму, вы павінны так, каб суправаджаць яе з
        запоўніным адпаведным зыходным кодам у машыначытальным або з пісьмовым відзе.
        Ліст павінен быць сапраўдны на працягу не менш чым за тры гады, каб даць поўны адпаведны
        машыначытальны зыходны код. </li>

        <li> Любое з гэтых умоў можа быць адменена, калі вы атрымаеце дазвол ад
        уладальнік аўтарскіх правоў. </li>

        <li> Ваша правамернае выкарыстанне і іншыя правы ніякім чынам не ўплываюць на ўмовы вышэй. </li>
    </ul>
    <p> Вышэй прыведзена кароткае апісанне GNU General Public license. Працягваючы, вы
    згаджаецеся з GNU General Public license. Вышэй
    проста рэзюмэ GNU General Public license, і яго дакладнасць на
    гарантаванае. Настойліва рэкамендуецца прачытаць <a href="http://www.gnu.org/copyleft/gpl.html" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;">GNU General Public
    license</a> ў поўным аб\'ёме, перш чым прыступаць. Тэкст Вы таксама знойдзеце ў 
    файле ліцэнзіі, які распаўсюджваецца з гэтым пакетам. </p>';
...
$_lang['options_upgrade_advanced'] = 'Пашыранае абнаўленне <br /> <small> (з наладай параметраў базы даных) </small>';
$_lang['options_upgrade_advanced_note'] = 'Для дэталёвай налады даных пра падключэнне да базы даных або пры пераходзе на сервер з другога кадоўкай базы даных. <Strong> Вы павінны ведаць поўную назву вашай базы даных, імя карыстальніка, пароль, кадзіроўку і супастаўленне. </Strong>';
...
$_lang['package_err_nf'] = 'Не атрымалася атрымаць пакет [[+package]] .';
...
$_lang['password_err_short'] = 'Ваш пароль павінен быць даўжынёй не менш за 6 знакаў.';
