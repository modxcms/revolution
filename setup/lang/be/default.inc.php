...
$_lang['all_languages'] = 'Усе мовы';
$_lang['only_popular'] = 'Толькі папулярныя';
...
$_lang['step_welcome'] = 'Вітаем';
$_lang['step_options'] = 'Опцыі';
$_lang['step_connect'] = 'Злучэнне';
$_lang['step_test'] = 'Тэст';
$_lang['step_contexts'] = 'Кантэксты';
$_lang['step_install'] = 'Усталяваць';
$_lang['step_complete'] = 'Завершана';
$_lang['modx_installer'] = 'Ўсталёўшчык MODX';
...
$_lang['upgrade_version_unsupported'] = 'Абнаўленне з MODX [[+version]] не падтрымліваецца дадзеным выпускам. Вам трэба будзе абнавіць да MODX 2.6 або больш позняй версіі перад абнаўленнем да гэтага выпуску.';
