...
$_lang['config_key_override'] = 'Калі вы хочаце запусціць праграму ўстаноўкі на канфігурацыйным ключы, выдатным ад таго, які ў цяперашні час паказаны ў <pre>setup/includes/config.core.php</pre>, калі ласка, укажыце яго ніжэй.';
