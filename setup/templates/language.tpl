<form id="install" action="?" method="post">
    ...
    <div class="content-wrap">
        ...
        <div class="select_lang">
            ...
            <button class="toggle toggle--all" type="button"><span>{$_lang.all_languages}</span></button>
            <button class="toggle toggle--popular" type="button"><span>{$_lang.only_popular}</span></button>
        </div>
    </div>

    <script>
        // Helpers
        var showElement = function (e) { e.style.display = 'block'; }
        var hideElement = function (e) { e.style.display = 'none'; }
        ...
        var showAllLanguagesButton = document.querySelector('.toggle--all')
        var showPopularLanguagesButton = document.querySelector('.toggle--popular')
