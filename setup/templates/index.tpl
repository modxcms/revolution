...
<tr>
  ...
  <tr class="fancyRow2">
    <td class="border-top-bottom smallText" colspan="2">
        <p style="padding: 5px 10px;">&copy; 2005-2013 the <a href="http://www.modx.com/" target="_blank" style="color: green; text-decoration:underline">MODX</a> Content Mangement Framework (CMF) project. All rights reserved. MODX is licensed under the GNU GPL.</p>
