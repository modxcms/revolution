        ...
        switch (MODX_SETUP_KEY) {
            case '@traditional@':
                ...
                if ($mode == modInstall::MODE_NEW) {
                    ...
                    $settings['processors_path'] = MODX_CORE_PATH . 'src/MODX/Processors/';
                    ...
                    $settings['processors_path'] = defined('MODX_PROCESSORS_PATH') ? MODX_PROCESSORS_PATH : MODX_CORE_PATH . 'src/MODX/Processors/';
                }
