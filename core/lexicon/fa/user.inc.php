...
$_lang['change_password'] = 'تغییر گذرواژه';
$_lang['change_password_confirm'] = 'بازنویسی گذرواژه';
$_lang['change_password_new'] = 'گذرواژه‌ی جدید';
$_lang['city'] = 'شهر';
$_lang['extended_fields'] = 'Extended Fields';
$_lang['extended_fields_msg'] = 'Edit any extended fields that are implemented here.';
$_lang['login_options'] = 'گزینه های ورود به سیستم';
$_lang['minimum_role'] = 'Minimum Role';
$_lang['password'] = 'گذر واژه';
$_lang['password_confirm'] = 'بازنویسی گذرواژه';
...
$_lang['password_new'] = 'گذرواژه‌ی جدید';
$_lang['password_notification'] = 'Password Notification';
$_lang['password_old'] = 'گذرواژه‌ی قبلی';
...
$_lang['user_fax'] = 'نمابر';
$_lang['user_female'] = 'خانم';
$_lang['user_full_name'] = 'نام کامل';
$_lang['user_group'] = 'User Group';
$_lang['user_group_create'] = 'ایجاد گروه کاربری';
...
$_lang['user_group_new'] = 'گروه کاربری کاربر';
$_lang['user_group_parent'] = 'Parent Group';
$_lang['user_group_remove'] = 'حذف گروه کاربری';
$_lang['user_group_remove_confirm'] = 'آیا از حذف این گروه کاربری اطمینان دارید؟';
$_lang['user_group_settings'] = 'تنظیمات گروه کاربری';
$_lang['user_group_settings_desc'] = 'مدیریت تنظیمات برای گروه کاربری';
$_lang['user_group_untitled'] = 'گروه کاربری بدون عنوان';
$_lang['user_group_update'] = 'بروزرسانی گروه کاربری';
$_lang['user_group_user_add'] = 'اضافه کردن کاربر به گروه';
...
$_lang['user_group_user_remove_confirm'] = 'آیا مطمئن هستید می خواهید این کاربر را از گروه حذف کنید؟';
...
$_lang['user_settings'] = 'تنظیمات کاربر';
$_lang['user_settings_desc'] = 'در اینجا می توانید تنظیمات خاص برای کاربر را تغییر دهید.';
...
$_lang['user_update'] = 'به‌روز رسانی کاربر';
