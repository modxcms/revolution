...
$_lang['dashboard_description_desc'] = 'A short description of the Dashboard.';
...
$_lang['dashboard_name_desc'] = 'The name of the Dashboard.';
...
$_lang['w_whosonline'] = 'چه کسی آنلاین است؟';
