 ...
 * @subpackage lexicon
 */
$_lang['help_page_title'] = 'راهنمایی و پشتیبانی';
$_lang['help_main_head'] = 'MODX is Here for You';
$_lang['help_main_subhead'] = 'نیاز به کمک در پروژه مادایکس دارید؟<br>جزئیات بیشتر<a href="http://modx.com/support">modx.com/support</a> یا با +1 (469) 777-6639 تماس بگیرد.';
$_lang['forums'] = 'انجمن‌ها';
$_lang['forums_title'] = 'انجمن‌های کاربران مادایکس';
...
$_lang['email_sub'] = 'با مادایکس به روز باشید';
...
$_lang['email_sub_button'] = 'ثبت‌نام کنید';
$_lang['social_follows'] = 'شما می‌توانید <b>مادایکس</b> را در شیکه‌های اجتماعی دنبال کنید.';
$_lang['follow'] = 'مادایکس را دنبال کنید';
