...
$_lang['access_category_err_remove'] = 'خطایی به هنگام ذخیره‌ی دسته‌ی ACL رخ داد.';
$_lang['access_category_remove'] = 'حذف دسته‌ی دسترسی';
$_lang['access_category_update'] = 'به روز رسانی دسته‌ی دسترسی';
$_lang['access_confirm_remove'] = 'آیا مایل به حذف این مورد کنترل دسترسی امنیتی هستید؟';
...
$_lang['access_context_err_remove'] = 'خطایی به هنگام حذف دسته‌ی ACL رخ داد.';
...
$_lang['access_err_remove'] = 'خطا به هنگام حذف ACL!';
