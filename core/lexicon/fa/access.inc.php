 ...
 * @subpackage lexicon
 */
$_lang['access_category_management_msg'] = 'مدیریت دسترسی دسته کاربران به عناصر از طریق دسته‌بندی‌ها، و تنظیم مقررات دسترسی در صورت تمایل.';
$_lang['access_category_create'] = 'Add Category Access';
$_lang['access_category_err_ae'] = 'برای این دسته، ACL موجود می‌باشد!';
$_lang['access_category_err_nf'] = 'دسته‌ی  ALC یافت نشد.';
$_lang['access_category_err_ns'] = 'دسته‌ی ACL مشخص نشده است.';
...
$_lang['access_context_management_msg'] = 'مدیریت دسترسی دسته کاربران به زمینه‌ها، و تنظیم مقررات دسترسی در صورت تمایل.';
$_lang['access_context_create'] = 'Add Context Access';
$_lang['access_context_err_ae'] = 'برای این زمینه، سطوح دسترسی موجود می‌باشد!';
$_lang['access_context_err_nf'] = 'سطوح دسترسی برای زمینه پیدا نشد.';
$_lang['access_context_err_ns'] = 'سطوح دسترسی برای زمینه تعیین نشده است.';
...
$_lang['access_err_ae'] = 'ACL از قبل موجود است!';
$_lang['access_err_create_md'] = 'ایحاد ACL ممکن نیست: کمبود داده‌ها!';
$_lang['access_err_nf'] = 'یافتن ACL مورد نظر ممکن نیست!';
$_lang['access_err_remove'] = 'An error occurred while trying to delete the ACL!';
$_lang['access_err_save'] = 'خطا به هنگام ذخیره‌سازی ACL!';
$_lang['access_grid_empty'] = 'موردی برای نمایش موجود نمی‌باشد';
$_lang['access_grid_paginate'] = 'نمایش موارد {0} تا {1} از مجموع {2} مورد';
...
$_lang['access_permissions'] = 'مجوزهای دسترسی';
$_lang['access_permissions_add_document_group'] = 'ایجاد دسته‌ سند جدید';
$_lang['access_permissions_add_user_group'] = 'ایجاد دسته کاربری جدید';
$_lang['access_permissions_documents_in_group'] = '<strong>اسناد در این دسته:</strong> ';
...
$_lang['access_permissions_user_groups'] = 'گروه های کاربری';
...
$_lang['category_add'] = 'افزودن دسته‌بندی';
...
$_lang['no_policy_option'] = '(بدون مقررات)';
$_lang['permissions_in_policy'] = 'مجوزها در مقررات انتخاب شده';
...
$_lang['resource_group_resource_err_nf'] = 'پرونده جزو آن دسته پرونده‌ها نیست.';
