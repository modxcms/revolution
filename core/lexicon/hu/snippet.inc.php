...
$_lang['snippet_code'] = 'Kódrészlet forrása (php)';
$_lang['snippet_delete_confirm'] = 'Biztosan törli ezt a kódrészletet?';
$_lang['snippet_desc'] = 'Leírás';
$_lang['snippet_desc_category'] = 'A kategória, amelyikbe ez a kódrészlet tartozik.';
$_lang['snippet_desc_description'] = 'Ezen kódrészlet rövid leírása.';
$_lang['snippet_desc_name'] = 'A kódrészlet neve. A [[NameOfSnippet]] címkék használatával lesz elérhető.';
...
$_lang['snippet_lock_msg'] = 'A kódrészlet szerkesztéséhez szükség van az edit_locked felhasználói tulajdonságra.';
$_lang['snippet_management_msg'] = 'Itt választhatja ki a módosítani kívánt kódrészletet.';
$_lang['snippet_msg'] = 'Itt hozhatja létre vagy szerkesztheti a kódrészleteket. Ne feledje, a kódrészletek nyers PHP kódok, és ha a sablon egy bizonyos pontján akarja megjeleníteni a kódrészlet kimenetét, vissza kell adnia egy értéket a kódrészlet belsejéből.';
$_lang['snippet_name'] = 'Kódrészlet neve';
$_lang['snippet_new'] = 'Kódrészlet létrehozása';
$_lang['snippet_properties'] = 'Alaptulajdonságok';
$_lang['snippet_title'] = 'Kódrészlet létrehozása/szerkesztése';
$_lang['snippet_untitled'] = 'Névtelen kódrészlet';
