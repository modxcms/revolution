 ...
 */
$_lang['chunk'] = 'Darab';
$_lang['chunk_desc_category'] = 'A kategória, amelyikbe ez a kódegység tartozik.';
$_lang['chunk_desc_description'] = 'Ezen kódegység rövid leírása.';
$_lang['chunk_desc_name'] = 'A kódegység neve. A [[$nameOfChunk]] címkék használatával lesz elérhető.';
$_lang['chunk_code'] = 'Kódegység tartalma (html)';
$_lang['chunk_desc'] = 'Leírás';
...
$_lang['chunk_lock_msg'] = 'A kódegység szerkesztéséhez szükség van az edit_locked felhasználói tulajdonságra.';
$_lang['chunk_msg'] = 'Itt létrehozhatja vagy módosíthatja a kódegységeket. Ne feledje, a kódegységek \'nyers\' HTML kódok; vagyis a PHP kód nem lesz feldolgozva.';
$_lang['chunk_name'] = 'Kódegység neve';
