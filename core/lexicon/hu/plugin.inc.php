...
$_lang['plugin_add_to_event'] = 'Beépülő hozzáadása eseményhez';
$_lang['plugin_code'] = 'Beépülő kódja (php)';
$_lang['plugin_config'] = 'Beépülő beállításai';
$_lang['plugin_desc'] = 'Leírás';
$_lang['plugin_desc_category'] = 'A kategória, amelyikbe ez a beépülő tartozik.';
$_lang['plugin_desc_description'] = 'Ezen beépülő rövid leírása.';
$_lang['plugin_desc_name'] = 'Beépülő neve.';
$_lang['plugin_delete_confirm'] = 'Biztosan törölni szeretné ezt a beépülőt?';
$_lang['plugin_disabled'] = 'Nem működő beépülő';
$_lang['plugin_disabled_msg'] = 'A beépülő ki van kapcsolva és nem válaszol az eseményekre.';
...
$_lang['plugin_event_update'] = 'Beépülő eseményének szerkesztése';
$_lang['plugin_lock'] = 'A beépülő szerkesztésre zárolva';
$_lang['plugin_lock_msg'] = 'A beépülő szerkesztéséhez szükség van az edit_locked felhasználói jellemzőre.';
...
$_lang['plugin_msg'] = 'Itt hozhatja létre vagy módosíthatja a beépülőket. A beépülők \'nyers\' PHP kódok, amiket a kiválasztott rendszeresemények hívnak meg.';
$_lang['plugin_name'] = 'Beépülő neve';
...
$_lang['plugin_title'] = 'Beépülő létrehozása, módosítása';
$_lang['plugin_untitled'] = 'Névtelen beépülő';
