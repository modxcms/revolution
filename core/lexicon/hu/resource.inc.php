...
$_lang['document_new'] = 'Új dokumentum';
...
$_lang['resource_delete_confirm'] = 'Biztosan törli ezt az erőforrást?<br />FONTOS: Minden alárendelt erőforrás is törlődik!';
...
$_lang['resource_new'] = 'Új erőforrás';
...
$_lang['resource_unpublish_confirm'] = 'Ha most vonja vissza az erőforrást, minden korábban beállított közzétételi vagy visszavonási dátumot eltávolít. Ha szeretné beállítani vagy megtartani ezeket a dátumokat, válassza a visszavonás helyett az erőforrás szerkesztését.<br /><br />Folytatja?';
...
$_lang['static_resource_new'] = 'Új állandó erőforrás';
...
$_lang['weblink_help'] = 'Az objektum címe, amelyiket ezzel a hivatkozással kíván elérni. Ha egy létező MODX erőforrásra akar hivatkozni, adja meg itt az ID-t.';
...
$_lang['weblink_new'] = 'Új webes hivatkozás';
