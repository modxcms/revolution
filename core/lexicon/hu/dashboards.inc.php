...
$_lang['dashboard_remove_multiple'] = 'Vezérlőpultok törlése';
...
$_lang['dashboard_err_remove'] = 'Hiba történt a vezérlőpult törlése közben.';
$_lang['dashboard_err_remove_default'] = 'Nem törölheti az alapértelmezett vezérlőpultot!';
...
$_lang['widget_err_remove'] = 'Hiba történt a vezérlőelem törlése közben.';
...
$_lang['widget_dashboard_remove'] = 'Vezérlőelem törlése az irányítópultról';
...
$_lang['widget_add_desc'] = 'Válasszon egy vezérlőelemet a vezérlőpulthoz adáshoz.';
$_lang['widget_add_success'] = 'A vezérlőelem sikeresen hozzá lett adva a vezérlőpultjához. Ennek az ablaknak a bezárása után lesz betöltve.';
$_lang['widget_remove_confirm'] = 'Biztosan törli ezt a vezérlőpulti vezérlőelemet? Ez a művelet nem vonható vissza, és törli a vezérlőelemet minden vezérlőpultból.';
$_lang['widget_remove_multiple'] = 'Több vezérlőelem törlése';
$_lang['widget_remove_multiple_confirm'] = 'Biztosan törli ezeket a vezérlőpulti vezérlőelemeket? Ez a művelet nem vonható vissza, és törli a vezérlőelemeket minden hozzárendelt vezérlőpultból.';
...
$_lang['widget_size_desc'] = 'A vezérlőelem mérete negyedtől kezdve kétszeresig.';
$_lang['widget_size_double'] = 'Kétszeres méret';
$_lang['widget_size_full'] = 'Teljes méret';
$_lang['widget_size_three_quarters'] = 'Háromnegyed';
$_lang['widget_size_two_third'] = 'Kétharmad';
$_lang['widget_size_half'] = 'Fél';
$_lang['widget_size_one_third'] = 'Egyharmad';
$_lang['widget_size_quarter'] = 'Negyed';
...
$_lang['widget_unplace'] = 'Vezérlőelem törlése az irányítópultról';
$_lang['widgets'] = 'Vezérlőelemek';
$_lang['widgets.intro_msg'] = 'Below is a list of all the installed Dashboard Widgets you have.';

$_lang['action_new_resource'] = 'Új oldal';
$_lang['action_new_resource_desc'] = 'Hozzon létre egy új oldalt a honlapján.';
$_lang['action_view_website'] = 'Weboldal megtekintése';
$_lang['action_view_website_desc'] = 'Nyissa meg weboldalát egy új ablakban.';
$_lang['action_advanced_search'] = 'Összetett keresés';
$_lang['action_advanced_search_desc'] = 'Összetett keresés a teljes weboldalán.';
$_lang['action_manage_users'] = 'Felhasználók kezelése';
$_lang['action_manage_users_desc'] = 'A teljes honlap és a kezelő felhasználók kezelése.';

$_lang['w_buttons'] = 'Gombok';
$_lang['w_buttons_desc'] = 'A tulajdonságok között megadott tömbből megjelenít egy gombválasztékot.';
$_lang['w_updates'] = 'Frissítések';
$_lang['w_updates_desc'] = 'Megkeresi az elérhető frissítéseket az alaprendszehez és a további összetevőkhöz.';
