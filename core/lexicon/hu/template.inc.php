...
$_lang['template_source'] = 'Médiaforrás';
$_lang['template_source_description'] = 'A médiaforrás egy állandó állomány vagy előnézet kiválasztásához. Az "Egyik sem" lehetőségnél feltételezzük, hogy teljes elérést ad meg.';
$_lang['template_preview'] = 'Sablon előnézete';
$_lang['template_preview_description'] = 'A sablon képernyőmentése a sablonválasztóban látható előnézethez. A legjobb méret 335 x 236 (sz x m)';
