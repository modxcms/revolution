...
$_lang['number_strict_decimalprecision'] = 'Přísná desetinná přesnost';
$_lang['number_strict_decimalprecision_desc'] = 'Je-li nastaveno na „Ano“, zachová koncové nuly v desetinných číslech (výchozí hodnota "Ne").';
