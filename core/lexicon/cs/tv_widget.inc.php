...
$_lang['checkbox_display_switch'] = 'Zobrazit jako přepínač';
$_lang['checkbox_display_switch_desc'] = 'Pokud je nastaveno na „Ano“, budou v editačním formuláři Dokumentů prvky této TV vykresleny jako přepínače (Toggle switch) namísto zaškrtávacích políček (Checkbox). Výchozí nastavení je „Ne“.';
$_lang['class'] = 'Třída';
...
$_lang['delimiter_desc'] = 'Jeden nebo více znaků používaných k oddělení hodnot (platí pro TV, které podporují vícenásobný výběr).';
...
$_lang['number_decimalprecision_strict'] = 'Přísná desetinná přesnost';
$_lang['number_decimalprecision_strict_desc'] = 'Je-li nastaveno na „Ano“, zachová koncové nuly v desetinných číslech (výchozí hodnota "Ne").';
