...
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. IIS často nemá správně nastavenou proměnnou "document_root", která je používána správcem souborů, s čím může pracovat. Máte-li problémy s používáním správce souborů, ujistěte se, že tato cesta je nastavena do kořene MODX instalace.';
$_lang['setting_filemanager_path_relative'] = 'Relativní cesta pro správce souborů? (Deprecated)';
$_lang['setting_filemanager_path_relative_desc'] = 'Deprecated - Use Media Sources instead. Je-li cesta nastavená ve filemanager_path relativní vůči MODX base_path, nastavte tuto volbu na Ano, pokud je cesta ve filemanager_path mimo docroot nastavte Ne.';
$_lang['setting_filemanager_url'] = 'URL pro správce souborů (Deprecated)';
$_lang['setting_filemanager_url_desc'] = 'Deprecated - Use Media Sources instead. Volitelné. Tuto volbu použijte pokud chcete nastavit explicitní URL pro přístup k souborům v rámci správce souborů (užitečné v případě, že jste změnili filemanager_path na cestu mimo MODX webroot). Ujistěte se, že je tato URL přístupná z webu. Pokud tuto volbu ponecháte prázdnou, MODX se pokusí automaticky tuto URL doplnit.';
$_lang['setting_filemanager_url_relative'] = 'Relativní URL pro správce souborů? (Deprecated)';
$_lang['setting_filemanager_url_relative_desc'] = 'Deprecated - Use Media Sources instead. Je-li URL nastavená v filemanager_url relativní vůči MODX base_url, nastavte tuto volbu na Ano. Je-li URL nastavená ve filemanager_url mimo webroot nastavte Ne.';
