...
$_lang['tv_err_duplicate'] = 'Nastala chyba při duplikování TV.';
...
$_lang['tv_err_ae'] = 'Template variable s názvem "[[+name]]" již existuje.';
...
$_lang['tv_err_reserved_name'] = 'TV nemůže mít stejné jméno jak pole \'Resource\'.';
$_lang['tv_err_save_access_permissions'] = 'Nastala chyba při ukládání přístupových práv TV.';
$_lang['tv_err_save'] = 'Nastala chyba při ukládání Template Variable.';
...
$_lang['tv_tmpl_access_msg'] = 'Vyberte šablony, které mají povolený přístup k této Template Variable.';
...
$_lang['tvt_err_nf'] = 'Template variable nemá přístup k určené šabloně.';
