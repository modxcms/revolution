...
$_lang['resource_delete_confirm'] = 'Jste si jisti, že chcete odstranit dokument: "[[+resource]]"?<br />POZNÁMKA: Všechny podřízené dokumenty budou také odstraněny!';
...
$_lang['resource_err_delete_errorpage'] = 'Tento dokument je nastaven jako "Chybová stránka" a nemůže být odstraněn!';
...
$_lang['resource_err_symlink_target_invalid'] = 'Cíl symbolického odkazu neobsahuje celočíselnou hodnotu.';
$_lang['resource_err_symlink_target_nf'] = 'Nemůžete vytvořit symbolický odkaz na prostředek, který není k dispozici.';
...
$_lang['resource_err_unpublish_errorpage'] = 'Tento dokument je spojen s proměnnou \'error_page\' a nemůže mu být ukončeno publikování!';
$_lang['resource_err_unpublish_errorpage_dates'] = 'Tento dokument je spojen s proměnnou \'error_page\' a nemůže mít nastaveno datum publikování ani datum ukončení publikování!';
$_lang['resource_err_unpublish_siteunavailable'] = 'Tento dokument je spojen s proměnnou \'site_unavailable_page\' a nemůže mu být ukončeno publikování!';
$_lang['resource_err_unpublish_siteunavailable_dates'] = 'Tento dokument je spojen s proměnnou \'site_unavailable_page\' a nemůže mít nastaveno datum publikování ani datum ukončení publikování!';
$_lang['resource_err_weblink_target_nf'] = 'Nelze nastavit webový odkaz na prostředek, který není k dispozici.';
...
$_lang['resource_unpublishdate'] = 'Datum ukončení publikování';
...
$_lang['weblink_help'] = 'Úplná URL adresa, na kterou chcete odkazovat tímto webovým odkazem (https://example. om/page). Pokud chcete odkazovat na existující MODX dokument, zadejte ID zde.';
...
$_lang['resource_right_middle_title'] = 'Šablona';
$_lang['resource_right_bottom_title'] = 'Chování v menu';
