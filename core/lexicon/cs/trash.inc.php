...
$_lang['trash.intro_msg'] = 'Manage the deleted resources here. <br><i>Please check the publishing state, before you restore any resource.</i> You can (un-)publish resources directly from the grid with a double click on the published cell of the resource.';
...
$_lang['trash.purge_all'] = 'Vyčistit vše';
$_lang['trash.restore_all'] = 'Obnovit vše';
$_lang['trash.selected_purge'] = 'Trvale odstranit vybrané zdroje';
$_lang['trash.selected_restore'] = 'Obnovit vybrané zdroje';
$_lang['trash.purge'] = 'Trvale odstranit zdroj';
$_lang['trash.purge_confirm_title'] = 'Odstranit trvale?';
