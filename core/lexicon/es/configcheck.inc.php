...
$_lang['configcheck_installer_msg'] = 'El directorio setup/ contiene el instalador de MODX.  Sólo imagina que podría pasar si una persona malvada encuentra esta carpeta y activa el instalador!  Probablemente no llegue muy lejos, porque necesitará ingresar información del usuario para la base de datos, pero pero de todas maneras es mejor remover esta carpeta de tu servidor. It is located at: [[+path]]';
