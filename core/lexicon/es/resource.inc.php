...
$_lang['resource_change_template_confirm'] = '¿Estás seguro de que quieres cambiar la plantilla? ADVERTENCIA: Esto guardará los cambios y actualizará la página; asegúrate de que estás listo para hacerlo antes de continuar.';
...
$_lang['resource_delete_confirm'] = '¿Estás seguro de que quieres borrar este recurso?<br />NOTA: ¡Cualquier recurso hijo también serán borrado!';
...
$_lang['resource_menuindex_help'] = 'Orden del recurso en el árbol. Por lo general se utiliza con para ordenar los recursos mostrados dinámicamente. Algunos componentes podrían ignorar esta configuración.';
$_lang['resource_menutitle'] = 'Título del Menú';
$_lang['resource_menutitle_help'] = 'El título del menú es un campo que puedes usarse para mostrar un título corto para el recurso dentro del snippet de menú.';
...
$_lang['resource_publishdate_help'] = 'Si configuras una fecha de publicación, el recurso será publicado cuando llegue la fecha de publicación. Haciendo clic en el icono del calendario se puede seleccionar una fecha, dejándo el campo en blanco el recurso nunca será publicado automáticamente.';
...
$_lang['resource_refresh'] = 'Actualizar Recurso';
