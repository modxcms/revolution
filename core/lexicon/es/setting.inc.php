...
$_lang['settings_after_install'] = 'Como esta es una instalación nueva, deberás revisar la configuración y modificar las que creas convenientes. Despues de modificar la configuración, pulsa "Guardar" para actualizar la base de datos con la nueva configuración.<br /><br />';
...
$_lang['settings_misc'] = 'Miscelaneas';
...
$_lang['setting_access_category_enabled_desc'] = 'Utiliza esto para activar o desactivar las comprobaciones de ACL al acceder a las diferentes Categorías. <strong>NOTA: ¡Si esta opción se configura como "No" todos los Permisos de Acceso a Categorías serán ignorados!</strong>';

$_lang['setting_access_context_enabled'] = 'Comprobar Acceso a Contextos';
$_lang['setting_access_context_enabled_desc'] = 'Utiliza esto para activar o desactivar las comprobaciones de ACL al acceder a los diferentes Contextos. <strong>NOTA: ¡Si esta opción se configura como "No" todos los Permisos de Acceso a Contextos serán ignorados! No desactivar esta opción por completo ni para el contexto "mgr" o no podrás acceder al panel de Administración.</strong>';

$_lang['setting_access_resource_group_enabled'] = 'Comprobar Acceso a Grupos de Recursos';
$_lang['setting_access_resource_group_enabled_desc'] = 'Utiliza esto para activar o desactivar las comprobaciones de ACL al acceder a los diferentes Grupos de Recursos (por Contexto). <strong>NOTA: ¡Si esta opción se configura como "No" todos los Permisos de Acceso a Grupos de Recursos serán ignorados!</strong>';
...
$_lang['setting_auto_menuindex_desc'] = 'Selecciona "Si" para incrementar el índice de menú automáticamente de manera predeterminada.';
...
$_lang['setting_automatic_alias_desc'] = 'Selecciona "Si" para que el sistema genere automáticamente el alias basado en el título del Recurso cuando sea guardado.';
...
$_lang['setting_cache_default_desc'] = 'Selecciona "Si" para hacer que todos los recursos sean almacenenados en caché por defecto.';
...
$_lang['setting_cache_disabled_desc'] = 'Selecciona "Si" para deshabilitar todas las características de caché de MODX. MODX no recomienda deshabilitar la caché.';
...
$_lang['setting_cache_scripts_desc'] = 'Cuando esté habilitado, MODX almacenará en caché todos los los Scripts (Snippets y Plugins) en un archivo para reducir los tiempos de carga. MODX recomienda configurarlo a "Si".';
...
$_lang['setting_filemanager_path_relative_desc'] = 'Obsoleto - Utilizar Recursos Multimedia en su lugar. Si la configuración anterior (filemanager_path) es una ruta relativa, configura el valor a "Si". Si por el contrario, la ruta está fuera del directorio raíz de MODX, configura el valor a "No".';
...
$_lang['setting_filemanager_url_relative_desc'] = 'Obsoleto - Utilizar Recursos Multimedia en su lugar. Si la configuración filemanager_url es una ruta relativa al directorio raíz de MODX, configura el valor como "Si". Si por el contrario, la ruta está fuera de la raíz de MODX, configura el valor como "No".';
...
$_lang['setting_global_duplicate_uri_check_desc'] = 'Selecciona "Si" para que las comprobaciones de URIs duplicados incluyan todos los Contextos en la búsqueda. De otra manera, sólo el Contexto en el que se esté guardando el Recurso es revisado.';
...
$_lang['setting_inline_help_desc'] = 'Si se configura como "Si", la ayuda de los campos se mostrará directamente debajo de ellos. En caso contrario, los campos mostrarán un mensaje de ayuda al poner el cursor del ratón sobre ellos.';
...
$_lang['setting_publish_default_desc'] = 'Selecciona "Si" para hacer todos los recursos nuevos publicados por defecto.';
...
$_lang['setting_richtext_default_desc'] = 'Selecciona "Si" para hacer que todos los recursos nuevos utilicen el Editor de Texto Enriquecido.';

$_lang['setting_search_default'] = 'Buscable por Defecto';
$_lang['setting_search_default_desc'] = 'Selecciona "Si" para permitir que todos los recursos nuevos puedan ser buscados.';
...
$_lang['setting_show_tv_categories_header_desc'] = 'Configurar como "Si" para que MODX muestre la cabecera de "Categorías" bajo la primera pestaña de categorías cuando se editen Variables de Plantilla en un Recurso.';
...
$_lang['setting_site_status_desc'] = 'Selecciona "Si" para permitir el acceso a la web. Si seleccionas "No", tus visitantes verán el "Mensaje de Sitio No Disponible", y no podrán navegar por el sitio.';
...
$_lang['setting_symlink_merge_fields_desc'] = 'Si está configurado como "Si", combinará automáticamente los campos no vacíos con el recurso de destino cuando se utilicen SymLinks si el forwarding está activado.';
...
$_lang['setting_tvs_below_content_desc'] = 'Configurar como "Si" para mover las variables de plantilla debajo del campo Contenido cuando se edite un recurso.';

$_lang['setting_ui_debug_mode'] = 'Modo de Depuración en la Interfaz de Usuario';
$_lang['setting_ui_debug_mode_desc'] = 'Configurar como "Si" para mostrar mensajes de depuración al utilizar la interfaz gráfic de la plantilla predeterminada del panel de administración. El navegador debe soportar "console.log".';
...
$_lang['setting_use_alias_path_desc'] = 'Configurando esta opción a "Si" se mostrará la ruta completa al Recurso si éste tiene un alias. Por ejemplo, si un Recurso con un alias de "hijo" se encuentra dentro de un Recurso contenedor con un alias de "padre", entonces la ruta completa del alias al Recurso será mostrado como "/padre/hijo.html".<br /><strong>NOTA: Cuando esta opción se configura como "Si" (activando las rutas de alias), los recursos (como imágenes, css, javascript, etc.) usan la ruta absoluta, como por ejemplo "/assets/images" en lugar de "assets/images". Al hacer esto, prevendrás que navegador o servidor web añadan la ruta relativa a la ruta del alias.</strong>';

$_lang['setting_use_browser'] = 'Habilitar Navegador de Recursos';
$_lang['setting_use_browser_desc'] = 'Selecciona "Si" para habilitar el navegador de recursos. Esto permitirá a tus usuarios a navegar y subir recursos tales como imágenes, archivos flash y archivos multimedia en el servidor.';
