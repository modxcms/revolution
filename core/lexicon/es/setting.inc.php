...
$_lang['setting_filemanager_path'] = 'Ruta de Admin de Archivos (Deprecated)';
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. IIS normalmente no llena apropiadamente la configuración de document_root, la cual es usada por el admin de archivos para determinar lo que puedes ver.  Si estás teniendo problemas usando el admin de archivos, asegúrate de que esta ruta apunta a la raíz de tu instalación de MODX.';
$_lang['setting_filemanager_path_relative'] = 'Es la Ruta del Admin de Archivos Relativa? (Deprecated)';
$_lang['setting_filemanager_path_relative_desc'] = 'Deprecated - Use Media Sources instead. Si tu configuración de filemanager_path es relativa a la ruta base_path de MODX, entonces por favor configura esto a Si.  Si tu filemanager_path está fuera del docroot, configura esto a No.';
$_lang['setting_filemanager_url'] = 'URL del Admin de Archivos (Deprecated)';
$_lang['setting_filemanager_url_desc'] = 'Deprecated - Use Media Sources instead. Opcional.  Configura esto si quieres configurar una URL explícita para acceder a los archivos en el admin de archivos de MODX (es útil si has cambiado filemanager_path a una ruta fuera de la raíz web de MODX).  Asegúurate que esta sea una URL accesible en la web del valor configurado en filemanager_path.  Si dejas esto vacío, MODX tratará de calcularlo automáticamente.';
$_lang['setting_filemanager_url_relative'] = 'Es la URL del Admin de Archivos Relativa? (Deprecated)';
$_lang['setting_filemanager_url_relative_desc'] = 'Deprecated - Use Media Sources instead. Si tu configuración de filemanager_url es relativa al base_url de MODX, entonces pr favor configura esto a Si.  Si tu filemanager_url está fuera de la raíz web principal, configur esto a No.';
