...
$_lang['extended_fields_msg'] = 'Editar cualquiera de los campos aquí integrados.';
...
$_lang['password_gen_specify'] = 'Especificar la Contraseña:';
...
$_lang['user'] = 'Usuario';
$_lang['user_active_desc'] = 'Si el Usuario está o no está activo. Si un Usuario no está activo, no podrá entra a ningún Contexto ni al Panel de Administrador.';
...
$_lang['user_edit_self_msg'] = '<strong>Puedes que después de guardar tu perfil necesites cerrar sesión e iniciarla de nuevo para ver los cambios.</strong><br>Si además elegiste generar una contraseña nueva, se te enviará por email.';
...
$_lang['user_err_password_invalid'] = 'La contraseña introducda no es válida.';
...
$_lang['user_err_resource_subdirectory'] = 'El directorio que introducido no contiene los directorios %s.';
...
$_lang['user_upload_message'] = 'Si quieres impedir que éste usuario suba cualquier tipo de archivo en ésta categoría, asegurate de que "Usar Configuración Principal" no esté activado y deja el campo en blanco.';
