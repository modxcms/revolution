...
$_lang['access_context_err_ae'] = 'Una ACL para ese Contexto ya existe!';
...
$_lang['access_type_err_ns'] = 'Tipo de Objetivo o ID no especificados!';
...
$_lang['user_group_user_access_msg'] = 'Selecciona que usuarios quieres que pertenezcan a este Grupo de Usuarios.';
/**
 * Entries automatically taken fron english language file
 */
...
$_lang['filter_by_source'] = 'Filtrar por Origen de Origen Multimedia...';
...
$_lang['resource_group_update'] = 'Actualizar un Grupo de RecursosUpdate Resource Group';
...
$_lang['resource_group_automatic_access_desc'] = 'Nota: Es posible se deban vaciar los permisos despues de agregar el Grupo de Recursos si se marca alguna de las opciones presentes abajo.';
...
$_lang['user_group_aw_desc'] = 'Nota: Es posible se deban vaciar los permisos despues de agregar el Grupo de Usuarios si se marca alguna de las opciones presentes abajo.';
...
$_lang['user_group_aw_users_desc'] = 'Una lista separada por comas de nombres de usuarios a los que agregar a este Grupo de Usuarios. Se deberá utilizar el formato "usuario:rol", de otra manera, especificando únicamente el nombre de usuario se asumirá el rol "Member".';
$_lang['user_group_aw_resource_groups'] = 'Grupos de Recursos';
$_lang['user_group_aw_resource_groups_desc'] = 'Una lista separada por comas de los Grupos de Recursos a los que otorgar acceso en los Contextos arriba mostrados.';
$_lang['user_group_aw_categories'] = 'Categorías de Elementos';
$_lang['user_group_aw_categories_desc'] = 'Una lista separada por comas de las Categorías de Elementos a las que otorgar acceso en los Contextos arriba mostrados.';
...
$_lang['user_group_category_authority_desc'] = 'El Rol mínimo que tendrá acceso a los Permisos de la Política seleccionada para este contexto. Roles con Autoridades superiores (números más pequeños) también heredarán el acceso. En la mayoría de ocasiones, el valor puede ser "Member".';
$_lang['user_group_category_category_desc'] = 'La Categoría a la que Otorgar Permisos de acceso.';
$_lang['user_group_category_context_desc'] = 'El Contexto necesario para Elementos asociados a la Categoría arriba mostrada.';
...
$_lang['user_group_context_authority_desc'] = 'El Rol mínimo que tendrá acceso a los Permisos de la Política seleccionada para este contexto. Roles con Autoridades superiores (numeros más pequeños) también heredarán el acceso. En la mayoría de ocasiones, el valor puede ser "Member".';
$_lang['user_group_context_context_desc'] = 'El contexto al que dar acceso.';
$_lang['user_group_context_policy_desc'] = 'La Política a aplicar a este Contexto para este Grupo de Usuarios. Esto otorgará a todos los Usuarios en este Grupo de Usuarios con los Roles mínimos los Permisos especificados en la Política.';
$_lang['user_group_resourcegroup_authority_desc'] = 'El Rol mínimo que tendrá acceso a los Permisos de la Política seleccionada para este contexto. Roles con Autoridades superiores (numeros más pequeños) también heredarán el acceso. En la mayoría de ocasiones, el valor puede ser "Member".';
$_lang['user_group_resourcegroup_context_desc'] = 'El contexto a buscar para elementos asociados al Grupo de Recursos arriba mostrado.';
$_lang['user_group_resourcegroup_policy_desc'] = 'La Política a aplicar en este Contexto para los Elementos de la Categoría de este Grupo de Usuarios. Esto otorgará a todos los Usuarios en este Grupo de Usuarios con los roles mínimos los permisos especificados en la Política.';
$_lang['user_group_resourcegroup_resource_group_desc'] = 'El Grupo de Recursos al que otorgar permisos de acceso.';
$_lang['user_group_source_access'] = 'Acceso a Recursos Multimedia';
$_lang['user_group_source_access_msg'] = 'Recursos Multimedia a los que este Grupo de Usuarios tiene acceso.';
$_lang['user_group_source_authority_desc'] = 'El Rol mínimo que tendrá acceso a los Permisos de la Política seleccionada. Roles con Autoridades superiores (numeros más pequeños) también heredarán el acceso. En la mayoría de ocasiones, el valor puede ser "Member".';
