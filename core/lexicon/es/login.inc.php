 ...
 * @subpackage lexicon
 */
$_lang['login_activation_key_err'] = 'La clave de activación no concuerda!  Por favor revisa tu email de activación y asegúrate de que cargaste el URL correcto.';
$_lang['login_blocked_admin'] = 'Has sido bloqueado del admin por un administrador.';
$_lang['login_blocked_error'] = 'Estás temporalmente bloqueado y no puedes entrar.  Por favor inténtalo nuevamente más tarde.';
$_lang['login_blocked_ip'] = 'No estás permitido de entrar de tu dirección de IP actual.';
...
$_lang['login_title'] = 'Ingreso al Admin de MODX';
$_lang['login_user_err_nf_email'] = 'No se encontró usuario con ese email.  Por favor inténtalo nuevamente.';
$_lang['login_username'] = 'Nombre de Usuario: ';
$_lang['login_username_password_incorrect'] = 'El nombre de usuario o la contraseña que ingresaste es incorrecto.  Por favaor revisa el nombre de usuario, ingresa la contraseña e inténtalo nuevamente.';
$_lang['login_user_inactive'] = 'Tu cuenta de usuario ha sido deshabilitada.  Por favor contacta a tu administrador del sistema para habilitar tu cuenta.';