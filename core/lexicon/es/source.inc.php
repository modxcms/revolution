...
$_lang['source_type.s3_desc'] = 'Navegar a través de un depósito de Amazon S3.';
...
$_lang['prop_file.baseUrlPrependCheckSlash_desc'] = 'Si se activa, MODX solo agregará al inicio la URL base (baseUrl) si no se encuentra una barra inversa (/) al principio de la URL al renderizar la Variable de Plantilla. Util cuando se configura la variable de plantilla con una URL externa a baseUrl.';
...
$_lang['prop_file.imageExtensions_desc'] = 'Una lista separada por comas de extensiones de archivo a utilizar como imágenes. MODX tratará de crear miniaturas de los ficheros con dichas extensiones.';
