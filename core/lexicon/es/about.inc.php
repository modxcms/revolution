...
$_lang['help_main_subhead'] = 'Abajo podrás obtener ayuda para tu proyecto con MODX. <br>Más detalles en <a href="http://modx.com/support">modx.com/support</a> o llamando al +1 (469) 777-6639';
$_lang['forums'] = 'Foros';
...
$_lang['help_about'] = 'El software MODX® que estás utilizando es el resultado de una colaboración con una increíble comunidad de usuarios, seguidores y desarrolladores. Desde 2004, el equipo detrás de MODX lo ha patrocinado y gestionado, financiando su continuo trabajo a través del soporte comercial y características de pago. Puedes <a href="http://modx.com/support/" class="supportTicket">comprar soporte en origen</a>, para obtener una hora de soporte de emergencia (también válido para dos horas de soporte no prioritario). O <a href="mailto:hello@modx.com?subject=MODX Manager Inquiry ">enviarnos un email</a> si tienes alguna otra duda de MODX en general.';
$_lang['help_credit'] = 'MODX es un software de código abierto licenciado bajo <a href="http://www.gnu.org/licenses/gpl-2.0.html" target="_blank">GPL versión 2.0</a> o posterior. Copyright 2004-2014 por MODX, LLC. “MODX” es una marca registrada. Se honrado—por favor, mantén intacto este texto acreditativo y el resto de información de esta página.';
