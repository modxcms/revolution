...
$_lang['role_desc_authority'] = 'Die Autoritäts-Ebene der Rolle. Niedrigere Autoritäts-Ebenen (also solche mit einem niedrigeren Zahlenwert) haben mehr Befugnisse und erben die Berechtigungen von Rollen mit geringerer Autorität (höherem Zahlenwert) in den Gruppen, denen sie zugeordnet sind.';
...
$_lang['role_err_remove'] = 'Beim Versuch, die Roll zu löschen, ist ein Fehler aufgetreten.';
...
$_lang['user_new'] = 'Benutzer erstellen';
...
$_lang['user_sudo_desc'] = 'Wenn diese Einstellung aktiviert ist, hat dieser Benutzer vollständigen Zugriff auf die gesamte Site und umgeht alle Zugriffsberechtigungs-Checks. Aktivieren Sie diese Einstellung *NICHT*, wenn Sie sich nicht wirklich sicher sind!';
