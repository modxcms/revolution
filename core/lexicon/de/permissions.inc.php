...
$_lang['perm.edit_context_desc'] = 'Um Kontexte zu bearbeiten. <strong>WARNUNG: Ermöglicht den Zugriff auf Kontext-Einstellungen, die sicherheitsbezogene Systemeinstellungen überschreiben können, wie z.B. hochgeladene Dateitypen und API-Anmeldedaten.</strong>';
...
$_lang['perm.edit_plugin_desc'] = 'Um Plugins zu bearbeiten. <strong>WARNUNG: Kombiniert mit der save_plugin Berechtigung, wird die Möglichkeit gewährt, beliebigen serverseitigen Code auszuführen.</strong>';
$_lang['perm.edit_propertyset_desc'] = 'Eigenschaften-Gruppen bearbeiten.';
$_lang['perm.edit_role_desc'] = 'Rollen bearbeiten.';
$_lang['perm.edit_snippet_desc'] = 'Um Snippets zu bearbeiten. <strong>WARNUNG: Kombiniert mit der save_snippet Berechtigung, wird die Möglichkeit gewährt, beliebigen serverseitigen Code auszuführen.</strong>';
$_lang['perm.edit_template_desc'] = 'Templates bearbeiten.';
$_lang['perm.edit_tv_desc'] = 'Um Template-Variablen zu bearbeiten. <strong>WARNUNG: Kombiniert mit der save_tv Berechtigungen, wird der Zugriff auf die Ausführung von TV-Bindungen gewährt, die verwendet werden können, um Zugriff auf sensible Daten wie Passwörter und Systemeinstellungen zu erhalten.</strong>';
$_lang['perm.edit_user_desc'] = 'Um Benutzer zu bearbeiten. <strong>WARNUNG: Ermöglicht den Zugriff auf Benutzer-Einstellungen, die sicherheitsbezogene Systemeinstellungen überschreiben können, wie z.B. hochgeladene Dateitypen und API-Anmeldedaten.</strong>';
...
$_lang['perm.file_update_desc'] = 'Um den Inhalt von physikalischen Dateien zu bearbeiten. <strong>WARNUNG: Ermöglicht es, beliebigen serverseitigen Code auszuführen.</strong>';
...
$_lang['perm.language_desc'] = 'Um die aktuelle Sprache im Manager zu wechseln.';
...
$_lang['perm.policy_delete_desc'] = 'Zugriffs-Richtlinien löschen.';
$_lang['perm.policy_edit_desc'] = 'Um eine Zugriffsrichtlinie zu bearbeiten. <strong>WARNUNG: Kombiniert mit der policy_save Berechtigung wird die Möglichkeit gewährt, Rechte auszuweiten, einschließlich sicherheitsbezogener Berechtigungen.</strong>';
$_lang['perm.policy_new_desc'] = 'Neue Zugriffs-Richtlinien erstellen.';
$_lang['perm.policy_save_desc'] = 'Zugriffs-Richtlinien speichern.';
$_lang['perm.policy_view_desc'] = 'Zugriffs-Richtlinien anzeigen.';
$_lang['perm.policy_template_delete_desc'] = 'Zugriffs-Richtlinien-Templates löschen.';
$_lang['perm.policy_template_edit_desc'] = 'Zugriffs-Richtlinien-Templates bearbeiten.';
$_lang['perm.policy_template_new_desc'] = 'Neue Zugriffs-Richtlinien-Templates erstellen.';
$_lang['perm.policy_template_save_desc'] = 'Zugriffs-Richtlinien-Templates speichern.';
$_lang['perm.policy_template_view_desc'] = 'Zugriffs-Richtlinien-Templates anzeigen.';
...
$_lang['perm.settings_desc'] = 'Um Systemeinstellungen anzuzeigen und zu bearbeiten. <strong>WARNUNG: Sensible Daten wie API-Schlüssel werden häufig in den Systemeinstellungen gespeichert. Außerdem kann ein Benutzer die für den Upload erlaubte Dateitypen ändern, wodurch beliebiger Code ausgeführt werden kann.</strong>';
...
$_lang['perm.usergroup_edit_desc'] = 'Um eine Benutzergruppe zu bearbeiten. <strong>WARNUNG: Ermöglicht den Zugriff auf Benutzergruppen-Einstellungen, die sicherheitsbezogene Systemeinstellungen überschreiben können, wie z.B. hochgeladene Dateitypen und API-Anmeldedaten.</strong>';
