...
$_lang['namespace_err_remove'] = 'Beim Versuch, den Namensraum zu entfernen, ist ein Fehler aufgetreten.';
...
$_lang['namespace_assets_path_desc'] = 'Geben Sie hier einen absoluten Pfad zu den Assets für diesen Namensraum an (als "Assets" bezeichnet man in diesem Zusammenhang CSS- und JavaScript-Dateien, Bilder etc.). Sie können Platzhalter wie z.B. {assets_path} verwenden. Beispiel: {assets_path}components/democomponent/';
$_lang['namespace_name_desc'] = 'Geben Sie hier einen Namen für den Namensraum an.';
$_lang['namespace_path'] = 'Core-Pfad';
$_lang['namespace_path_desc'] = 'Geben Sie hier einen absoluten Pfad zum Core für diesen Namensraum an. Sie können Platzhalter wie z.B. {core_path} verwenden. Beispiel: {core_path}components/democomponent/';
