...
$_lang['resource_alias_help'] = 'Ein Alias für diese Ressource. Dies wird die Ressource verfügbar machen unter:<br /><br />https://ihrserver/alias<br /><br /><strong>Hinweis:</strong> Dies funktioniert nur, wenn Sie suchmaschinenfreundliche URLs verwenden.';
...
$_lang['resource_err_remove'] = 'Beim Versuch, die Ressource zu entfernen, ist ein Fehler aufgetreten.';
...
$_lang['resource_publish_confirm'] = 'Das sofortige Veröffentlichen einer Ressource führt dazu, dass ein evtl. gesetztes Datum, für das eine Veröffentlichung oder ein Zurückziehen geplant war, entfernt wird. Wenn Sie Veröffentlichungs- oder Zurückziehungsdaten setzen oder behalten möchten, bearbeiten Sie bitte stattdessen die Ressource.<br /><br />Fortfahren?';
...
$_lang['resource_unpublish_confirm'] = 'Das sofortige Zurückziehen einer Ressource führt dazu, dass ein evtl. gesetztes Datum, für das eine Veröffentlichung oder ein Zurückziehen geplant war, entfernt wird. Wenn Sie Veröffentlichungs- oder Zurückziehungsdaten setzen oder behalten möchten, bearbeiten Sie bitte stattdessen die Ressource.<br /><br />Fortfahren?';
