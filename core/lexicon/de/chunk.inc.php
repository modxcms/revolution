...
$_lang['chunk_name_desc'] = 'Platzieren Sie den von diesem Chunk generierten Inhalt in einer Ressource, einem Template oder einem anderen Chunk mit folgendem MODX-Tag: <span class="copy-this">[[$<span class="example-replace-name">'.$_lang['example_tag_chunk_name'].'</span>]]</span>';
