...
$_lang['configcheck_phpversion_msg'] = 'Ihre PHP Version [[+phpversion]] wird nicht länger von den Entwicklern gepflegt. Es gibt keine Sicherheitsupdates mehr hierfür. Es ist sehr wahrscheinlich, dass demnächst auch MODX oder ein installiertes Extra die Unterstützung für diese PHP Version einstellen wird. Bitte aktualisieren Sie Ihre Hosting-Umgebung.';
