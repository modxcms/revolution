...
$_lang['source_edit'] = 'Einstellungen und Zugriffsrechte von Benutzergruppen für diese Medienquelle bearbeiten';
$_lang['source_err_ae_name'] = 'Eine Medienquelle mit diesem Namen existiert bereits! Bitte geben Sie einen neuen Namen an.';
$_lang['source_err_name_reserved'] = 'Der Quellenname „[[+reservedName]]“ ist reserviert. Bitte wählen Sie einen anderen Namen.';
...
$_lang['source_reserved_general_desc'] = 'Beachten Sie, dass dies ein geschützter, vorgegebener Medienquelle ist. Die unten angezeigten Werte dienen nur Informationszwecken. Die Eigenschaften und zugewiesenen Benutzergrupp(en) sind jedoch von Benutzern mit den entsprechenden Berechtigungen bearbeitbar.';
