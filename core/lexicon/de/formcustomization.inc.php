...
$_lang['constraint_incomplete_constraint_err'] = 'Um Einschränkungen anzuwenden, muss Einschränkung angegeben werden, damit diese Regel richtig funktioniert.';
$_lang['constraint_incomplete_constraint_warn'] = 'Die Einstellung #%d im Formular-Anpassungsprofil mit dem Namen „%s“ kann nicht wie erwartet funktionieren, da ein Einschränkungsfeld gesetzt wurde, aber die Einschränkung fehlt.';
$_lang['constraint_incomplete_field_err'] = 'Um Einschränkungen anzuwenden, muss das Feld zur Einschränkung angegeben werden, damit diese Regel richtig funktioniert.';
$_lang['constraint_incomplete_field_warn'] = 'Die Einstellung #%d im Formular-Anpassungsprofil mit dem Namen „%s“ kann nicht wie erwartet funktionieren, da eine Einschränkung gesetzt wurde, aber das Einschränkungsfeld fehlt.';
