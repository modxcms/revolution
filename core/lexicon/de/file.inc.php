...
$_lang['file_err_create_general_exception'] = 'Beim Versuch, die Datei zu erstellen, ist ein unbekannter Fehler aufgetreten. Bitte überprüfen Sie die MODX und/oder Server Fehlerprotokolle für weitere Informationen.';
$_lang['file_err_create_write_exception'] = 'Die Datei konnte nicht erstellt werden. Bitte stellen Sie sicher, dass Sie Schreibrechte für das Zielverzeichnis haben und versuchen Sie es erneut.';
...
$_lang['file_err_move_general_exception'] = 'Beim Verschieben der Datei ist ein unbekannter Fehler aufgetreten. Bitte überprüfen Sie die MODX und/oder Server Fehlerprotokolle für weitere Informationen.';
$_lang['file_err_move_write_exception'] = 'Die Datei konnte nicht verschoben werden. Bitte stellen Sie sicher, dass Sie Schreibrechte für die Datei und ihr Zielverzeichnis haben und versuchen Sie es erneut.';
...
$_lang['file_err_update_general_exception'] = 'Beim Versuch, die Datei zu aktualisieren, ist ein unbekannter Fehler aufgetreten. Bitte überprüfen Sie die MODX und/oder Server Fehlerprotokolle für weitere Informationen.';
$_lang['file_err_update_write_exception'] = 'Die Datei konnte nicht aktualisiert werden. Bitte überprüfen Sie die Schreibrechte und versuchen Sie es erneut.';
...
$_lang['file_folder_err_move_general_exception'] = 'Beim Verschieben des Verzeichnisses ist ein unbekannter Fehler aufgetreten. Bitte überprüfen Sie die MODX und/oder Server Fehlerprotokolle für weitere Informationen.';
$_lang['file_folder_err_move_write_exception'] = 'Das Verzeichnis konnte nicht verschoben werden. Bitte stellen Sie sicher, dass Sie Schreibrechte für dieses Verzeichnis und dessen Zielverzeichnis haben und versuchen Sie es erneut.';
...
$_lang['file_folder_err_rename_general_exception'] = 'Beim Umbenennen des Verzeichnisses ist ein unbekannter Fehler aufgetreten. Bitte überprüfen Sie die MODX und/oder Server Fehlerprotokolle für weitere Informationen.';
$_lang['file_folder_err_rename_write_exception'] = 'Das Verzeichnis konnte nicht umbenannt werden. Bitte überprüfen Sie die Schreibrechte und versuchen Sie es erneut.';
