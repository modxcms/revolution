...
$_lang['plugin_category_desc'] = 'Verwenden, um Plugins innerhalb des Element-Baums zu gruppieren.';
$_lang['plugin_code'] = 'Plugin-Code (PHP)';
$_lang['plugin_config'] = 'Plugin-Konfiguration';
$_lang['plugin_description_desc'] = 'Informationen zum Verwenden dieses Plugins in Suchergebnissen und als Tooltip im Elementbaum anzeigen.';
