...
$_lang['dashboard_err_ae_name'] = 'Sebuah dashboard dengan nama "[[+ nama]]" sudah ada! Coba nama lain.';
$_lang['dashboard_err_duplicate'] = 'Galat terjadi saat mencoba menduplikasi dashboard.';
$_lang['dashboard_err_nf'] = 'Dasbor tidak ditemukan.';
$_lang['dashboard_err_ns'] = 'Dasbor tidak ditentukan.';
$_lang['dashboard_err_ns_name'] = 'Silakan tentukan nama untuk widget.';
...
$_lang['dashboard_usergroup_remove'] = 'Menghapus Dashboard dari kelompok pengguna';
...
$_lang['dashboard_widgets.intro_msg'] = 'Di sini Anda dapat menambah, mengelola, dan menghapus widget dari Dashboard ini. Anda juga dapat drag dan drop baris dalam grid untuk menyusun kembali.';
...
$_lang['widget_create'] = 'Buat Widget baru';
$_lang['widget_err_ae_name'] = 'Sebuah widget dengan nama "[[+ nama]]" sudah ada! Coba nama lain.';
$_lang['widget_err_nf'] = 'Widget tidak ditemukan!';
$_lang['widget_err_ns'] = 'Widget tidak ditentukan!';
$_lang['widget_err_ns_name'] = 'Silakan tentukan nama untuk widget.';
$_lang['widget_err_remove'] = 'Terjadi kesalahan saat mencoba untuk menghapus Widget.';
...
$_lang['widget_dashboard_remove'] = 'Menghapus Widget dari Dashboard';
...
$_lang['widget_new'] = 'Widget baru';
$_lang['widget_remove'] = 'Hapus Widget';
$_lang['widget_remove_confirm'] = 'Apakah Anda yakin Anda ingin menghapus Widget Dashboard ini? Ini permanen, dan akan menghapus Widget dari dashboard semua.';
$_lang['widget_remove_multiple'] = 'Menghapus beberapa widget';
$_lang['widget_remove_multiple_confirm'] = 'Apakah Anda yakin Anda ingin menghapus widget Dashboard ini? Ini permanen, dan akan menghapus widget dari semua dashboard mereka ditugaskan.';
$_lang['widget_namespace'] = 'Namespace';
$_lang['widget_namespace_desc'] = 'Namespace yang akan dimuat ke widget. Berguna untuk kustom path.';
$_lang['widget_php'] = 'Inline PHP Widget';
$_lang['widget_place'] = 'Tempat Widget';
$_lang['widget_size'] = 'Ukuran';
$_lang['widget_size_desc'] = 'Ukuran widget. Dapat berupa setengah layar lebar ("setengah"), lebar layar ("penuh"), atau lebar layar penuh dan dua baris ("ganda").';
$_lang['widget_size_double'] = 'Ganda';
$_lang['widget_size_full'] = 'Penuh';
...
$_lang['widget_unplace'] = 'Menghapus Widget dari Dashboard';
$_lang['widget_update'] = 'Memperbarui Widget';
$_lang['widgets'] = 'Widget';
$_lang['widgets.intro_msg'] = 'Daftar dibawah ini adalah daftar semua widget Dashboard yang terinstal yang Anda memiliki.';
