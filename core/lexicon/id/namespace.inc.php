...
$_lang['namespace_err_ns'] = 'Namespace tidak ditentukan.';
$_lang['namespace_err_remove'] = 'Terjadi kesalahan saat mencoba untuk menghapus namespace.';
$_lang['namespace_err_save'] = 'Terjadi kesalahan saat mencoba untuk menyimpan namespace.';
$_lang['namespace_assets_path'] = 'Aset jalan';
$_lang['namespace_assets_path_desc'] = 'Menentukan path absolut ke aset untuk Namespace ini di sini. Anda dapat menggunakan pengganti seperti {assets_path}. Contoh: {assets_path} komponen/democomponent /';
...
$_lang['namespace_update'] = 'Memperbarui Namespace';
