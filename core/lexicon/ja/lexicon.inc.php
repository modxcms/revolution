...
$_lang['lexicon_management'] = '言語エントリーの管理';
$_lang['lexicon_management_desc'] = 'MODx管理画面で用いる語彙(Lexicon)を各国語単位で管理します。原本となる語彙が/core/lexicon/ 以下にファイル形式で収録されており、この画面ではこれらの語彙の原本をDB側で上書きする管理を行なうことができます。';
