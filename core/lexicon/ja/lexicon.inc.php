...
$_lang['lexicon_management'] = 'レキシコンの管理';
$_lang['lexicon_management_desc'] = 'システム全体で用いる語彙(Lexicon)を管理します。原本となる語彙が/core/lexicon/ 以下にファイル形式で収録されており、この画面ではこれらの語彙の原本をDB側で上書きする管理を行なうことができます。';
