...
$_lang['action_desc'] = 'MODX管理画面のトップメニューの構成や、新規アクションの追加により管理ページ及びウェブアプリケーションのページの自作ができます。アクションを追加する場合はネームスペースを新規作成してください。';
...
$_lang['lang_topics'] = '言語トピック';
$_lang['lang_topics_desc'] = 'これは、このアクションが読み込むべき、言語トピックを示すリストです。';