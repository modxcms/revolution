...
$_lang['dashboard_description_desc'] = 'このダッシュボードについての短い説明';
$_lang['dashboard_edit'] = 'Edit the settings and Widget placements for this Dashboard';
$_lang['dashboard_hide_trees'] = '左側のツリーを隠す';
$_lang['dashboard_hide_trees_desc'] = 'このオプションを有効にすると、ウェルカムページで左側のツリーが表示されなくなります。';
$_lang['dashboard_name_desc'] = 'このダッシュボードの名前';
