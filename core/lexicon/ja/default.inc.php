...
$_lang['db_info_mysql'] = 'テーブルがオーバーヘッドを持つ場合、オーバーヘッドカラムのリンクをクリックすることで最適化するかもしれません。';
...
$_lang['showing_pub'] = '公開されたドキュメントを表示';
$_lang['showing_unpub'] = '公開待ちドキュメントを表示';
$_lang['snippet'] = 'スニペット';
