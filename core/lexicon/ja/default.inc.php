...
$_lang['confirm_unpublish'] = 'このドキュメントの公開を取り消すことで、設定された公開/公開取消日時は上書きされます。公開・公開取消日時をそのままにしたい場合は「ドキュメントの編集」を選択してください。<br />続けますか?';
$_lang['console'] = 'コンソール';
...
$_lang['refresh_lexicon_topics'] = '語彙トピックのキャッシュを初期化';
