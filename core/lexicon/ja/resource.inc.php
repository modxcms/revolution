...
$_lang['createedit_document'] = 'ドキュメントの作成・編集';
$_lang['createedit_static'] = '静的リソースの作成・編集';
$_lang['createedit_symlink'] = 'シムリンクの作成・編集';
$_lang['createedit_weblink'] = 'ウェブリンクの作成・編集';
$_lang['document'] = 'ドキュメント';
$_lang['document_create'] = 'ドキュメントの作成';
$_lang['document_create_here'] = 'ここにドキュメントを作成';
$_lang['document_new'] = '新しいドキュメント';
$_lang['documents'] = 'ドキュメント';
$_lang['duplicate_alias_found'] = 'リソース [[+id]] はすでにエイリアス [[+alias]] を使用しています。重複しないエイリアス名を入力してください。';
$_lang['empty_template'] = '(空)';
$_lang['general'] = '一般';
$_lang['markup'] = 'マークアップ/構造';
$_lang['none'] = 'なし';
$_lang['page_settings'] = 'ページ設定';
$_lang['preview'] = 'プレビュー';
...
$_lang['resource_change_template_confirm'] = 'このテンプレートを変更しますか？';
...
$_lang['resource_class_key_help'] = 'これはリソースのクラスキーです。MODxのタイプで表示します。';
$_lang['resource_content'] = 'リソースコンテンツ';
...
$_lang['resource_locked_by'] = 'リソースID [[+id]] は現在 [[+user]] にロックされています。';
...
$_lang['static_resource_create_here'] = 'ここに静的リソースを作成';
$_lang['static_resource_new'] = '新しい静的リソース';
$_lang['status'] = 'ステータス';
$_lang['symlink'] = 'シムリンク';
$_lang['symlink_create'] = 'シムリンクの作成';
...
$_lang['weblink_create'] = 'ウェブリンクの作成';
