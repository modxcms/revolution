...
$_lang['namespace_err_ns'] = 'Не е посочено пространство с имена.';
$_lang['namespace_err_remove'] = 'Възникна грешка при опита за пермахване на пространството от имена.';
$_lang['namespace_err_save'] = 'Възникна грешка при опита за запис на пространството от имена.';
$_lang['namespace_assets_path'] = 'Път към активи';
$_lang['namespace_assets_path_desc'] = 'Посочете тук абсолютен път към активите за това  пространство от имена. Може да използвате контейнери като {assets_path}. Пример: {assets_path}components/democomponent/';
...
$_lang['namespace_update'] = 'Актуализация на пространство от имена';
