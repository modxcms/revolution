...
$_lang['login_cannot_locate_account'] = 'आपके द्वारा प्रविष्टि किया गया उपयोगकर्तानाम या पासवर्ड गलत है । कृपया उपयोगकर्ता नाम जाचें, पासवर्ड दुबारा टाइप करें, और पुनः प्रयास करें ।';
...
$_lang['login_email_label'] = 'ई - मैल खाता';
$_lang['login_err_unknown'] = 'Log in करने का प्रयास करते समय एक अज्ञात त्रुटि उत्पन्न हुई।';
$_lang['login_forget_your_login'] = 'अपना पासवर्ड भूल गए?';
...
$_lang['login_back_to_login'] = 'लॉगिन पर वापिस जाएं';
...
$_lang['login_password'] = 'पासवर्ड';
$_lang['login_password_reset_act_sent'] = 'यदि उपयोगकर्ता या ईमेल मौजूद है, तो आपको शीघ्र ही एक ईमेल प्राप्त होगा ।';
$_lang['login_remember'] = 'मुझे [[+lifetime]] के लिए लॉगिन रखें';
$_lang['login_send_activation_email'] = 'Activation ईमेल भेजें';
$_lang['login_title'] = 'लॉगिन';
$_lang['login_user_err_nf_email'] = 'यदि उपयोगकर्ता या ईमेल मौजूद है, तो आपको शीघ्र ही एक ईमेल प्राप्त होगा ।';
$_lang['login_username'] = 'आईडी';
$_lang['login_username_or_email'] = 'उपयोगकर्ता का नाम या ईमेल';
...
$_lang['login_email_subject'] = 'आपका लॉगिन विवरण';
$_lang['login_magiclink_subject'] = 'आपका एक बार फिर का लॉगिन लिंक';
$_lang['login_magiclink_err'] = 'आपका लॉगिन लिंक मान्य नहीं है । कृपया एक नया अनुरोध करें ।';
...
$_lang['login_magiclink_default_msg'] = 'यदि आपका ईमेल <i>[[+email]]</I> किसी खाते के साथ पंजीकृत हैं, तो आपको शीघ्र ही एक ईमेल प्राप्त होगा ।';
$_lang['login_magiclink_error_msg'] = 'सिस्टम ईमेल के माध्यम से लॉगिन लिंक भेजने में सक्षम नहीं था । यदि यह त्रुटि स्थाई हैं तो कृपया साइट व्यवस्थापक से संपर्क करें ।';
...
$_lang['login_signup_email'] = '<p>नमस्कार, [[+उपयोगकर्ता नाम]]!</p><p>आपके लिए <strong>[[++site_name]]</strong> वेबसाइट पर एक खाता पंजीकृत किया गया था. यदि आप अपना पासवर्ड नहीं जानते हैं, [[++allow_manager_login_forgot_password:is=`1`:then=`लॉगिन स्क्रीन पर पासवर्ड भूल गए लिंक का उपयोग करके इसे रीसेट करें`:else=`अपने साइट व्यवस्थापक से पूछें`]]।</p> <p class="center"><a href="[[+url_scheme]][[+http_host]][[+manager_url]]" class="btn">लॉग इन करें [[++site_name]]</a </p>';
$_lang['login_greeting_morning'] = '<strong>सुप्रभात</strong>, फिर से  स्वागत हैं!';
$_lang['login_greeting_afternoon'] = '<strong>नमस्कार<strong>, फिर से स्वागत हैं!';
$_lang['login_greeting_evening'] = '<strong>नमस्कार</strong>, फिर से स्वागत है!';
$_lang['login_greeting_night'] = '<strong>नमस्कार</strong>, फिर से स्वागत है!';
$_lang['login_note'] = 'कृपया प्रबंधक तक पहुंचने के लिए लॉग इन करें। ';
$_lang['login_note_passwordless'] = 'एकमुस्त लॉगिन लिंक प्राप्त करने के लिए कृप्या अपना ईमेल पता दर्ज करें ।';
$_lang['login_magiclink_email_button'] = 'मुझे एक बार का लॉगिन लिंक भेजे';
$_lang['login_magiclink_email_placeholder'] = 'आपके उपयोगकर्ता खाते का ईमेल यहां';
$_lang['login_email'] = 'ईमेल';
$_lang['login_help_button_text'] = 'मदद';
$_lang['login_help_title'] = 'MODX के साथ सहायता प्राप्त करें';
...
$_lang['login_return_site'] = 'वेबसाइड पर लौटें';
