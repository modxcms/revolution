 ...
 * @subpackage lexicon
 */
$_lang['about_msg'] = 'MODX är ett <a href="http://modx.com/" target="_blank">PHP applikationsramverk och system för innehållshantering</a> och är licensierat under <a href="http://opensource.org/licenses/gpl-2.0.php">GNU Public License v2</a> och senare versioner (om du vill).';
