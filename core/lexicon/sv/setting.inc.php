...
$_lang['country'] = 'Land';
$_lang['description_desc'] = 'En kort beskrivning av inställningen. Det här kan vara en nyckel till en lexikonpost.';
$_lang['key_desc'] = 'Inställningens nyckel. Den kommer att bli tillgänglig i ditt innehåll via platshållaren [[++nyckel]].';
$_lang['name_desc'] = 'Inställningens namn. Det här kan vara en nyckel till en lexikonpost.';
...
$_lang['setting_cache_action_map_desc'] = 'När denna är aktiverad kommer händelser (eller controllerkartor) att cachas för att minska laddningstiderna i hanteraren.';
...
$_lang['setting_manager_html5_cache_desc'] = 'Experimentell. Använd HTML5-funktionen lokal cache i hanteraren. Rekommenderas endast om hanteraren används i moderna webbläsare.';
