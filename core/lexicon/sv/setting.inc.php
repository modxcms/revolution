...
$_lang['setting_filemanager_path'] = 'Sökväg till filhanteraren (Deprecated)';
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. IIS fyller oftast inte i inställningarna för document_root ordentligt, vilket används av filhanteraren för att bestämma vad du får se. Om du har problem med filhanteraren, se till så att denna katalog pekar till roten på din installation av MODX.';
$_lang['setting_filemanager_path_relative'] = 'Är filhanterarens sökväg relativ? (Deprecated)';
$_lang['setting_filemanager_path_relative_desc'] = 'Deprecated - Use Media Sources instead. Om din inställning för filemanager_path (Sökväg till filhanteraren) är relativ i förhållande till MODX base_path väljer du "Ja" här. Om din filemanager_path ligger utanför dokumentroten väljer du "Nej".';
$_lang['setting_filemanager_url'] = 'Filhanterarens URL (Deprecated)';
$_lang['setting_filemanager_url_desc'] = 'Deprecated - Use Media Sources instead. Valfri. Använd den här inställningen om du vill ange en uttrycklig URL för att komma åt filerna i MODX filhanterare (användbart om du har ändrat manager_path till en sökväg utanför MODX webbrot). Kontrollera att detta är den webbåtkomliga URL:en av det angivna värdet för filemanager_path. Om fältet lämnas tomt kommer MODX att försöka beräkna URL:en automatiskt.';
$_lang['setting_filemanager_url_relative'] = 'Är filhanterarens URL relativ? (Deprecated)';
$_lang['setting_filemanager_url_relative_desc'] = 'Deprecated - Use Media Sources instead. Om din inställning för filemanager_url (Filhanterarens URL) är relativ i förhållande till MODX base_url väljer du "Ja" här. Om din filemanager_url ligger utanför den huvudsakliga webbroten väljer du "Nej".';
