...
$_lang['plugin_disabled'] = 'Avaktiverad plugin';
$_lang['plugin_disabled_msg'] = 'Plugin:en är avaktiverad och kommer inte att svara på events.';
...
$_lang['plugin_event_update'] = 'Redigera pluginhändelse';
...
$_lang['plugin_msg'] = 'Här kan du skapa och redigera plugins. Plugins är "rå" PHP-kod som körs när de valda systemhändelserna utlöses.';
