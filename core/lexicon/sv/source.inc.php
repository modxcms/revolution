...
$_lang['source_edit'] = 'Redigera inställningar och användargruppsåtkomst för denna mediakälla';
$_lang['source_err_ae_name'] = 'Det finns redan en mediakälla med det namnet! Ange ett annat namn.';
$_lang['source_err_name_reserved'] = 'Källnamnet ”[[+reservedName]]” är reserverat. Välj ett annat namn.';
...
$_lang['source_reserved_general_desc'] = 'Observera att detta är en skyddad inbyggd mediakälla. De värden som visas nedan är endast i informationssyfte. Dess inställningar och tilldelade användargrupper kan dock redigeras av användare med lämpliga behörigheter.';
...
$_lang['skipExtensions'] = 'Undanta tillägg';
$_lang['prop_file.skipExtensions'] = 'En kommaseparerad lista med tillägg. MODX kommer inte att visa filer som matchar någon av dessa.';
