...
$_lang['fc.action_update'] = 'Redigera resurs';
$_lang['fc.action_resource_wildcard'] = 'Skapa & redigera resurs';
$_lang['field'] = 'Fält';
...
$_lang['import_from_xml'] = 'Importera set från XML';
$_lang['label'] = 'Etikett';
$_lang['original_value'] = 'Ursprungligt värde';
$_lang['profile'] = 'Profil';
$_lang['profile_create'] = 'Skapa profil';
...
$_lang['profile_msg'] = 'Här kan du ange set för den här profilen. Ett set är en uppsättning regler som gäller för en given sida (redigera eller skapa resurs). De kan vara begränsade till vissa mallar eller andra fältvärden som resursen har. Begränsningar för set som gäller skapa resurs utförs på grundval av föräldern till den nyskapade resursens värde.';
$_lang['profile_new'] = 'Skapa formuläranpassningsprofil';
...
$_lang['rule_update'] = 'Redigera regel';
...
$_lang['set_tvs_msg'] = 'Här kan du ange synlighet, etiketter, standardvärden och de flikar som ska använda dom genom att dubbelklicka på en rad i rutnätet. Notera: Om du flyttar en mallvariabel till en annan region så kan du justera ordningen på mallvariabeln i regionsrangfältet. Lämna ett fält tomt om du vill använda standardvärdet.';
...
$_lang['tab'] = 'Flik';
$_lang['tab_create'] = 'Skapa flik';
$_lang['tab_id'] = 'ID';
$_lang['tab_name'] = 'Flikens namn';
$_lang['tab_title'] = 'Titel';
$_lang['tab_new'] = 'Skapa flik';
...
$_lang['usergroup_create'] = 'Skapa användargrupp';
...
$_lang['usergroup_remove'] = 'Ta bort användargrupp från profil';
