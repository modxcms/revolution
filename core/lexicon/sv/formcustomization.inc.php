...
$_lang['form_customization_msg'] = 'Här är en lista på de regler som används för närvarande. Du kan hitta mer information om regler och formuläranpassningar <a href="https://docs.modx.com/current/en/building-sites/client-proofing/form-customization" target="_blank">här</a>. Notera att felaktiga regler kan ställa till med problem för din MODX-installation. Inaktiverade regler visas som blekt grå.';
