...
$_lang['rules'] = 'Regler';
$_lang['set'] = 'Set';
$_lang['set_and_fields'] = 'Settets information och fält';
...
$_lang['set_constraint_field_desc'] = 'Genom att ange ett värde i begränsningsfältet så kommer utförandet av  settets regler att förhindras om inte resursens fält matchar "begränsningsvärdet".';
...
$_lang['set_remove_confirm'] = 'Är du säker på att du vill ta bort det här settet? Det här går inte att ångra.';
...
$_lang['set_tabs_msg'] = 'Här kan du justera flikarna för den här sidan inklusive deras synlighet och titel. Dubbelklicka i en rad för att redigera dess värde. Lämna ett fält tomt om du vill använda standardvärdet.';
$_lang['set_template_desc'] = 'Genom att välja en mall så kommer utförandet av settets regler att begränsas om inte resursen använder den angivna mallen.';
$_lang['set_tvs_msg'] = 'Här kan du ange synlighet, etiketter, standardvärden och de flikar som ska använda dom genom att dubbleklicka i en rad. Notera: Om du flyttar en mallvariabel till en annan flik så kan du justera ordningen på mallvariablen i Flikrang-fältet. Lämna ett fält tomt om du vill använda standardvärdet.';
