...
$_lang['export_site_maxtime_message'] = 'Här kan du specificera antal sekunder som MODX har på sig att exportera webbplatsen (åsidosätter PHPs inställningar). Skriv 0 för obegränsad tid. Notera att om 0 eller ett väldigt högt värde skrivs, kan det få din server att göra konstiga saker och rekommenderas därför inte.';
