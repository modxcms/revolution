...
$_lang['system_events.create'] = 'Skapa händelse';
...
$_lang['system_events.groupname_desc'] = 'Namnet på den grupp som händelsen hör till. Välj en befintlig eller skriv in ett nytt gruppnamn.';
