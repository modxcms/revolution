...
$_lang['not_updated'] = 'Inte uppdaterad';
$_lang['package'] = 'Paket';
...
$_lang['package_err_remove'] = 'Ett fel inträffade när paket med signatur [[+signature]] skulle tas bort.';
...
$_lang['package_remove_confirm'] = 'Är du säker på att du vill ta bort detta paket? Borttagningen går inte att ångra.';
...
$_lang['provider_add_or'] = 'Eller skapa en leverantör...';
...
$_lang['provider_err_invalid_xml'] = 'Leverantören returnerade inte giltig XML. Kontrollera att tjänstens URL är giltig och att paketleverantören är tillgänglig för närvarande.';
...
$_lang['provider_err_not_selected'] = 'Du måste välja en leverantör från listan ovan för att fortsätta.';
...
$_lang['transport_package_create'] = 'Skapa paket';
