...
$_lang['chunk_tab_general_desc'] = 'Här kan du ange grundläggande attribut för denna <em>chunk</em> samt dess innehåll. Innehållet måste vara HTML, antingen placerat i fältet <em>Chunk-kod</em> nedan eller i en statisk extern fil, och kan inkludera MODX-taggar. Observera att PHP-kod inte kommer att köras i detta element.';
