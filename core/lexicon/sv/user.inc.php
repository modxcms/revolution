...
$_lang['user_created_password_message'] = 'Användaren <b>[[+username]]</b> har skapats. <br>Lösenordet är: <b>[[+password]]</b>';
...
$_lang['user_err_password_invalid'] = 'Ditt lösenord får inte innehålla ogiltiga tecken som /, \\, &apos;, &quot;, ;, <, >, (, ) eller {}.';
...
$_lang['user_group_err_remove'] = 'Ett fel inträffade när användargruppen skulle skapas.';
...
$_lang['user_group_new'] = 'Skapa användargrupp';
$_lang['user_group_parent'] = 'Föräldragrupp';
$_lang['user_group_remove'] = 'Ta bort användargrupp';
$_lang['user_group_remove_confirm'] = 'Är du säker på att du vill ta bort användargruppen "[[+user_group]]" och alla dess barn?';
...
$_lang['user_group_update'] = 'Redigera användargrupp';
...
$_lang['user_group_user_update_role'] = 'Redigera roll för användare i användargrupp';
...
$_lang['user_password_changed'] = 'Lösenordet ändrades till: <b>[[+password]]</b>';
...
$_lang['user_settings_desc'] = 'Du kan åsidosätta MODX systeminställningar på en per-användare-basis, eller skapa nya inställningar som är tillgängliga endast för den här användaren.';
...
$_lang['user_updated_password_message'] = 'Användaren <b>[[+username]]</b> uppdaterades.<br>Lösenordet är: <b>[[+password]]</b>';
