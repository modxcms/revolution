...
$_lang['context_edit'] = 'Redigera inställningar och användargruppsåtkomst för denna kontext';
...
$_lang['context_err_name_reserved'] = 'Kontextnamnet ”[[+reservedName]]” är reserverat. Välj ett annat namn.';
...
$_lang['context_err_ns_name'] = 'Ange ett giltigt namn på kontexten.';
...
$_lang['context_reserved_general_desc'] = 'Observera att detta är en skyddad inbyggd kontext. De värden som visas nedan är endast i informationssyfte. Dess inställningar och tilldelade användargrupper kan dock redigeras av användare med lämpliga behörigheter.';
