...
$_lang['permissions_desc'] = 'Här  kan du definiera specifika behörigheter som den här policyn kommer att innehålla. Alla användargrupper med denna policy kommer att ärva dessa behörigheter.';
...
$_lang['policy_property_create'] = 'Skapa åtkomstpolicy-egenskap';
$_lang['policy_property_new'] = 'Ny åtkomstpolicy-egenskap';
$_lang['policy_property_remove'] = 'Ta bort åtkomstpolicy-egenskap';
$_lang['policy_property_specify_name'] = 'Ange ett namn på policy-egenskapen:';
$_lang['policy_remove'] = 'Ta bort policy';
$_lang['policy_remove_confirm'] = 'Är du säker på att du vill ta bort den här åtkomstpolicyn?';
$_lang['policy_update'] = 'Uppdatera åtkomstpolicy';
