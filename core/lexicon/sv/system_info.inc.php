...
$_lang['database_table_droptablestatements'] = 'Generera DROP TABLE-kommandon.';
...
$_lang['database_table_reserved'] = 'Reserverat';//sqlsrv
...
$_lang['database_table_unused'] = 'Oanvänt';//sqlsrv
...
$_lang['sysinfo_desc'] = 'Här kan du se allmän information om din MODX-miljö.';
...
$_lang['truncate_table_err'] = 'Ett fel inträffade när tabellen skulle trunkeras';
