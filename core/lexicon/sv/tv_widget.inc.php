...
$_lang['combo_preserve_selectionorder_desc'] = 'När denna sätts till "Ja" visas sparade poster i den ordning de ursprungligen valdes. Annars visas posterna i den ordning som definierats i listans alternativ. (Standard: Ja)';
...
$_lang['number_strict_decimalprecision'] = 'Strikt decimalprecision';
$_lang['number_strict_decimalprecision_desc'] = 'När denna sätts till ”Ja” bevaras avslutande nollor i decimaltal (standard är ”Nej”).';
...
$_lang['hide_time'] = 'Göm tidsalternativet för användare';
$_lang['title'] = 'Titel';
