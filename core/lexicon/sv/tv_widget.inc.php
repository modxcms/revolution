...
$_lang['checkbox_display_switch'] = 'Visa som switch';
$_lang['checkbox_display_switch_desc'] = 'När satt till ”Ja” kommer denna mallvariabels inställningar att visas i resursredigeringsformuläret som switchar istället för kryssrutor. (Standard: ”Nej”)';
