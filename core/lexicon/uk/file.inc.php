...
$_lang['file_err_create_general_exception'] = 'Сталася невідома помилка при спробі створення файлу. Будь ласка, перевірте журнал помилок MODX та/або серверу для отримання додаткової інформації.';
$_lang['file_err_create_write_exception'] = 'Файл не вдалося створити. Будь ласка, перевірте, чи маєте права на запис у цільовий каталог, і спробуйте ще раз.';
...
$_lang['file_err_move_general_exception'] = 'Сталася невідома помилка при спробі створення файлу. Будь ласка, перевірте журнал помилок MODX та/або серверу для отримання додаткової інформації.';
$_lang['file_err_move_write_exception'] = 'Файл не вдалося створити. Будь ласка, перевірте, чи маєте права на запис у цільовий каталог, і спробуйте ще раз.';
...
$_lang['file_err_update_general_exception'] = 'Під час спроби оновити цей файл сталася невідома системна помилка. Будь ласка, перевірте журнали помилок MODX та/або сервера для отримання додаткової інформації.';
$_lang['file_err_update_write_exception'] = 'Файл не вдалося оновити. Будь ласка, перевірте, чи маєте права на запис до цього файлу, і спробуйте ще раз.';
...
$_lang['file_folder_err_move_general_exception'] = 'Під час спроби перемістити каталог сталася невідома помилка. Будь ласка, перевірте журнали помилок MODX та/або сервера для отримання додаткової інформації.
';
$_lang['file_folder_err_move_write_exception'] = 'Каталог не вдалося перемістити. Будь ласка, перевірте, чи маєте права на запис як для цього каталогу, так і для цільового каталогу, і спробуйте ще раз.';
...
$_lang['file_folder_err_rename_general_exception'] = 'Під час спроби перейменувати каталог сталася невідома помилка. Будь ласка, перевірте журнали помилок MODX та/або сервера для отримання додаткової інформації.';
$_lang['file_folder_err_rename_write_exception'] = 'Каталог не вдалося перейменувати. Будь ласка, перевірте, чи маєте права на запис для нього, і спробуйте ще раз.';
