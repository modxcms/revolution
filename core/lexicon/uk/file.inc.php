...
$_lang['file_confirm_remove'] = 'Ви дійсно бажаєте видалити цей файл? Видалення файлу може порушити роботу Вашого сайту. Переконайтеся, що знаєте, для чого потрібен цей файл перед тим, як його видалити.';
...
$_lang['file_folder_err_invalid_path'] = 'Недопустимий шлях до створення нового каталогу.';
...
$_lang['file_last_modified'] = 'Змінений';
