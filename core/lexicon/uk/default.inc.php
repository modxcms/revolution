...
$_lang['activity_message'] = 'Цей список показує останні дії з ресурсами:';
$_lang['activity_title'] = 'Нещодавно відредаговані/створені документи';
$_lang['add'] = 'Додати';
$_lang['add_chunk'] = 'Створити чанк';
$_lang['add_folder'] = 'Створити папку';
$_lang['add_plugin'] = 'Створити плагін';
$_lang['add_snippet'] = 'Створити сніпет';
$_lang['add_tag'] = 'Створити тег ';
$_lang['add_template'] = 'Створити шаблон';
...
$_lang['add_to_category_template'] = 'Створити шаблон тут';
$_lang['add_to_category_this'] = 'Створити [[+type]] тут';
$_lang['add_to_category_tv'] = 'Створити TV тут';
$_lang['add_tv'] = 'Створити TV тут';
$_lang['add_weblink'] = 'Створити посилання';
$_lang['add_symlink'] = 'Створити символічне посилання';
...
$_lang['category_create_desc'] = 'Категорія буде відображатися лише тоді, коли хоча б один Елемент призначений їй (за замовчуванням, всі Категорії, навіть порожні, відображаються у Дереві категорії).';
...
$_lang['clear_cache_on_save'] = 'Очистити кеш'; // make consistent with how this appears on Resource editing panel
$_lang['clear_cache_on_save_desc'] = 'Очистити кеш під час збереження елемента. '; // make more general, as this action clears more than just this item's cache files
...
$_lang['confirm_remove_multiple'] = 'Ви дійсно бажаєте видалити виділені елементи?';
...
$_lang['datetime_conversion_err_invalid_mysql_format'] = 'Спроба перетворення значення “[[+value]]” на timestamp, але значення не в потрібному mysql форматі  (Y-m-d H:i:s).';
...
$_lang['duplicate_context'] = 'Дублювати контекст';
...
$_lang['duplicate_redirect'] = 'Перенаправити на дублікат';
...
$_lang['error_grid_get_content_no_msg'] = 'Помилка сервера заблокувала завантаження вмісту цієї сітки. Щоб отримати додаткову інформацію, змініть MODX debug налаштування на 1 або на порожнє (не 0, оскільки у звіті буде вимкнено дану функцію).';
$_lang['error_grid_get_content_tolog'] = 'Завантаження вмісту сітки заборонено. Перегляньте ваші дані у консолі браузеру, лог менеджера та/або лог сервера для отримання додаткової інформації.';
$_lang['error_grid_get_content_toscreen'] = 'Вміст цієї cітки не може бути завантажений через помилку сервера: [[+message]]';
...
$_lang['ext_minvalmaxfield'] = 'Мінімальне значення не може бути більшим, ніж максимальне значення ';
...
$_lang['ext_maxvalminfield'] = 'Максимальне значення не може бути меншим, ніж мінімальне значення ';
...
$_lang['grid_column_creator_description'] = 'Вказує сутність, яка створила дані та налаштування рядків (лише для читання)';
$_lang['group'] = 'Група';
$_lang['guid'] = 'GUID';
...
$_lang['mail_to_err_server_error'] = 'Помилка поштового сервера завадила доставці на <em>[[+recipient]]</em>. Будь ласка, зверніться до вашого системного адміністратора, якщо проблема не зникає.';
$_lang['male'] = 'Чоловік';
...
$_lang['name'] = 'Ім\'я';
$_lang['new'] = 'Новий';
$_lang['new_chunk'] = 'Створити чанк';
$_lang['new_folder'] = 'Створити папку';
$_lang['new_key'] = 'Створити ключ';
$_lang['new_message'] = 'Створити повідомлення';
$_lang['new_name'] = 'Нове ім\'я';
$_lang['new_parent'] = 'Створити батьківський ресурс ';
$_lang['new_plugin'] = 'Створити плагін';
$_lang['new_snippet'] = 'Створити сніпет';
$_lang['new_template'] = 'Створити шаблон';
$_lang['new_tv'] = 'Створити TV';
$_lang['new_user'] = 'Створити користувача';
$_lang['next'] = 'Далі -&gt;';
$_lang['no'] = 'Ні';
...
$_lang['open'] = 'Відкрити';
$_lang['options'] = 'Опції';
$_lang['orm_attribute_add'] = 'Створити атрибут';
$_lang['orm_attribute_add_below'] = 'Додати атрибут нижче тут';
...
$_lang['orm_container_add'] = 'Створити контейнер';
$_lang['orm_container_add_below'] = 'Створити контейнер нижче тут';
...
$_lang['package_extra'] = 'Додаток';
$_lang['package_extras'] = 'Додатки';
...
$_lang['quick_update'] = 'Швидке редагування';
$_lang['quick_update_chunk'] = 'Швидко редагувати чанк';
$_lang['quick_update_file'] = 'Швидко редагувати файл';
$_lang['quick_update_plugin'] = 'Швидко редагувати плагін';
$_lang['quick_update_resource'] = 'Швидке редагування';
...
$_lang['refresh_context'] = 'Оновити контекст';
...
$_lang['remove_context'] = 'Видалити контекст';
...
$_lang['resource_groups_panel_desc'] = '<p>Перетягуйте Ресурси в Групи ресурсів і між ними.</p><p>За замовчуванням, коли ви перетягуєте Ресурс з однієї групи до іншої, він буде <em>переміщений</em>, а не скопійований. Щоб <em>скопіювати</em> Ресурс з однієї групи до іншої, натисніть і утримуйте клавішу <strong>option/alt</strong> перед тим, як натиснути на ресурс і перетягнути його.</p>';
...
$_lang['site_unavailable_message'] = 'Сайт в даний час недоступний';
...
$_lang['stay_new'] = 'Створити ще один';
...
$_lang['unedited'] = 'Невідредаговано';
$_lang['unknown'] = 'Невідоме';
...
$_lang['context_menu'] = 'Контекстне меню';
...
$_lang['template_empty'] = '(пусто)';
$_lang['template_empty_desc'] = '(Примітка: Шаблон не був призначений для цього набору)';
$_lang['template_missing'] = '(відсутнє)';
$_lang['template_missing_reassign'] = '(відсутній — виберіть шаблон або “порожній“ із цього списку)';
$_lang['template_missing_desc'] = '(Примітка: Призначений шаблон вже не існує)';
