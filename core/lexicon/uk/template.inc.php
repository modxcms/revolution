...
$_lang['template_icon_description'] = 'Необов\'язково. Користувацький клас CSS іконки для всіх ресурсів з цим шаблоном. Наприклад, шрифт Awesome (безкоштовний) клас, наприклад icon-home або fa-home.';
...
$_lang['template_source'] = 'Джерело файлів ';
$_lang['template_source_description'] = 'Джерело файлів для вибору статичного або попереднього перегляду. Якщо джерело не задане, передбачається, що ви вкажете абсолютний шлях. ';
$_lang['template_preview'] = 'Попередній перегляд шаблону ';
$_lang['template_preview_description'] = 'Скріншот шаблону, який використовується як попередній перегляд. Найкращий розмір 335 x 236 (ш x д) ';
