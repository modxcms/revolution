...
$_lang['about_desc'] = 'Дізнайтеся більше і отримайте допомогу з MODX';
...
$_lang['api_docs_desc'] = 'Повна документація для API для MODX Revolution. ';
...
$_lang['eventlog_viewer_desc'] = 'Переглянути журнал помилок MODX';
...
$_lang['media'] = 'Медіа';
$_lang['media_desc'] = 'Оновити джерела медіа та медіа';
...
$_lang['refreshuris_desc'] = 'Перегенерувати URI ресурсів системи';
...
$_lang['site_schedule_desc'] = 'Перегляд ресурсів з майбутніми днями публікації або зняттям з публікації';
...
$_lang['view_logging'] = 'Журнал системи керування';
$_lang['view_logging_desc'] = 'Перегляд останніх переглядів діяльності менеджера';
$_lang['view_sysinfo'] = 'Інформація про систему';
$_lang['view_sysinfo_desc'] = 'Перегляд інформації про сервер, такої як phpinfo, інформації про базу даних і багато іншого';
$_lang['wiki'] = 'Вікі (Automatic Translation)';
$_lang['wiki_desc'] = 'Запуск офіційної документації MODX';
