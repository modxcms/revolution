...
$_lang['perm.edit_tv_desc'] = 'Для редагування будь-яких змінних шаблону. <strong> УВАГА: в поєднанні з дозволами save_tv надає доступ для виконання прив\'язок до TV, які можна використовувати для розкриття таких секретів, як паролі та системні налаштування.</strong>';
...
$_lang['perm.file_update_desc'] = 'Для оновлення вмісту фізичних файлів. <strong>УВАГА: надає можливість виконувати довільний серверний код.</strong>';
