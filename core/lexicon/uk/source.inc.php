...
$_lang['source_edit'] = 'Редагувати налаштування та Групу Користувачів для цього Джерела Медіа';
$_lang['source_err_ae_name'] = 'Джерело медіа з таким іменем вже існує! Будь ласка, вкажіть інше ім\'я.';
$_lang['source_err_name_reserved'] = 'Назва джерела “[[+reservedName]]” зарезервована. Будь ласка, оберіть іншу назву.';
...
$_lang['source_reserved_general_desc'] = 'Зверніть увагу, що це захищене, вбудоване Джерело Медіа. Значення, наведені нижче, подано лише для ознайомлення. Однак його властивості та призначені Групи користувачів можна редагувати користувачам із відповідними правами доступу.';
