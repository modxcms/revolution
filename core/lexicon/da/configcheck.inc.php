...
$_lang['configcheck_configinc_msg'] = 'Dit websted er sårbart over for hackere, der kan gøre en masse skade på webstedet. Skift venligst din configfil så den kun er læsbar! Hvis du ikke er sideadministrator, bedes du kontakte en og advare om denne besked! Den er beliggende på [[+ sti]]';
$_lang['configcheck_default_msg'] = 'En uspecificeret advarsel blev fundet. Hvilket er mærkeligt...';
$_lang['configcheck_errorpage_unavailable'] = 'Dit websites fejlside er ikke tilgængelig.';
...
$_lang['configcheck_errorpage_unpublished_msg'] = 'Dette betyder, at din fejlside er utilgængelige for offentligheden. Offentliggør siden eller sørg for den er tildelt til en eksisterende ressource fra dit website i systemindstillings menuen.';
...
$_lang['configcheck_unauthorizedpage_unpublished'] = 'Den uautoriseret adgang side, defineret i websites konfigurationsindstillingerne er ikke offentliggjort.';
$_lang['configcheck_unauthorizedpage_unpublished_msg'] = 'Dette betyder, at din uautoriseret adgang side er utilgængelige for offentligheden. Offentliggør siden eller sørg for den er tildelt til en eksisterende ressource fra dit website i systemindstillings menuen.';
