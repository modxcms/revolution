...
$_lang['activity_title'] = 'Poprzednie dokumenty';
$_lang['add'] = 'Add';
...
$_lang['confirm_unpublish'] = 'Un-publishing this document now will remove any (un)publishing dates that may have been set. If you wish to set or keep publish or unpublish dates, please choose to edit the document instead.<br />Proceed?';
...
$_lang['rank'] = 'Rank';
$_lang['recent_docs'] = 'Poprzednie dokumenty';
