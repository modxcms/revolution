...
$_lang['security_notices'] = 'Powiadomienia bezpieczeństwa MODX'; #
...
$_lang['yourinfo_message'] = 'Kilka informacji o Twoim koncie użytkownika:'; #

#$_lang['yourinfo_previous_login'] = 'Your last login:';
$_lang['yourinfo_previous_login'] = 'Poprzednie logowanie:'; #

#$_lang['yourinfo_title'] = 'Your info';
$_lang['yourinfo_title'] = 'Twoje konto użytkownika'; # ? Seems not to be used in user info box caption?

#$_lang['yourinfo_total_logins'] = 'Total number of logins:';
$_lang['yourinfo_total_logins'] = 'Liczba logowań:'; #

#$_lang['yourinfo_username'] = 'You are logged in as:';
$_lang['yourinfo_username'] = 'Twój login:'; #
