...
$_lang['default_value'] = 'Προεπιλεγμένη τιμή';
...
$_lang['filter_by_search'] = 'Αναζήτηση...';
...
$_lang['set_import_err_upload'] = 'Παρουσιάστηκε σφάλμα κατά την αναζήτηση του αρχείου XML. Παρακαλώ προσδιορίστε ένα έγκυρο αρχείο.';
