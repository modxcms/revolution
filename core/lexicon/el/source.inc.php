 ...
 * @subpackage lexicon
 */
$_lang['access'] = 'Δικαιώματα πρόσβασης';
...
$_lang['skipExtensions'] = 'παράλειψηΕπεκτάσεων';
$_lang['prop_file.skipExtensions'] = 'Λίστα επεκτάσεων διαχωρισμένη με κόμμα. Το MODX δεν θα εμφανίζει αρχεία που ταιριάζουν με οποιαδήποτε από αυτές.';
