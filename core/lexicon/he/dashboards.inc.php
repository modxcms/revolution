...
$_lang['dashboard_description_desc'] = 'תיאור קצר של לוח המחוונים.';
...
$_lang['dashboard_hide_trees_desc'] = 'ע״י סימון תיבת הבחירה הזו, עץ הדפים בצד שמאל יוסתר בעת טעינת לוח מחוונים זה בדף הפתיחה.';
$_lang['dashboard_name_desc'] = 'שם לוח המחוונים.';
...
$_lang['w_no_data'] = 'אין נתונים להצגה';
