...
$_lang['configcheck_htaccess_msg'] = 'MODX detectou que sua pasta /core está(parcialmente) acessível ao público. <strong>Isso não é recomendado e é um risco de segurança.</strong> Se sua instalação de MODX está sendo executado em um servidor Web Apache você deve configurar pelo menos o arquivo .htaccess dentro o pasta core <em>[[+fileLocation]]</em>. Isto pode ser feito facilmente, renomeando o arquivo de exemplo ht.access para .htaccess.<p>Existem outros métodos e servidores Web, caso utilize, por favor leia o <a href="https://rtfm.modx.com/revolution/2.x/administering-your-site/security/hardening-modx-revolution">Guia de Segurança MODX</a> para mais informações sobre como proteger seu site.</p>Se você configurar tudo corretamente, por exemplo, navegando para o <a href="[[+checkUrl]]" target="_blank">Changelog</a> deve dar-lhe um 403 (permissão negada) ou melhor um 404 (não encontrado). Se você pode ver o changelog lá no navegador, algo está errado e você precisa reconfigurar ou chamar um especialista para resolver isso.';
