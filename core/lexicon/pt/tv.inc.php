...
$_lang['tv_tab_input_options'] = 'Opções de entrada';
...
$_lang['tv_tab_output_options'] = 'Opções de saída';
...
$_lang['tv_tab_sources_desc'] = 'Aqui você pode atribuir os meios de comunicação que estão a ser utilizados para este VT em cada contexto específico. Dê um duplo clique no nome da fonte na grade para mudá-lo.';
$_lang['tv_tab_tmpl_access'] = 'Acesso ao Template';
