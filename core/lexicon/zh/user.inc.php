...
$_lang['user_fax'] = 'Fax';
$_lang['user_female'] = '女士';
$_lang['user_full_name'] = '全称';
$_lang['user_group'] = 'User Group';
$_lang['user_group_create'] = '创建用户组';
