...
/* ftp source type */
$_lang['prop_ftp.host_desc'] = '服务器主机名或IP地址';
...
$_lang['prop_ftp.port_desc'] = '服务器端口，默认为21。';
$_lang['prop_ftp.root_desc'] = '连接后根目录将打开';
$_lang['prop_ftp.passive_desc'] = '启用或禁用FTP被动模式';
$_lang['prop_ftp.ssl_desc'] = '启用或禁用ssl连接';
