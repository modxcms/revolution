...
$_lang['configcheck_configinc_msg'] = 'Il tuo sito è molto vulnerabile: gli hackers possono danneggiarlo pesantemente. Setta il file config in sola lettura! Se non sei l\'amministratore del sito, contatta un amministratore di sistema e avvisalo di questo messaggio! Il file in questione è il seguente: core/config/config.inc.php';
