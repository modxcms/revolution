...
$_lang['access_category_err_ae'] = 'Una ACL per questa Categoria esiste gia\'!';
...
$_lang['access_context_err_ae'] = 'Una ACL per quel Contesto esiste gia\'!';
...
$_lang['access_err_ae'] = 'La ACL esiste gia\'!';
...
$_lang['access_err_save'] = 'Errore salvando l\'ACL!';
...
$_lang['access_permissions_documents_tab'] = 'Qui puoi vedere quali gruppi di documenti sono stati specificati. Puoi anche creare nuovi gruppi, rinominarli e vedere quali documenti sono nei vari gruppi (sposta il puntatore del mouse sopra l\'id del documento per vedere il suo nome). Per aggiungere un documento a un gruppo o rimuovere un documento da un gruppo, modifica direttamente il documento.';
...
$_lang['access_permissions_links_tab'] = 'Qui e\' dove specifichiamo quale gruppo utente ha i diritti di accesso,cioe\' puo\' modificare o creare figli, per il gruppo di documenti. Per collegare un gruppo di documenti a un gruppo di utenti, seleziona il gruppo dalla casella a discesa e premi su \'Collega\'. Per rimuovere il collegamento per un particolare gruppo, premi \'Rimuovi \'. Questo rimuovera\' immediatamente il collegamento.';
$_lang['access_permissions_no_documents_in_group'] = 'Nessuno.';
$_lang['access_permissions_no_users_in_group'] = 'Nessuno.';
$_lang['access_permissions_off'] = '<span class="warning">Permessi d\'Accesso non attivati.</span> Questo significa che qualunque modifica fatta qui non avra\' nessun effetto finche\' i Permessi d\'Accesso non saranno attivati.';
...
$_lang['access_permissions_user_group'] = 'Gruppi utenti:';
...
$_lang['access_rgroup_err_ae'] = 'Una ACL per questo gruppo risorse esiste gia\'!';
...
$_lang['access_rgroup_err_remove'] = 'Un errore e\' occorso mentre tentavo di rimuovere l\'ACL per il Gruppo di Risorse.';
...
$_lang['resource_group_access_remove_confirm'] = 'Sei sicuro che vuoi rimuovere questa risorsa dal gruppo risorse?';
$_lang['resource_group_create'] = 'Crea Gruppo Risorse';
$_lang['resource_group_err_ae'] = 'Un gruppo risorse con questo nome esiste gia\'.';
$_lang['resource_group_err_create'] = 'Un errore e\' occorso mentre tentavo di creare il gruppo risorse.';
$_lang['resource_group_err_nf'] = 'Il gruppo di risorse non e\' stato trovato.';
$_lang['resource_group_err_ns'] = 'Gruppo di risorse non specificato.';
$_lang['resource_group_err_remove'] = 'Un errore e\' occorso mentre tentavo di rimuovere il gruppo risorse.';
...
$_lang['resource_group_resource_err_ae'] = 'La risorsa e\' gia\' parte di questo gruppo risorse.';
$_lang['resource_group_resource_err_create'] = 'Un errore e\' occorso mentre tentavo di mettere la risorsa nel gruppo risorse.';
$_lang['resource_group_resource_err_nf'] = 'La risorsa non e\' parte di questo gruppo risorse.';
$_lang['resource_group_resource_err_remove'] = 'Un errore e\' occorso mentre tentavo di rimuovere la risorsa dal gruppo risorse.';
$_lang['resource_group_untitled'] = 'Gruppo Risorse senza titolo';
$_lang['roles_msg'] = 'Un ruolo e\', per definizione, una posizione o uno status che uno detiene in una certa situazione. Possono essere usati per raggruppare gli Utenti in posizioni o status all\'interno di un Gruppo Utenti. I Ruoli in MODx hanno anche quella che si chiama "Autorita\'", definita da un valore numerico intero. I livelli di Autorita\' sono "ereditabili in basso", nel senso che un Ruolo con Autorita\' 1 ereditera\' qualunque Politica di Gruppo assegnata a se stesso e a qualunque ruolo con livello di Autorita\' maggiore di 1.';
$_lang['user_group_category_access'] = 'Elemento di Categoria d\'Accesso';
$_lang['user_group_category_access_msg'] = 'Qui puoi indicare a quali Elementi questo Gruppo Utente puo\' accedere, attraverso le Categorie in cui si trovano gli Elementi.';
$_lang['user_group_category_err_ae'] = 'Questo Gruppo Utenti ha gia\' accesso a questa Categoria.';
$_lang['user_group_category_remove_confirm'] = 'Sei sicuro che vuoi rimuovere questa Categoria da questo Gruppo Utenti?';
$_lang['user_group_context_access'] = 'Accessi Contesti';
$_lang['user_group_context_access_msg'] = 'Qui puoi indicare a quali Contesti questo Gruppo Utenti puo\' accedere.';
$_lang['user_group_context_err_ae'] = 'Questo Gruppo Utenti ha gia\' accesso a questo Contesto.';
$_lang['user_group_context_remove_confirm'] = 'Sei sicuro che vuoi rimuovere questo Contesto da questo Gruppo Utenti?';
$_lang['user_group_resourcegroup_access'] = 'Accessi Gruppi Risorse';
$_lang['user_group_resourcegroup_access_msg'] = 'Qui puoi indicare a quali Gruppi Risorse questo Gruppo Utenti puo\' accedere.';
$_lang['user_group_resourcegroup_err_ae'] = 'Questo Gruppo Utenti ha gia\' accesso a questo Gruppo Risorse.';
