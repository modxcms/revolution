...
$_lang['import_base_path'] = 'Inserisci il percorso base che contiene i file da importare.<br /><small><em>Lascia il campo vuoto per usare l\'impostazione del contesto in uso.</em></small>';
$_lang['import_duplicate_alias_found'] = 'La risorsa [[+id]] utilizza gia\' l\'alias [[+alias]]. Inserire un alias univoco.';
$_lang['import_element'] = 'Inserisci l\'elemento HTML di origine da importare:';
$_lang['import_enter_root_element'] = 'Inserisci l\'elemento di origine da importare:';
...
$_lang['import_site_time'] = 'Importazione conclusa. L\'importazione e\' durata %s secondi.';
