...
$_lang['password_gen_method'] = 'Modalita\' Genera Password';
$_lang['password_gen_specify'] = 'Lasciami specificare la password:';
$_lang['password_method'] = 'Modalita\' Notifica Password';
...
$_lang['role_err_ae'] = 'Esiste gia\' un ruolo con questo nome.';
$_lang['role_err_duplicate'] = 'Si e\' verificato un errore durante la duplicazione del ruolo.';
$_lang['role_err_has_users'] = 'Ci sono degli utenti con questo ruolo. Non puo\' essere cancellato.';
...
$_lang['role_err_remove'] = 'Si e\' verificato un errore durante il tentativo di rimuovere il ruolo.';
$_lang['role_err_remove_admin'] = 'Stai provando a rimuovere il ruolo di amministratore. Questo ruolo non puo\' essere cancellato!';
...
$_lang['user_already_in_use'] = 'Nome Utente gia\' in uso!';
$_lang['user_block'] = 'Bloccato';
$_lang['user_blockedafter'] = 'Bloccato dal';
...
$_lang['user_created_password_message'] = 'L\'utente e\' stato creato. La password e\': [[+password]]';
...
$_lang['user_edit_self_msg'] = 'E\' possibile che tu debba uscire (log out) e rientrare (log in) nuovamente dopo il salvataggio, per aggiornare completamente le tue informazioni.</strong><br>Inoltre, nel caso tu debba generare una nuova password personale, questa ti verra\' inviata tramite e-mail.';
$_lang['user_email'] = 'Indirizzo E-mail';
$_lang['user_err_access_permissions_save'] = 'Si e\' verificato un errore durante il salvataggio dei permessi di accesso dell\'utente.';
$_lang['user_err_ae_group'] = 'Utente gia\' presente in questo gruppo!';
$_lang['user_err_already_exists'] = 'Nome Utente gia\' in uso!';
$_lang['user_err_already_exists_email'] = 'Email gia\' in uso!';
...
$_lang['user_err_not_specified_blockedafter'] = 'Specifica la data dopo cui sara\' bloccato nel formato mm/gg/AAAA. ';
$_lang['user_err_not_specified_blockeduntil'] = 'Specifica la data fino a cui sara\'bloccato nel formato mm/gg/AAAA.';
...
$_lang['user_err_not_specified_fileman_path'] = 'La directory che hai specificato :<br />1) O non esiste.<br />2) O non ha i permessi di lettura.<br />3) O non e\' una directory.';
...
$_lang['user_err_not_specified_managertheme'] = 'Il tema del manager che hai specificato non e\' stato caricato (uploaded).';
...
$_lang['user_err_not_specified_notification_method'] = 'Specifica la modalita\' di notifica della nuova password.';
...
$_lang['user_err_not_specified_resourcedir'] = 'La directory che hai specificato non e\' valida.';
...
$_lang['user_err_remove'] = 'Si e\' verificato un errore durante durante il tentativo di rimuovere l\'utente.';
$_lang['user_err_resource_subdirectory'] = 'La directory che hai specificato non contiene le directories %s.';
$_lang['user_err_save'] = 'Si e\' verificato un errore durante il salvataggio dell\'utente.';
...
$_lang['user_group_document_group_err_already_exists'] = 'Il Gruppo Utenti e\' gia\' associato a questo gruppo di documenti.';
$_lang['user_group_document_group_err_create'] = 'Si e\' verificato un errore durante il tentativo di associare il Gruppo Utenti al gruppo di documenti.';
$_lang['user_group_document_group_err_not_found'] = 'Questo Gruppo Utenti non e\' associato a questo gruppo di documenti!';
$_lang['user_group_document_group_err_remove'] = 'Si e\' verificato un errore durante il tentativo di scollegare il Gruppo Utenti dal gruppo di documenti.';
$_lang['user_group_err_already_exists'] = 'Esiste gia\' un Gruppo Utenti con questo nome.';
$_lang['user_group_err_create'] = 'Si e\' verificato un errore durante il tentativo di creare il Gruppo Utenti.';
...
$_lang['user_group_err_remove'] = 'Si e\' verificato un errore durante il tentativo di rimuovere il Gruppo Utenti.';
$_lang['user_group_err_remove_admin'] = 'Non puoi rimuovere il Gruppo Amministratori.';
$_lang['user_group_err_save'] = 'Si e\' verificato un errore durante il tentativo di salvare il Gruppo Utenti.';
$_lang['user_group_management_msg'] = 'Gestisci l\'appartenenza degli utenti ai gruppi e applica i ruoli.';
$_lang['user_group_member_err_already_in'] = 'Utente gia\' presente in questo Gruppo Utenti!';
$_lang['user_group_member_err_create'] = 'Si e\' verificato un errore durante il tentativo di aggiungere l\'Utente a un Gruppo Utenti.';
$_lang['user_group_member_err_nf'] = 'Utente non presente in questo Gruppo Utenti!';
$_lang['user_group_member_err_remove'] = 'Si e\' verificato un errore durante il tentativo di rimuovere questo utente dal gruppo.';
$_lang['user_group_member_err_save'] = 'Si e\' verificato un errore durante il tentativo di aggiungere l\'utente al gruppo.';
...
$_lang['user_is_blocked'] = 'Questo Utente e\' bloccato!';
...
$_lang['user_profile_err_save'] = 'Si e\' verificato un errore durante il tentativo di salvare gli attributi dell\'utente.';
$_lang['user_remove'] = 'Rimuovi Utente';
$_lang['user_remove_confirm'] = 'Sei sicuro di voler rimuovere questo utente? Questa operazione e\' irreversibile!';
$_lang['user_remove_multiple'] = 'Rimuovi Utenti Multipli';
$_lang['user_remove_multiple_confirm'] = 'Sei sicuro di voler rimuovere questi utenti? Questa operazione e\' irreversibile!';
$_lang['user_remote_data_msg'] = 'Modifica dati utente remoti.';
$_lang['user_role_update'] = 'Aggiorna Ruolo Utente';
$_lang['user_setting_err_remove'] = 'Si e\' verificato un errore durante la rimozione delle impostazioni utente.';
$_lang['user_setting_err_save'] = 'Si e\' verificato un errore durante il salvataggio delle impostazioni utente.';
...
$_lang['user_updated_password_message'] = 'L\'Utente e\' stato aggiornato. La password e\': [[+password]]';
...
$_lang['user_use_config'] = 'Usa Imostazioni di Configurazione del Sistema';
