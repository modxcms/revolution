...
$_lang['area_lexicon_string_msg'] = 'Inserisci qui la Chiave del termine associato all\'area. Se non c\'è alcuna denominazione corrispondente, verrà mostrata soltanto la Chiave stessa (il nome univoco).<br />Aree Core: authentication, caching, file, furls, gateway, language, manager, session, site, system';
...
$_lang['setting_filemanager_path'] = 'Percorso del File Manager (Deprecated)';
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. IIS spesso non completa in modo corretto il valore document_root, che è usato per determinare cosa puoi vedere dal file manager. Se stai incontrando problemi usando il file manager, assicurati che questo percorso punti alla root della tua installazione di MODX.';
$_lang['setting_filemanager_path_relative'] = 'Il percorso del File Manager è Relativo? (Deprecated)';
$_lang['setting_filemanager_path_relative_desc'] = 'Deprecated - Use Media Sources instead. Se il tuo valore del filemanager_path è relativo rispetto al base_path di MODX, allora imposta questo valore a \'SI\'. Se il tuo filemanager_path è esterno rispetto alla radice dei documenti (docroot), imposta questo su \'NO\'.';
$_lang['setting_filemanager_url'] = 'File Manager Url (Deprecated)';
$_lang['setting_filemanager_url_desc'] = 'Deprecated - Use Media Sources instead. Opzionale. Specifica questo valore se vuoi impostare un esplicito URL per accedere ai files tramite il file manager di MODX (utile se hai cambiato il valore filemanager_path con un percorso esterno alla radice web (webroot) di MODX). Assicurati che questa sia URL, accessibile da web, del parametro del filemanager_path. Se lasci questo campo vuoto, MODX proverà a calcolarlo automaticamente.';
$_lang['setting_filemanager_url_relative'] = 'L\'URL del File Manager è Relativa? (Deprecated)';
$_lang['setting_filemanager_url_relative_desc'] = 'Deprecated - Use Media Sources instead. Se il tuo valore del filemanager_url è relativo rispetto alla base_url di MODX, allora imposta questo valore a \'SI\'. Se il tuo filemanager_url è esterno rispetto alla radice web (webroot), imposta questo su \'NO\'.';
