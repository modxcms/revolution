...
$_lang['area_furls'] = 'URL Semplici (Friendly URLs, FURL)';
...
$_lang['area_lexicon_string_msg'] = 'Inserisci qui il NomeUnivoco del termine associato all\'area. Se non c\'e\' alcuna denominazione corrispondente, verra\' mostrato soltanto il NomeUnivoco stesso.<br />Aree Core:<ul><li>authentication</li><li>caching</li><li>file</li><li>furls</li><li>gateway</li><li>language</li><li>manager</li><li>session</li><li>site</li><li>system</li></ul>';
$_lang['area_site'] = 'Sito';
$_lang['area_system'] = 'Sistema e Server';
$_lang['areas'] = 'Aree';
$_lang['namespace'] = 'Blocco';
$_lang['namespace_filter'] = 'Filtra per Blocco...';
$_lang['search_by_key'] = 'Cerca per NomeUnivoco...';
$_lang['setting_create'] = 'Crea Nuova Impostazione';
$_lang['setting_err'] = 'Controlla i dati per i seguenti campi: ';
$_lang['setting_err_ae'] = 'Una Impostazione con questo NomeUnivoco esiste di gia\'. Specifica un NomeUnivoco diverso.';
$_lang['setting_err_nf'] = 'Impostazione non trovata.';
$_lang['setting_err_ns'] = 'Impostazione non specificata';
$_lang['setting_err_remove'] = 'Si e\' verificato un errore durante il tentativo di rimuovere l\'Impostazione.';
$_lang['setting_err_save'] = 'Si e\' verificato un errore durante il tentativo di salvare l\'Impostazione.';
...
$_lang['settings_after_install'] = 'Dal momento che questa e\' una nuova installazione, sei pregato di controllare queste impostazioni, puoi cambiare qualsiasi cosa tu voglia. Dopo aver controllato le varie opzioni, clicca su \'Salva\' per aggiornare il database delle Impostazioni.<br /><br />';
$_lang['settings_desc'] = 'Qui puoi impostare le preferenze generali e le configurazioni per l\'interfaccia del manager di Gestione nonche\' per il funzionamento stesso del tuo sito.  Clicca due volte sulla colonna con il valore della impostazione che vorresti modificare dinamicamente dalla griglia, oppure clicca con il tasto destro su una voce per maggiori opzioni. Puoi anche cliccare sul simbolo "+" per una descrizione della impostazione.';
$_lang['settings_furls'] = 'URLs semplici (FURLs)';
$_lang['settings_misc'] = 'Varie';
$_lang['settings_site'] = 'Sito';
$_lang['settings_ui'] = 'Interfaccia e Funzionalita\'';
$_lang['settings_users'] = 'Utente';
$_lang['system_settings'] = 'Impostazione Sistema';

// user settings
$_lang['setting_allow_mgr_access'] = 'Accesso Pannello Controllo';
$_lang['setting_allow_mgr_access_desc'] = 'Seleziona questa opzione per abilitare o disabilitare l\'accesso al pannello di controllo (manager). <strong>NOTA: Se questa opzione e\' impostata su "NO" allora l\'utente sara\' reindirizzato al Login del Manager o alla Pagina Iniziale del sito.</strong>';
...
$_lang['setting_login_allowed_days_desc'] = 'Seleziona i giorni in cui questo utente e\' autorizzato ad entrare.';

$_lang['setting_login_allowed_ip'] = 'Indirizzo IP autorizzato';
$_lang['setting_login_allowed_ip_desc'] = 'Inserisci l\'indirizzo IP da cui questo utente e\' autorizzato ad entrare. <strong>NB: Separa differenti indirizzi IP con una virgola (,)</strong>';

$_lang['setting_login_homepage'] = 'Pagina Iniziale';
...
$_lang['setting_allow_duplicate_alias'] = 'Permetti aliases duplicati';
$_lang['setting_allow_duplicate_alias_desc'] = 'Se impostato su \'SI\', sara\' ammesso il salvataggio di aliases duplicati. <strong>NOTA: Questa opzione dovrebbe essere usata con \'Percorso URL semplici\' impostato su \'SI\' per evitare problemi di riferimenti alle risorse.</strong>';

$_lang['setting_allow_tags_in_post'] = 'Consenti Tags HTML in POST';
$_lang['setting_allow_tags_in_post_desc'] = 'Se viene scelto \'NO\', tutte le azioni POST dentro il manager saranno ripulite da qualsiasi tag. Si raccomanda di lasciare questo parametro impostato su \'SI\'.';

$_lang['setting_archive_with'] = 'Forzare Archiviazione PCLZip';
$_lang['setting_archive_with_desc'] = 'Se impostato su "SI", sara\' usato PCLZip invece di ZipArchive come estensione zip. Cambia questo parametro se ti imbatti in errori di estrazione (extractTo) o se hai problemi nella decompressione (unzipping) nel Gestore dei Pacchetti.';

$_lang['setting_auto_menuindex'] = 'Indicizzazione Menu di default';
$_lang['setting_auto_menuindex_desc'] = 'Seleziona \'SI\' per attivare l\'incremento automatico dell\'indice del menu di default.';

$_lang['setting_auto_check_pkg_updates'] = 'Controlla automaticamente gli Aggiornamenti dei Pacchetti';
$_lang['setting_auto_check_pkg_updates_desc'] = 'Se impostato su \'SI\', si controllera\' automaticamente se sono disponibili aggiornamenti per i pacchetti inseriti nel Gestore Pacchetti. Questo puo\' rallentare il caricamento della griglia.';
...
$_lang['setting_auto_check_pkg_updates_cache_expire_desc'] = 'Il numero di minuti che il Gestore dei Pacchetti terra\' in cache i risultati del controllo aggiornamenti.';
...
$_lang['setting_blocked_minutes'] = 'Minuti Bloccaggio';
...
$_lang['setting_cache_disabled_desc'] = 'Seleziona \'SI\' per disabilitare tutte le funzioni di caching di MODx. MODx raccomanda il "NO", non disabilitare il caching.';
$_lang['setting_cache_disabled_err'] = 'Per favore specifica se vuoi o meno la cache abilitata.';

$_lang['setting_cache_json'] = 'Cache Dati JSON';
$_lang['setting_cache_json_desc'] = 'Inserisci in cache qualsiasi dato JSON invito da e verso la manager UI.';
...
$_lang['setting_cache_json_expires'] = 'Scadenza della Cache JSON';
$_lang['setting_cache_json_expires_desc'] = 'Questo valore (in secondi) imposta la durata temporale di default dei files della cache JSON.';
...
$_lang['setting_cache_lang_js'] = 'Abilita Cache delle Stringhe Lessicali JS';
$_lang['setting_cache_lang_js_desc'] = 'Se impotato "SI", verranno usati gli headers del server per inserire in cache le stringhe lessicali caricate nei JavaScript per l\'interfaccia del pannello di controllo.';

$_lang['setting_cache_lexicon_topics'] = 'Abilita Cache Archivi Linguaggio';
$_lang['setting_cache_lexicon_topics_desc'] = 'Se impotato "SI", tutti gli Archivi Linguaggio saranno inseriti in cache in modo da ridurre sostanzialmente il tempo di caricamento delle funzionalita\' per l\'Internazionalizzazione. Si raccomanda fortemente di lasciarlo impostato su "SI"';

$_lang['setting_cache_noncore_lexicon_topics'] = 'Abilita Cache Archivi Linguaggio Non-Core';
$_lang['setting_cache_noncore_lexicon_topics_desc'] = 'Se impotato "NO", gli Archivi Linguaggio Non-Core NON saranno inseriti in cache. Utile durante lo sviluppo di propri Extras personali.';

$_lang['setting_cache_resource'] = 'Abilita Cache Parziale Risorse';
$_lang['setting_cache_resource_desc'] = 'Il comportamento della cache parziale delle risorse e\' configurabile dalla risorsa stessa quando questa opzione e\' abilitata ("SI"). Disabilitando ("NO") questa opzione sara\' disabilitata a livello globale.';

$_lang['setting_cache_resource_expires'] = 'Scadenza della Cache Parziale  Risorse';
...
$_lang['setting_compress_css_desc'] = 'Se impostato su "SI", verra\' usata una versione compressa dei fogli di stile css nell\'interfaccia del manager. Questo riduce in modo significativo il tempo di caricamento ed esecuzione dentro il manager. Disabilita ("NO") questa funzione SOLO se stai modificando elementi del core.';

$_lang['setting_compress_js'] = 'Usa Librerie Javascript Compresse';
$_lang['setting_compress_js_desc'] = 'Se impostato su "SI", verra\' usata una versione compressa delle personali librerie JavaScript. Questo riduce in modo significativo il tempo di caricamento ed esecuzione dentro al manager. Disabilita ("NO") questa funzione SOLO se stai modificando elementi del core.';

$_lang['setting_concat_js'] = 'Usa Librerie Javascript Concatenate';
$_lang['setting_concat_js_desc'] = 'Se impostato su "SI", verra\' usata una versione concatenata delle librerie Javascript nell\'interfaccia del manager.  Questo riduce in modo significativo il tempo di caricamento e di esecuzione dentro al manager. Disabilita ("NO") questa funzione SOLO se stai modificando elementi del core.';
...
$_lang['setting_custom_resource_classes_desc'] = 'Un elenco di classi di Risorse personalizzate, separate da virgola. Specifica con la sintassi lowercase_lexicon_key:className (Es: wiki_resource:WikiResource). Tutte le classi personali devono estendere modResource. Per indicare la posizione del controllore per ogni classe, aggiungi un\'impostazione con [nameOfClassLowercase]_delegate_path con il percorso della directory dei files php create/update. Es: wikiresource_delegate_path per una classe WikiResource che estenda modResource.';
...
$_lang['setting_editor_css_path_desc'] = 'Inserisci il percorso del tuo file CSS che vorresti usare con editor richtext. Il miglior modo di inserire il percorso e\' di inserirlo dalla root del tuo server, per esempio:  /assets/site/style.css. Se non vuoi caricare un foglio di stile dentro un editor richtext, lascia questo campo vuoto.';
...
$_lang['setting_enable_dragdrop_desc'] = 'Se impostato su \'No\', non sara\' effettuabile il dragging e dropping negli Alberi delle Risorse e degli Elementi.';
...
$_lang['setting_feed_modx_news'] = 'News Feed URL';
$_lang['setting_feed_modx_news_desc'] = 'Imposta l\'URL dei feed RSS per il pannello MODx News nel manager.';

$_lang['setting_feed_modx_news_enabled'] = 'News Feed Abilitati';
$_lang['setting_feed_modx_news_enabled_desc'] = 'Se impostato su \'NO\', verra\' nascosto il feed delle News nella sezione di benvenuto del manager.';

$_lang['setting_feed_modx_security'] = 'URL Feed Avvisi di Sicurezza';
...
$_lang['setting_feed_modx_security_enabled'] = 'Feed Avvisi di sicurezza Abilitato';
$_lang['setting_feed_modx_security_enabled_desc'] = 'Se impostato su \'NO\', verra\' nascosto il feed sulla Sicurezza nella sezione di benvenuto del manager.';

$_lang['setting_filemanager_path'] = 'Percorso del File Manager';
$_lang['setting_filemanager_path_desc'] = 'IIS spesso non completa in modo corretto il valore document_root, che e\' usato per determinare cosa puoi vedere dal file manager. Se stai incontrando problemi usando il file manager, assicurati che questo percorso punti alla root della tua installazione di MODx.';

$_lang['setting_filemanager_path_relative'] = 'Il percorso del File Manager e\' Relativo?';
$_lang['setting_filemanager_path_relative_desc'] = 'Se il tuo valore del filemanager_path e\' relativo rispetto al base_path di MODx, allora imposta questo valore a \'SI\'. Se il tuo filemanager_path e\' esterno rispetto alla radice dei documenti (docroot), imposta questo su \'NO\'.';

$_lang['setting_filemanager_url'] = 'File Manager Url';
$_lang['setting_filemanager_url_desc'] = 'Opzionale. Specifica questo valore se vuoi impostare un esplicito URL per accedere ai files tramite il file manager di MODx (utile se hai cambiato il valore filemanager_path con un percorso esterno alla radice web (webroot) di MODx). Assicurati che questa sia la URL del parametro filemanager_path. Se lasci questo campo vuoto, MODx provera\' a calcolarlo automaticamente.';

$_lang['setting_filemanager_url_relative'] = 'L\'URL del File Manager e\' Relativa?';
$_lang['setting_filemanager_url_relative_desc'] = 'Se il tuo valore del filemanager_url e\' relativo rispetto alla base_url di MODx, allora imposta questo valore a \'SI\'. Se il tuo filemanager_url e\' esterno rispetto alla radice web (webroot), imposta questo su \'NO\'.';
...
$_lang['setting_forward_merge_excludes_desc'] = 'Un SymLink unisce valori di campi non-vuoti sopra ai valori della Risorsa a cui punta. Questa lista, separata da virgole, vine utilizzata per escludere preventivamente i valori dei campi sovrascrivibili dal SymLink.';

$_lang['setting_friendly_alias_lowercase_only'] = 'Alias solo minuscole FURL';
...
$_lang['setting_friendly_alias_strip_element_tags'] = 'Strappare Elementi Tags Alias FURL';
$_lang['setting_friendly_alias_strip_element_tags_desc'] = 'Determina se i tags degli Elementi devono essere strappati(tolti) da un alias di una Risorsa.';

$_lang['setting_friendly_alias_translit'] = 'Translitterazione Alias FURL';
$_lang['setting_friendly_alias_translit_desc'] = 'Il metodo di translitterazione da usare su un alias specificato per una Risorsa. Vuoto o "none" e\' il valore di defalut che salta la translitterazione. Altri valori possibili sono "iconv" (se disponibile) o una tabella di translitterazione fornita da una classe di servizio translitterazione personale.';
...
$_lang['setting_friendly_alias_translit_class_path_desc'] = 'La posizione del pacchetto formato modello da cui sara\' caricata la Classe del Servizio per la Translitterazione Alias FURL.';

$_lang['setting_friendly_alias_trim_chars'] = 'Caratteri Tagliare Alias FURL';
...
$_lang['setting_friendly_alias_urls'] = 'Usa Alias Semplici (Friendly Aliases)';
$_lang['setting_friendly_alias_urls_desc'] = 'Se e SOLO se stai usando gli URLs semplici (friendly URLs, FURL), e la risorsa ha un alias, l\'alias avra\' sempre precedenza sull\'URL semplice. Impostando questa opzione su \'SI\', il suffisso del Tipo Contenuto della Risorsa sara\' sempre applicato all\'alias. Per esempio, se la tua Risorsa con ID 1 ha un alias `introduzione`, e hai impostato un suffisso di Tipo Contenuto `.html`, impostando questa opzione su `SI` verra\' generato automaticamente `introduzione.html`. Se non c\'e\' alcun alias, MODx generera\' `1.html` come link.';

$_lang['setting_friendly_alias_word_delimiter'] = 'DelimitatorE Parola Alias FURL ';
$_lang['setting_friendly_alias_word_delimiter_desc'] = 'Il delimitatore di parola preferito per gli alias friendly URL finali (slugs).';

$_lang['setting_friendly_alias_word_delimiters'] = 'DelimitatorI Parola Alias FURL';
$_lang['setting_friendly_alias_word_delimiters_desc'] = 'I caratteri che formano i delimitatori finali (sligs)di parola durante l\'elaborazione degli alias degli URL amichevoli. Questi caratteri saranno convertiti e consolidati al delimitatore di parola predefinito per gli alias FURL.';

$_lang['setting_friendly_urls'] = 'Utilizza URLs semplici (friendly URL)';
$_lang['setting_friendly_urls_desc'] = 'Questo consente ("SI") di usare gli URLs semplici per i motori di ricerca, cioè mostrare nell\'indirizzo nome (alias) e non la stringa in php id=... <b>Nota</b>, questo funziona soltanto per le installazioni che girano su Apache, inoltre dovrai scrivere un file .htaccess per farli funzionare. Controlla il file .htaccess incluso nella installazione per maggiori informazioni.';
$_lang['setting_friendly_urls_err'] = 'Per favore specifica se vuoi usare o no gli URLs semplici (FURL).';
...
$_lang['setting_mail_use_smtp_desc'] = 'Se \'SI\', si provera\' ad usare protocollo SMTP nelle funzioni delle mail.';

$_lang['setting_mail_smtp_auth'] = 'Autenticazione SMTP';
$_lang['setting_mail_smtp_auth_desc'] = 'Imposta eventuale l\'autenticazione SMTP.Se la attivi "SI" devi completare le impostazioni mail_smtp_user e mail_smtp_pass.';

$_lang['setting_mail_smtp_helo'] = 'Messaggio Helo SMTP';
$_lang['setting_mail_smtp_helo_desc'] = 'Imposta l\'SMTP HELO del messaggio (Predefinito e\' hostname).';
...
$_lang['setting_mail_smtp_single_to_desc'] = 'Abilita l\'invio con unico A: delle mails ai destinatari, invece di inviare all\'intero elenco A: dei destinatari.';
...
$_lang['setting_manager_direction_desc'] = 'Scegli la direzione con cui sara\' mostrato il testo, da sinistra a destra "ltr" o da destra a sinistra "rtl".';

$_lang['setting_manager_date_format'] = 'Formato Data Manager';
$_lang['setting_manager_date_format_desc'] = 'La stringa, nel formato PHP date(), per le date visualizzate nel manager.';

$_lang['setting_manager_lang_attribute'] = 'Gestione Attributi Lingue per HTML e XML';
$_lang['setting_manager_lang_attribute_desc'] = 'Verra\' inserito per xml:lamg=".." nell\'headers. Inserisci il codice della lingua che soddisfa meglio la tua scelta della lingua del manager, questo assicura che il browser mostri il contenuto nel miglior formato per la tua lingua.';

$_lang['setting_manager_language'] = 'Gestione Lingua';
$_lang['setting_manager_language_desc'] = 'Seleziona la lingua per il Manager di Gestione.';

$_lang['setting_manager_login_start'] = 'Pagina Iniziale Manager';
$_lang['setting_manager_login_start_desc'] = 'Inserisci l\'ID del documento che vuoi mostrare all\'utente dopo che questo si e\' loggato dentro il manager. <strong>NOTA: assicurati che l\'ID che inserisci appartenga a un documento esistente, pubblicato e accessibile dall\'utente!</strong>';

$_lang['setting_manager_theme'] = 'Tema  Manager';
$_lang['setting_manager_theme_desc'] = 'Seleziona il Tema da utilizzare per il Manager (nome cartella).';

$_lang['setting_manager_time_format'] = 'Formato Ora Manager';
$_lang['setting_manager_time_format_desc'] = 'La stringa, nel formato PHP date(), per la visualizzazione degli orari nel manager.';

$_lang['setting_manager_use_tabs'] = 'Utilizza Schede nel Layout del Manager';
$_lang['setting_manager_use_tabs_desc'] = 'Se \'SI\', il manager utilizzera\' le schede(tabs) per disporre i contenuti dei pannelli. Altrimenti verranno utilizzati dei portali (portals).';

$_lang['setting_modRequest.class'] = 'Request Handler Class';
$_lang['setting_modRequest.class_desc'] = '';

$_lang['setting_modx_charset'] = 'Codifica Caratteri';
$_lang['setting_modx_charset_desc'] = 'Seleziona quale codifica dei caratteri vorresti usare. Tieni presente che MODx e\' stato testato con diverse di queste codifiche, ma non con tutte. Per la maggior parte delle lingue, l\'impostazione di default UTF-8 e\' da preferirsi.';

$_lang['setting_new_file_permissions'] = 'Permessi Nuovi File';
$_lang['setting_new_file_permissions_desc'] = 'Quando carichi un nuovo file nel File Manager, il Manager provera\' a modificare i permesse con quelli inseriti qui. Questo potrebbe non funzionare su alcune installazioni, come con IIS, in questi casi dovrai cambiare manualmente i permessi.';

$_lang['setting_new_folder_permissions'] = 'Permessi Nuova Cartella';
$_lang['setting_new_folder_permissions_desc'] = 'Quando crei una nuova cartella nel File Manager, il manager provera\' a cambiare i permessi della cartella con quelli inseriti qui. Questo potrebbe non funzionare su alcune installazioni, come con IIS, in questi casi dovrai cambiare manualmente i permessi.';
...
$_lang['setting_proxy_host_desc'] = 'Se il tuo server sta usando un proxy, imposta qui l\'hostname  per permettere alle funzionalita\' che potrebbero utilizzarlo, come il Gestore Pacchetti.';
...
$_lang['setting_phpthumb_allow_src_above_docroot_desc'] = 'Se "SI", il percorso origine "src" puo\' essere esterno alla radice dei documenti. Questo e\' utile per gli sviluppi di multi-contesti con multipli hosts virtuali.';

$_lang['setting_phpthumb_cache_maxage'] = 'Giorni Massimi Cache phpThumb';
$_lang['setting_phpthumb_cache_maxage_desc'] = 'Cancella le miniature (thumbnails) inserite in cache che non sono state visualizzate per piu\' di X giorni.';

$_lang['setting_phpthumb_cache_maxsize'] = 'Dimensione Massima Cache phpThumb';
$_lang['setting_phpthumb_cache_maxsize_desc'] = 'Elimina le miniature con gli accessi meno recenti qualora la cache diventi piu\' grande di X megabytes.';

$_lang['setting_phpthumb_cache_maxfiles'] = 'Numero Massimo Files Cache phpThumb';
$_lang['setting_phpthumb_cache_maxfiles_desc'] = 'Elimina le miniature con gli accessi meno recenti quando in cache sono inseriti piu\' di X files.';
...
$_lang['setting_phpthumb_far'] = 'Forza Vista Rifililatura phpThumb';
$_lang['setting_phpthumb_far_desc'] = 'L\'impostazione predefinita che usera\' phpThumb dentro il gestore. Impostare "C" per forzare la vista tagliata (crop) verso il Centro. Altri valori: "T", "B", "L", "R", "TL", "TR", "BL", "BR" composizione fatta con Top(alto)/Left(sin)/Bottom(basso)/Right(des) per eseguire tagli di conseguenza(Zoom-crop)<b> Nota Bene:</b> richiede ImageMagick per impostazioni diverse da "C".';

$_lang['setting_phpthumb_imagemagick_path'] = 'Percorso ImageMagick phpThumb';
$_lang['setting_phpthumb_imagemagick_path_desc'] = 'Opzionale. Imposta un percorso alternativo per ImageMagick per generare miniature con phpThumb, se non e\' predefinito in PHP.';

$_lang['setting_phpthumb_nohotlink_enabled'] = 'Hotlinking Disabilitato phpThumb';
...
$_lang['setting_phpthumb_nohotlink_text_message'] = 'Messaggio di Hotlinking Non Permesso phpThumb';
$_lang['setting_phpthumb_nohotlink_text_message_desc'] = 'Il messaggio mostrato al posto della miniatura  quando un tentativo di hotlinking e\' rifiutato.';

$_lang['setting_phpthumb_nohotlink_valid_domains'] = 'Domini Validi Hotlinking phpThumb';
$_lang['setting_phpthumb_nohotlink_valid_domains_desc'] = 'Un elenco separato da virgola degli hosts acui è permesso intervenire nel parametro URLs src.';

$_lang['setting_phpthumb_nooffsitelink_enabled'] = 'Linking FuoriSito Disabilitato phpThumb';
$_lang['setting_phpthumb_nooffsitelink_enabled_desc'] = 'Se "SI" si Disattiva la possibilità ad altri di utilizzare phpThumb per il rendering di immagini sui loro siti.';

$_lang['setting_phpthumb_nooffsitelink_erase_image'] = 'Elimina Immagini con Collegamento FuoriSito phpThumb';
...
$_lang['setting_phpthumb_nooffsitelink_require_refer_desc'] = 'Se abilitato "SI", qualsiasi tentativo di collegamento esterno sara\' rifiutato senza una valida intestazione di riferimento (header referrer).';

$_lang['setting_phpthumb_nooffsitelink_text_message'] = 'Messaggio per Collegamento FuoriSito non Autorizzato phpThumb';
...
$_lang['setting_phpthumb_nooffsitelink_valid_domains'] = 'Domini Validi Collegamento FuoriSito phpThumb';
$_lang['setting_phpthumb_nooffsitelink_valid_domains_desc'] = 'Un elenco separato da virgola degli hosts validati a cui e\' permesso il collegamento esterno.';
...
$_lang['setting_publish_default'] = 'Pubblicato Default';
...
$_lang['setting_request_controller_desc'] = 'Il nome del file del  controllore delle richieste con cui e\' caricato MODx. La maggior parte degli utenti possono lasciare index.php.';

$_lang['setting_request_param_alias'] = 'Parametro Alias Richieste';
$_lang['setting_request_param_alias_desc'] = 'Il nome del parametro GET per identificare gli aliases delle Risorse durante il reindirizzamento con FURLs. Normalmente "q"';

$_lang['setting_request_param_id'] = 'Parametro Richiesta ID';
$_lang['setting_request_param_id_desc'] = 'Il nome del parametro GET per identificare gli IDs delle Risorse quando non vengono usati FURLs. Normalmente "id"';

$_lang['setting_resolve_hostnames'] = 'Identifica Nomi Hosts';
$_lang['setting_resolve_hostnames_desc'] = 'Vuoi che MODx provi ad identificare i nome degli hosts dei tuoi visitatori quando visitano il tuo sito? Tale azione puo\' causare un po\' di lavoo extra per il caricamente del server, anche se i tuoi visitatori non si accorgeranno in alcun modo di questo.Consigliabile lasciare "NO" per diminuire il lavoro';

$_lang['setting_resource_tree_node_name'] = 'Campo Risorsa Nodi Albero';
$_lang['setting_resource_tree_node_name_desc'] = 'Specifica quale campo della Risorsa visualizzare come nome per i nodi dell\'Albero delle Risorse. Di default e\' il titolo della pagina (pagetitle), ma puo\' essere usato qualsiasi campo, come il titolo del menu, alias, titolo esteso, ecc.';
...
$_lang['setting_session_cookie_lifetime_desc'] = 'Usa questa impostazione per personalizzare la voce: durata in secondi dei cookie della sessione.  Cosi\' si imposta la durata del cookie della sessione di un cliente che abbia scelto l\'opzione \'ricordami\' al momento del login.';

$_lang['setting_session_cookie_path'] = 'Percorso Cookie Sessione';
$_lang['setting_session_cookie_path_desc'] = 'Con questa impostazione personalizza la voce: percorso del cookie per identificare specifiche sessioni della sessione.';

$_lang['setting_session_cookie_secure'] = 'Sicurezza Cookie Sessione';
$_lang['setting_session_cookie_secure_desc'] = 'Abilita questa opzione per usare cookies per sessioni sicure HTTPS.';
...
$_lang['setting_session_name_desc'] = 'Usa questa impostazione per personalizzare il nome della sessione usato quando si è nel gestore.';

$_lang['setting_settings_version'] = 'Impostazioni Versione';
...
$_lang['setting_set_header_desc'] = 'Se abilitato "SI", MODx provera\' a impostare gli headers HTTP per le Risorse.';
...
$_lang['setting_site_unavailable_message'] = 'Messaggio Sito Indisponibile';
$_lang['setting_site_unavailable_message_desc'] = 'Il messaggio che vuoi mostrare quando il sito e\' offline o si verifica un errore. <strong>Nota: Questo messaggio verra\' mostrato soltanto se l\'opzione relativa alla pagina di Sito non disponibile non e\' impostata.</strong>';

$_lang['setting_site_unavailable_page'] = 'Pagina Sito Indisponibile';
...
$_lang['setting_strip_image_paths_desc'] = 'Se impostato su \'NO\', MODx scrivera\' le origini dei files delle risorse src(immagini, files, flash, etc.) come URLs assoluti. Gli URLs relativi sono utili per spostare la tua installazione di MODx, e.g., da un server di test a un server di produzione. Se non hai idea di cosa significhi, sarebbe opportuno lasciare semplicemente impostato su \'SI\'.';

$_lang['setting_topmenu_show_descriptions'] = 'Mostra Descrizioni Top Menu';
$_lang['setting_topmenu_show_descriptions_desc'] = 'Se impostato su \'NO\', MODx nascondera\' le descrizioni dagli oggetti del top menu del manager.';

$_lang['setting_tree_default_sort'] = 'Campo Ordinamento Predefinito Albero Risorse';
...
$_lang['setting_tree_root_id'] = 'Radice Albero ID';
$_lang['setting_tree_root_id_desc'] = 'Imposta un ID valido di una Risorsa. Il nodo della Risorsa diventera\' la radice dell\'Albero a sinistra. L\'utente potra\' vedere soltanto le Risorse che sono figli della Risorsa specificata. Impostando 0 sara\' possibile vedere TUTTO';
...
$_lang['setting_upload_maxsize_desc'] = 'Inserisci la dimensione massima (bytes) di un file che puo\' essere caricato tramite il file manager. La dimensione deve essere inserita in bytes. <strong>NOTA: Files grandi possono impiegare molto tempo per essere caricati!</strong>';
...
$_lang['setting_use_alias_path_desc'] = 'Impostando questa opzione su \'SI\' verra\' mostrato il percorso completo della Risorsa, se la Risorsa ha un alias. Per esempio, se una Risorsa con un alias chiamato \'figlio\' si trova nella cartella con alias \'genitore\', allora il percorso dell\'alias sara\' \'/genitore/figlio.html\'.<br /><strong>NOTA: Se impostato su \'SI\' (attivando il percorso alias), si deve far riferimento agli oggetti (come immagini, css, javascripts, ecc) usando il percorso assoluto: es., \'/assets/images\' invece di \'assets/images\'. In questo modo si evita che il browser (o il web-server) aggiunga il percorso relativo al percorso dell\'alias. Consigliabile il "NO"</strong>';

$_lang['setting_use_browser'] = 'Abilita Browser Risorse';
$_lang['setting_use_browser_desc'] = 'Seleziona \'SI\' per abilitare il browser delle risorse. Questo consentira\' ai tuoi utenti di navigare e caricare risorse come immagini, flash e files multimediali sul server.';
...
$_lang['setting_webpwdreminder_message_desc'] = 'Inserisci il messaggio da inviare tramite mail, quando gli utenti chiedono una nuova password via email. Il Manager inviera\' loro una e-mail contenente la nuova password e le informazioni di attivazione. <br /><strong>Nota:</strong> I seguenti identificatori saranno sostituiti coi relativi valori dal Manager quando il messaggio verra\' inviato:<br /><br /> [[+sname+]] - Nome del sito, <br />[[+saddr+]] - Indirizzo email del sito, <br />[[+surl+]] - Url del sito, <br />[[+uid+]] - Login o id dell\'utente, <br />[[+pwd+]] - Password utente, <br />[[+ufn+]] - Nome completo dell\'utente.<br /><br /><strong>Lasciate [[+uid+]] e [[+pwd+]] nella e-mail, altrimenti il nome utente e la password non verranno inviati!</strong>';
...
$_lang['setting_welcome_screen_desc'] = 'Se impostato su \'SI\', la schermata di benvenuto verra\' mostrata al prossimo caricamento della pagina di benvenuto, e non verra\' mostrato successivamente.';
...
$_lang['setting_which_editor'] = 'Editor Utilizzato';
...
$_lang['setting_which_element_editor_desc'] = 'Qui puoi specificare quale Editor Rich Text vorresti usare durante la modifica degli Elementi (chunk,snippet,ecc.ecc.). Puoi scaricare e installare ulteriorio Editors Rich Text dal Gestore dei Pacchetti.';
