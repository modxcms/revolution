...
$_lang['resource_alias_help'] = 'Inserisci alias per questa risorsa. Questo renderà la risorsa accessibile tramite:<br />https://tuoserver/alias<br /><strong>Nota Bene:</strong> Funzionerà SOLO se stai usando i "friendly URLs".';
...
$_lang['weblink_message'] = 'Un weblink è un riferimento a un oggetto su Internet. Questo potrebbe essere un documento all\'interno di MODX, una pagina su un altro sito o un\'immagine o altro file su Internet.';
