...
$_lang['document_new'] = 'Crea Documento';
...
$_lang['resource_alias_visible'] = 'Utilizzare alias corrente nell\'alias percorso';
$_lang['resource_alias_visible_help'] = 'L\'alias di questa risorsa è inserita nell\'alias percorso URL Friendly';
...
$_lang['resource_delete_confirm'] = 'Sei sicuro di voler eliminare la risorsa: "[[+resource]]"?<br />NOTA: Anche ogni risorsa figlia sarà eliminata!';
...
$_lang['resource_err_delete_children'] = 'Si è verificato un errore provando a eliminare il figlio della risorsa.';
...
$_lang['resource_err_delete_errorpage'] = 'La risorsa è utilizzata come \'Pagina di Errore\' e non può essere eliminata!';
...
$_lang['resource_err_remove'] = 'Si è verificato un errore cercando di cancellare la risorsa.';
...
$_lang['resource_err_symlink_target_invalid'] = 'La destinazione del link simbolico non contiene un valore intero.';
$_lang['resource_err_symlink_target_nf'] = 'Non puoi collegare un link simbolico ad una risorsa che non esiste.';
$_lang['resource_err_symlink_target_self'] = 'Non puoi fare un symlink a se stesso.';
...
$_lang['resource_err_unpublish_errorpage'] = 'La risorsa è collegata alla variabile error_page e non può essere annullata!';
$_lang['resource_err_unpublish_errorpage_dates'] = 'La risorsa è collegata alla variabile error_page e non può avere impostato date di pubblicazione o di ritiro!';
$_lang['resource_err_unpublish_siteunavailable'] = 'La risorsa è collegata alla variabile site_unavailable_page e non può essere annullata!';
$_lang['resource_err_unpublish_siteunavailable_dates'] = 'La risorsa è collegata alla variabile site_unavailable_page e non può avere impostato date di pubblicazione o di ritiro!';
$_lang['resource_err_weblink_target_nf'] = 'Non è possibile impostare un collegamento web ad una risorsa che non esiste.';
$_lang['resource_err_weblink_target_self'] = 'Non puoi impostare un weblink a se stesso.';
...
$_lang['resource_hide_children_in_tree'] = 'Nascondi figlio';
$_lang['resource_hide_children_in_tree_help'] = 'Selezionare questa opzione per rendere i figli risorse nascoste nella struttura ad albero delle risorse.';
$_lang['resource_show_in_tree'] = 'Mostra nell\'Albero';
$_lang['resource_show_in_tree_help'] = 'Deseleziona questa opzione per nascondere risorse dall\'albero. <b>Attenzione!</b> non sarà in grado di modificare questa risorsa dopo tramite albero di risorse, solo da link diretto.';
...
$_lang['resource_new'] = 'Crea Risorsa';
...
$_lang['resource_publish_confirm'] = 'Pubblicare ora questa risorsa eliminerà ogni data di (annullamento della) pubblicazione che potrebbe esser stato impostato. Se desideri impostare o mantenere le date di pubblicazione o annullamento di pubblicazione, sei pregato di scegliere di modificare la risorsa piuttosto.<br /><br />Procedere?';
...
$_lang['resource_summary'] = 'Riepilogo';
...
$_lang['resource_unpublish_confirm'] = 'Annullare la pubblicazione di questa risorsa ora eliminerà ogni data di (annullamento della) pubblicazione che potrebbe esser stata impostata. Se desideri impostare o mantenere le date di pubblicazione o annullamento della pubblicazione, sei pregato piuttosto di modificare la risorsa.<br /><br />Procedere?';
$_lang['resource_unpublishdate'] = 'Data di ritiro';
...
$_lang['static_resource_new'] = 'Crea Risorsa Statica';
$_lang['status'] = 'Stato';
...
$_lang['symlink_new'] = 'Crea Symlink';
...
$_lang['weblink_help'] = 'L\'indirizzo URL completo dell\'oggetto che desideri riferire con questo link web (https://example.com/page). Se desideri puntare una Risorsa MODX esistente, inserisci qui l\'ID.';
...
$_lang['weblink_new'] = 'Crea Weblink';
