...
$_lang['export_site_maxtime_message'] = 'Qui puoi specificare il numero di secondi che MODX può impiegare per esportare il sito (sovrascrivendo la configurazione PHP). Inserisci 0 per un tempo illimitato. <strong>Nota bene:</strong> inserendo 0 oppure un valore molto grande può causare spiacevoli problemi al server e non e\' consigliato.';
