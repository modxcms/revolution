...
$_lang['export_site_maxtime_message'] = 'Qui è possibile specificare il numero di secondi che MODX può impiegare per esportare il sito (ignora le impostazioni di PHP). Immettere 0 per un tempo illimitato. Si prega di notare, l\'impostazione 0 o un numero davvero alto possono avere comportamenti imprevisti sul tuo server e non è raccomandato.';
