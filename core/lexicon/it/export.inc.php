...
$_lang['export_site_maxtime_message'] = 'Qui puoi specificare il numero di secondi che MODx può impiegare per esportare il sito (sovrascrivendo i settaggi PHP). Inserisci 0 per un tempo illimitato. <strong>Nota bene:</strong> inserendo 0 oppure un valore molto grande può causare spiacevoli problemi al server e non è consigliato.';
$_lang["export_site_message"] = '<p>Usando questa funzione potete esportare l\'intero sito in HTML. Considerate che cosi\' facendo perderete molte funzionalita\' di MODx, tipo:</p><ul><li>Gli accessi ai file esportati non saranno registrati.<li>Gli snippet interattivi NON funzionano nei file esportati.<li>Solo le normali Risorse saranno esportate, i Link Web non lo saranno.<li>Il processo di esportazione potrebbe fallire se le Risorse contengono snippet che inviano headers HTTP di redirezione.<li>A seconda di come avete scritto i documenti, i fogli di stile e le immagini, il design del sito potrebbe essere compromesso. Per sistemarlo, potete salvare/spostare i file esportati nella stessa cartella dove risiede il file index.php di MODx.</ul></p><p>Compilate il modulo e premete \'Avvia esportazione\' per avviare il processo. I file creati saranno salvati nel punto specificato usando, ove possibile, gli alias dei documenti come nomi dei file. Nell\'esportare il sito, sarebbe meglio aver attivato gli \'URL semplici\' nella configurazione di MODx. In base alla dimensione del sito, l\'esportazione potrebbe impiegare un po\' di tempo.</p><p><b>Ogni file esistente sar&agrave; sovrascritto dai nuovi file se i loro nomi sono identici!</b></p>';
