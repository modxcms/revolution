...
$_lang['mail_err_derive_getmailer'] = 'Tentativo di eseguire la funzione  _getMailer() nella classe modMail. Devi implementare questa funzione in un derivato di modMail.';
$_lang['mail_err_attr_nv'] = '[[+attr]] non e\' un  attributo PHPMailer valido ed e\' attualmente ignorato dall\'implementazione.';
