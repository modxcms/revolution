...
$_lang['permission_err_remove'] = 'Si è verificato un errore durante il tentativo di rimuovere questo permesso.';
...
$_lang['policy_create'] = 'Nuova Politica di Accesso';
...
$_lang['policy_desc_description'] = 'Opzionale. Una breve descrizione della Policy di Accesso';
...
$_lang['policy_err_remove'] = 'Si è verificato un errore durante il tentativo di rimuovere la Politica.';
...
$_lang['policy_property_new'] = 'Nuova Proprietà Politica';
...
$_lang['policy_remove_multiple_confirm'] = 'Sei sicuro di voler rimuovere queste Politiche di Accesso? Questa operazione è irreversibile.';
...
$_lang['policy_template_desc_description'] = 'Opzionale. Una breve descrizione del Template della Policy di Accesso';
...
$_lang['policy_template_err_remove'] = 'Si è verificato un errore durante il tentativo di rimuovere il Template di Politica.';
...
$_lang['policy_template_remove_confirm'] = 'Sei sicuro di voler rimuovere questo Template di Politica? Saranno rimosse anche tutte le Politiche associate a questo Template - questo potrebbe corrompere la tua installazione di MODX se una Politica attiva è associata a questo Template.';
$_lang['policy_template_remove_multiple'] = 'Rimuovi i Template di Politica Selezionati';
$_lang['policy_template_remove_multiple_confirm'] = 'Sei sicuro di voler rimuovere questi Templates di Politica? Saranno rimosse anche tutte le Politiche associate a questi Templates - questo potrebbe corrompere la tua installazione di MODX se anche solo una Politica attiva è associata a questi Templates .';
