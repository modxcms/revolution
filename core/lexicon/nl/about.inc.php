...
$_lang['help_about'] = 'The MODX® software die je gebruikt is het resultaat van samenwerking met een geweldige community bestaande uit gebruikers, supporters en developers. Sinds 2004 heeft het team achter MODX het gesponsord en beheerd, waarbij het lopende werk werd betaald uit commerciele support en in opdracht toegevoegde features. Je kunt <a href="" class="supportTicket">support van MODX kopen</a> voor 1 uur emergency support (ook bruikbaar voor twee uur non-priority support). Of <a href="mailto:hello@modx.com?subject=MODX Manager Inquiry ">e-mail ons</a> (in het engels) voor algemene vragen omtrend MODX.';
$_lang['help_credit'] = 'MODX is gratis open source software, gelicentieerd onder de <a href="http://www.gnu.org/licenses/gpl-2.0.html">GPL versie 2.0</a> of later. Copyright 2004-2014 by MODX, LLC. “MODX” is een geregistreerd handelsmerk. Laat deze credits en andere informatie op deze pagina alstjeblieft intact.';
$_lang['support_ticket_title'] = 'MODX Commerciele Support';
$_lang['support_ticket_subtitle'] = 'Een support incident voor $300 USD';
$_lang['support_ticket_button'] = 'Betaal met Credit Card';