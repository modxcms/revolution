...
$_lang['access_permissions_documents_tab'] = 'Hier kun je zien welke documentgroepen er zijn opgezet. Tevens kun je nieuwe groepen aanmaken, hernoemen, verwijderen en zien welke documenten zich in de verschillende groepen bevinden (ga met de muis over de id van het document, om de naam te zien). Bewerk het document rechtstreeks, om een document aan een groep toe te voegen of te verwijderen.';
...
$_lang['access_permissions_links_tab'] = 'Hier geven we aan welke gebruikersgroepen toegang (o.a. onderliggende documenten kunnen bewerken of aanmaken) krijgen tot de documentgroepen. Om een documentgroep aan een gebruikersgroep te koppelen, selecteert je de groep uit het dropdown-menu en klik je op \'Koppelen\'. Om de koppeling voor een bepaalde groep te verwijderen, klik je op \'Verwijderen ->\'. Hiermee wordt deze onmiddellijk verwijderd.';
...
$_lang['access_permissions_users_tab'] = 'Hier kun je zien welke gebruikersgroepen er zijn ingesteld. Tevens kun je nieuwe groepen aanmaken, hernoemen, verwijderen en zien welke gebruikers lid zijn van de verschillende groepen. Bewerk een gebruiker rechtstreeks om een nieuwe gebruiker aan een groep toe te voegen of om een gebruiker uit een groep te verwijderen.';
...
$_lang['access_rgroup_err_remove'] = 'Er is een fout opgetreden bij het verwijderen van de documentgroep ACL.';
