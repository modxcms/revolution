...
$_lang['create_resource'] = 'Nieuwe Resource';
$_lang['dashboard'] = 'Dashboard';
$_lang['documentation'] = 'Documentatie';
$_lang['file_bug'] = 'Rapporteer een fout';
$_lang['forums'] = 'Forums';
$_lang['help'] = 'Help';
...
$_lang['onlineusers_message'] = 'Deze lijst laat alle gebruikers zien die actief waren in de afgelopen 20 minuten:';
...
$_lang['welcome_messages'] = 'Er zijn <strong>%d</strong> berichten in je inbox, waarvan <strong>%s</strong> ongelezen.';
