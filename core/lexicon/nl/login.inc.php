...
$_lang['login_forget_your_login_note'] = 'Om een nieuw wachtwoord aan te maken, vul uw gebruikersnaam of email onderstaand in. Als u een account heeft, zal er activatie link worden verstuurd naar uw email adres.';
...
$_lang['login_greeting_evening'] = '<strong>Goedeavond</strong>, welkom terug!';
