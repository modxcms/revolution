...
$_lang['area_lexicon_string_msg'] = 'Vul hier een key in van een lexicon entry gebied. Indien er geen lexicon entry is, dan wordt de key van het gebied getoond.<br />Core gebieden: authentication, caching, file, furls, gateway, language, manager, session, site, system';
...
$_lang['setting_filemanager_path'] = 'Bestandsmanager pad (Deprecated)';
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. IIS heeft moeite met het goed instellen van de document_root instelling, welke door de bestandsmanager gebruikt wordt zodat bepaald wordt wat jij te zien krijgt. Indien je problemen ondervindt in de bestandsmanager, controleer of dit pad naar de root van jouw MODX installatie gaat.';
$_lang['setting_filemanager_path_relative'] = 'Is het Bestandsmanager pad relatief? (Deprecated)';
$_lang['setting_filemanager_path_relative_desc'] = 'Deprecated - Use Media Sources instead. Indien filemanager_path instelling relatief is aan de MODX base_path, zet deze instelling dan op Ja. Indien jouw filemanager_path buiten de docroot valt, zet dit dan op Nee.';
$_lang['setting_filemanager_url'] = 'Bestandsmanager URL (Deprecated)';
$_lang['setting_filemanager_url_desc'] = 'Deprecated - Use Media Sources instead. Optioneel. Stel deze in als je een expliciete URL wilt gebruiken voor de bestanden in de MODX bestandsmanager (handig als je het filemanager_path naar een pad buiten de MODX webroot hebt veranderd). Controleer wel of dit een web-bereikbare URL van de filemanager_path is. Als je deze leeg laat zal MODX proberen dit pad automatisch te berekenen.';
$_lang['setting_filemanager_url_relative'] = 'Is de bestandsmanager URL relatief? (Deprecated)';
$_lang['setting_filemanager_url_relative_desc'] = 'Deprecated - Use Media Sources instead. Indien filemanager_url instelling relatief is aan de MODX base_url, zet deze instelling dan op Ja. Indien jouw filemanager_url buiten de webroot valt, zet dit dan op Nee.';
