...
$_lang['configcheck_configinc_msg'] = 'Jouw website is kwetsbaar voor hackers welke veel schade aan jouw website kunnen aanrichten. Stel jouw configuratiebestand in op alleen-lezen! Indien je niet de beheerder bent, neem dan contact met de beheerder op en waarschuw hem over deze melding. Het bestand is [[+path]]';
$_lang['configcheck_default_msg'] = 'Een onverwachte fout is opgetreden. Wat raar is...';
$_lang['configcheck_errorpage_unavailable'] = 'Jouw website\'s foutpagina is niet beschikbaar.';
$_lang['configcheck_errorpage_unavailable_msg'] = 'Dit betekent dat jouw foutpagina niet bereikbaar is voor bezoekers of deze bestaat niet. Dit kan leiden tot een recursieve lus en er zullen veel errors door verschijnen op jouw site. Controleer dat geen normale gebruikersgroepen aan deze pagina gekoppeld zijn.';
$_lang['configcheck_errorpage_unpublished'] = 'Jouw site\'s foutpagina is niet gepubliceerd of bestaat niet.';
