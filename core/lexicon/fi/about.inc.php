...
$_lang['help_main_subhead'] = 'Katso alle jos tarvitset apua MODX projektisi kanssa<br>
Lisätietoja <a href="http://modx.com/support">modx.com/support</a> tai soita +1 (469) 777-6639';
...
$_lang['help_about'] = 'MODX® ohjelmisto jota käytät on yhteistyön tulos jolla on mahtava yhteisö käyttäjiä, tukijoita ja kehittäjiä. Vuodesta 2004 lähtien tiimi MODX:n takana on sponsoroinut ja hallinnut sitä rahoittamalla meneillään olevaa työtä kaupallisella tuella ja tilatuilla ominaisuuksilla. Voit <a href="http://modx.com/support/" class="supportTicket">ostaa tukea lähteeltä</a> ja saat yhden tunnin kiirellistä tukea (Voit myös käyttää kahteen tuntia kiireettömään tukeen). Tai <a href="mailto:hello@modx.com?subject=MODX Manager Inquiry ">lähetä sähköpostia meille</a> jos sinulla on kysyttävää MODX:stä yleisesti ottaen.';
$_lang['help_credit'] = 'MODX on ilmainen avoimen lähdekoodin ohjelmistoja lisensoitu <a href="http://www.gnu.org/licenses/gpl-2.0.html" target="_blank"> GPL-versio 2.0</a> tai uudempi. Tekijänoikeus 2004-2015 MODx, LLC. "MODX" on rekisteröity tavaramerkki. Tehkää oikea tekoja — säilyttäkää tämä teksti ja muu tieto ennallaan.';
