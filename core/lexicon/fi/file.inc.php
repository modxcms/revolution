...
$_lang['file_folder_err_rename_protected'] = 'Suojatun järjestelmähakemiston uudelleennimeäminen ei ole sallittua.';
$_lang['file_folder_err_remove'] = 'Virhe poistettaessa hakemistoa.';
$_lang['file_folder_err_remove_protected'] = 'Suojatun järjestelmähakemiston poistaminen ei ole sallittua.';
$_lang['file_folder_err_update'] = 'Hakemiston päivityksen yhteydessä tapahtui virhe.';
$_lang['file_folder_parent'] = 'Isäntähakemisto';
$_lang['file_folder_parent_desc'] = 'Suhteellinen medialähteen basePath nähden';
$_lang['file_folder_remove'] = 'Poista hakemisto';
$_lang['file_folder_remove_confirm'] = 'Oletko varma, että haluat poistaa hakemiston: "[[+directory]]"?<br />Tämä voi mahdollisesti rikkoa sivuston.';
