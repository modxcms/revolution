...
$_lang['resource_purge'] = 'Poista resurssi';
$_lang['resource_purge_confirm'] = 'Haluatko varmasti viimein poistaa seuraavan resurssin: "[[+resource]]"?<br />VAROITUS: Tätä ei voi perua.';
...
$_lang['resource_err_delete_errorpage'] = 'Resurssi on käytössä virhesivuna, eikä sitä voi poistaa!';
...
$_lang['resource_err_unpublish_errorpage'] = 'Resurssi on linkitetty virhesivu-muuttujaan eikä sen julkaisua voi poistaa!';
$_lang['resource_err_unpublish_errorpage_dates'] = 'Resurssi on linkitetty virhesivu-muuttujaan, eikä siihen voi asettaa julkaisupäivää tai peruuttaa julkaisupäivää!';
$_lang['resource_err_unpublish_siteunavailable'] = 'Resurssi on linkitetty site_unavailable_page muuttujaan eikä sillä voi olla julkaisun tai julkaisun poistopäivämääriä!';
$_lang['resource_err_unpublish_siteunavailable_dates'] = 'Resurssi on linkitetty site_unavailable_page muuttujaan eikä sillä voi olla julkaisun tai julkaisun poistopäivämääriä!';
...
$_lang['resource_hide_children_in_tree'] = 'Piilota alasivut';
$_lang['resource_hide_children_in_tree_help'] = 'Valitse tämä piilottaaksesi alasivut resurssipuussa.';
$_lang['resource_show_in_tree'] = 'Näytä puussa';
...
$_lang['resource_new'] = 'Luo uusi resurssi';
...
$_lang['resource_unpublish_confirm'] = 'Tämän resurssin julkaisun poistaminen nyt poistaa kaikki (pois)julkaisupäivämäärät, jotka on mahdollisesti asetettu. Jos haluat asettaa tai pitää julkaisu- tai julkaisupäivät, valitse muokkaa resurssia sen sijaan. <br /><br />Jatketaanko?';
...
$_lang['resource_right_top_title'] = 'Julkaisu';
