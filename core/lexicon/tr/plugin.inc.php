...
$_lang['plugin_add_to_event'] = 'Etkinliğe Eklenti Ekleyin';
$_lang['plugin_code'] = 'Eklenti kodu (Php)';
$_lang['plugin_config'] = 'Eklenti Yapılandırması';
$_lang['plugin_desc'] = 'Açıklama';
$_lang['plugin_desc_category'] = 'Bu eklentinin ait olduğu kategori.';
$_lang['plugin_desc_description'] = 'Bu eklentinin kısa bir açıklaması.';
$_lang['plugin_desc_name'] = 'Bu eklentinin adı.';
$_lang['plugin_delete_confirm'] = 'Bu eklentiyi silmek istediğinizden emin misiniz?';
$_lang['plugin_disabled'] = 'Eklentiyi devre dışı bırak';
$_lang['plugin_disabled_msg'] = 'Eklenti devre dışı bırakıldı ve olaylara yanıt vermeyecek.';
...
$_lang['plugin_err_remove'] = 'Eklenti kaldırılırken hata oluştu.';
...
$_lang['plugin_event_err_remove'] = 'Eklenti olayı kaldırılırken bir hata oluştu.';
...
$_lang['plugin_event_plugin_remove_confirm'] = 'Bu eklentiyi bu etkinlikten kaldırmak istediğinizden emin misiniz?';
$_lang['plugin_event_update'] = 'Eklenti Etkinliğini Güncelle';
$_lang['plugin_lock'] = 'Eklenti düzenleme için kilitlendi';
$_lang['plugin_lock_msg'] = 'Bu eklentiyi düzenlemek için kullanıcıların edit_locked özelliğine sahip olmaları gerekir.';
...
$_lang['plugin_msg'] = 'Buradan eklentileri ekleyebilir/değiştirebilirsiniz. Eklentiler, seçilen Sistem Olayları başladığında çağrılan \'raw\' PHP kodlarıdır.';
$_lang['plugin_name'] = 'Eklenti adı';
$_lang['plugin_new'] = 'Yeni Eklenti';
$_lang['plugin_priority'] = 'Etkinliğe göre eklenti yürütme sırasını belirleyin';
$_lang['plugin_properties'] = 'Eklenti Özellikleri';
$_lang['plugin_title'] = 'Eklentiyi oluştur/düzenle';
$_lang['plugin_untitled'] = 'İsimsiz eklenti';
