...
$_lang['template_assignedtv_tab'] = 'Atanan Şablon Değişkenleri';
...
$_lang['template_err_delete'] = 'Şablon silinirken bir hata oluştu.';
...
$_lang['template_err_remove'] = 'Şablon kaldırılırken bir hata oluştu.';
$_lang['template_err_save'] = 'Şablon kaydedilirken bir hata oluştu.';
$_lang['template_icon'] = 'Simge';
$_lang['template_icon_description'] = 'İsteğe bağlı. Bu şablonla tüm kaynaklar için özel bir simge sınıfı.';
...
$_lang['template_new'] = 'Yeni Şablon';
$_lang['template_no_tv'] = 'Bu şablona henüz herhangi bir şablon değişkeni atanmamış.';
...
$_lang['template_tv_edit'] = 'Şablon değişkenlerinin sıralama düzenini düzenle';
$_lang['template_tv_msg'] = 'Bu şablona atanan şablon değişkenleri aşağıda listelenmiştir.';
$_lang['template_untitled'] = 'Başlıksız Şablon';
$_lang['templates'] = 'Şablonlar';
$_lang['tvt_err_nf'] = 'Şablon Değişkeni\'nin belirtilen Şablona erişimi yok.';
$_lang['tvt_err_remove'] = 'Şablon değişkenini şablondan kaldırmayı denerken bir hata meydana geldi.';
