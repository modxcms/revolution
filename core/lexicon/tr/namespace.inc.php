...
$_lang['namespace_err_ns'] = 'İsim Alanı belirtilmedi.';
$_lang['namespace_err_remove'] = 'İsim Alanı kaldırılmaya çalışılırken bir hata meydana geldi.';
$_lang['namespace_err_save'] = 'Ad alanını kaydetmeye çalışılırken bir hata oluştu.';
$_lang['namespace_assets_path'] = 'Varlıklar Yolu';
$_lang['namespace_assets_path_desc'] = 'Buradaki İsim Alanı için varlıklara mutlak bir yol belirtin. {assets_path} gibi tutucular kullanabilirsiniz. Örneğin: {assets_path}components/democomponent/';
...
$_lang['namespace_update'] = 'İsim Alanı Güncelleştirme';
