...
$_lang['help_main_subhead'] = 'MODX projeniz için size yardımcı olacak yardımı almak için aşağıya bakın <br> <a href="http://modx.com/support">modx.com/support</a> adresinden daha fazla ayrıntıyı edinin veya +1 (469) 777-6639 numaralı telefonu arayın';
...
$_lang['help_about'] = 'Kullanmakta olduğunuz MODX® yazılımı, kullanıcıların, destekçilerin ve geliştiricilerin inanılmaz bir topluluk işbirliği sonucudur. MODX\'in arkasındaki ekip, 2004 yılından bu yana sponsorluğunu üstlenmiş ve ticari destek devreye sokulmuş özellikler aracılığıyla devam eden çalışmaları finanse etmiştir. Bir saat acil yardım almak için <a href="http://modx.com/support/" class="supportTicket"> kaynağından destek satın alabilirsiniz </a> (ayrıca, iki saatlik öncelikli olmayan destek için de kullanılabilir). Ya da genel olarak MODX hakkında başka bir sorunuz varsa <a href="mailto:hello@modx.com?subject=MODX Yönetici Sorgulaması "> e-posta ile </a>.';
