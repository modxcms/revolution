...
$_lang['dashboard_add'] = 'Pano ekle';
$_lang['dashboard_create'] = 'Pano Oluştur';
...
$_lang['dashboard_duplicate'] = 'Panoyu yinele';
$_lang['dashboard_remove'] = 'Panoyu sil';
$_lang['dashboard_remove_confirm'] = 'Bu panoyu kaldırmakistediğinize emin misiniz?';
$_lang['dashboard_remove_multiple'] = 'Panoyu kaldır';
$_lang['dashboard_remove_multiple_confirm'] = 'Seçili Panoları kaldırmak istediğinize emin misiniz?';
$_lang['dashboard_update'] = 'Panoyu Güncelle';
...
$_lang['dashboard_err_remove'] = 'Pano kaldırılmaya çalışılırken bir hata meydana geldi.';
$_lang['dashboard_err_remove_default'] = 'Varsayılan panoyu kaldıramazsınız!';
...
$_lang['dashboard_usergroup_remove'] = 'Panoyu kullanıcı grubundan kaldır';
...
$_lang['dashboard_widgets.intro_msg'] = 'Bu panodan widgetları ekleyebilir, yönetebilir ve kaldırabilirsiniz. Ayrıca, onları yeniden düzenlemek için satırları sürükleyip bırakabilirsiniz.';
...
$_lang['widget_create'] = 'Yeni widget oluştur';
...
$_lang['widget_err_remove'] = 'Aracı kaldırmaya çalışılırken bir hata meydana geldi.';
...
$_lang['widget_dashboard_remove'] = 'Widget\'ı panodan kaldır';
...
$_lang['widget_new'] = 'Yeni Araç';
$_lang['widget_remove'] = 'Aracı Sil';
$_lang['widget_remove_confirm'] = 'Bu Gösterge Paneli Pencere öğesini kaldırmak istediğinize emin misiniz? Bu kalıcıdır ve tüm Gösterge Tablolarından kaldırılacaktır.';
$_lang['widget_remove_multiple'] = 'Birden çok aracı sil';
$_lang['widget_remove_multiple_confirm'] = 'Bu Kontrol Paneli Pencere Öğelerini kaldırmak istediğinizden emin misiniz. Bu değişiklik kalıcıdır ve araçlara atanmış tüm Gösterge Tablolarını kaldıracaktır.';
...
$_lang['widget_size_desc'] = 'Aracın boyutu. Yarı ekran genişliğinde ("Yarım"), tam ekran genişliğinde ("Tam") veya tam ekran genişliği ve iki sıra ("Çift") olabilir.';
$_lang['widget_size_double'] = 'Çift';
$_lang['widget_size_full'] = 'Dolu';
...
$_lang['widget_unplace'] = 'Aracı Gösterge tablosundan kaldır';
$_lang['widget_update'] = 'Aracı güncelle';
