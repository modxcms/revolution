...
$_lang['import_site_message'] = '<p>UUsando esta ferramenta você poderá importar o conteúdo de um conjunto de arquivos HTML para o banco de dados.<em>Por favor note que você precisará copiar os arquivos e/ou pastas para a pasta de \'core/import\'.</em></p><p>Preencha o formulário abaixo opções, opcionalmente, selecione um recurso principal para os arquivos importados da árvore do documento e pressione "Importar HTML"para iniciar o processo de importação. Os arquivos importados serão salvos no local selecionado, utilizando, sempre que possível, o nome de arquivos como alias do documento, o título da página o título do documento.</p>';
$_lang['import_site_resource'] = 'Importar recursos de arquivos estáticos';
$_lang['import_site_resource_message'] = '<p>Usando esta ferramenta você pode importar recursos de um conjunto de arquivos estáticos no banco de dados. <em> Por favor note que você precisará copiar os arquivos e / ou pastas para a pasta de \'core/import\'.
</em></p><p>Preencha o formulário abaixo opções, opcionalmente, selecione um recurso principal para os arquivos importados da árvore do documento e pressione importar recursos para iniciar o processo de importação. Os arquivos importados serão salvos no local selecionado, utilizando, sempre que possível, o nome de arquivos como alias do documento e, se for em HTML, o título da página o título do documento.</p>';
