...
$_lang['Grupos de usuários'] = 'Grupos de usuários';
$_lang['visível'] = 'Visível';
$_lang['xmlwriter_err_nf'] = 'MODx XMLWriter requer a extensão PHP para usar este recurso. Verifique se a extensão é instalada, antes de continuar.';