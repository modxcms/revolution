...
$_lang['access_grid_empty'] = 'Sem ACL\'s para exibir';
$_lang['access_grid_paginate'] = 'Exibindo ACL\'s {0} - {1} de {2}';
...
$_lang['user_group_category_err_ae'] = 'Grupo de Usuários já tem acesso a esta Categoria.';
