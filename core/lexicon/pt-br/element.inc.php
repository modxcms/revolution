...
$_lang['is_static_msg'] = 'Indica se a fonte de elemento é armazenado em um arquivo externo.';
...
$_lang['static_file_msg'] = 'Uma localização arquivo externo onde a fonte de elemento é armazenado.';
$_lang['static_source'] = 'Acesso à Fonte de Mídia para arquivo estático';
$_lang['static_source_msg'] = 'MODX vai usar essa Fonte de Mídia como um caminho de base ao procurar o arquivo de Elemento Estático. Usando "Nenhum" vai supor que você está especificando um caminho absoluto .';
$_lang['tv_elements'] = 'Valores de Opções de Entrada';
