...
$_lang['source_access_remove_confirm'] = 'Вы сапраўды жадаеце выдаліць доступ да гэтай крынiцы файлаў з гэтай групы карыстальнікаў?';
$_lang['source_access_update'] = 'Абнавіць доступ';
$_lang['source_create'] = 'Стварыць новую крыніцу файлаў';
$_lang['source_description_desc'] = 'Кароткае апісанне крыніцы файлаў.';
$_lang['source_duplicate'] = 'Дубляваць крыніцу файлаў';
...
$_lang['source_remove'] = 'Выдаліць крыніцу файлаў';
$_lang['source_remove_confirm'] = 'Вы сапраўды жадаеце выдаліць гэтую крыніцу файлаў? Гэта можа зламаць некаторыя зменныя шаблону, якія вы прыстасавалі да гэтай крыніцы.';
...
$_lang['source_update'] = 'Абнавіць крыніцу файлаў';
