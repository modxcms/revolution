...
$_lang['source_type_desc'] = 'Тып, або драйвер медыя крыніцы. Крыніца будзе выкарыстоўваць гэты драйвер для падлучэння падчас збору сваіх дадзеных. Напрыклад: файлавая сістэма будзе захопліваць файлы з файлавай сістэмы. S3 атрымае файлы з вядра S3.';
...
$_lang['source.access.intro_msg'] = 'Тут вы можаце абмежаваць медыя крыніцы для канкрэтных груп карыстальнікаў і прымяніць палітыкі доступу для гэтых груп карыстальнікаў. Медыя крыніца без падлучаных груп карыстальнікаў даступна для ўсіх карыстальнікаў сістэмы кіравання.';
...
$_lang['prop_file.basePath_desc'] = 'Шлях да файлаў, на якія паказвае крыніца.';
$_lang['basePathRelative'] = 'basePathRelative (адносны базавы шлях)';
$_lang['prop_file.basePathRelative_desc'] = 'Калі базавы шлях ўстаноўкі, адзначаны вышэй, не адносіцца да шляху ўстаноўкі MODX, ўсталюйце значэнне як Не.';
$_lang['baseUrl'] = 'baseUrl (базавая спасылка)';
$_lang['prop_file.baseUrl_desc'] = 'URL, па якім гэтая крыніца можа быць даступна.';
$_lang['baseUrlPrependCheckSlash'] = 'baseUrlPrependCheckSlash (правяраць слэш у пачатку базавай спасылкі)';
$_lang['prop_file.baseUrlPrependCheckSlash_desc'] = 'Калі праўда, MODX будзе падстаўляць baseUrl да спасылак пры апрацоўцы зменнай шаблону, калі ў пачатку URL няма прамога слэшу (/). Карысна для ўстаноўкі значэння зменнай шаблону па-за baseUrl.';
$_lang['baseUrlRelative'] = 'baseUrlRelative (адносная базавая спасылка)';
$_lang['prop_file.baseUrlRelative_desc'] = 'Калі налада базавага URL не з\'яўляецца адноснай да URL ўстаноўкі MODX, усталюйце значэнне Не.';
...
$_lang['prop_file.skipFiles_desc'] = 'Падзелены коскамі спіс. MODX прапусціць і схавае файлы і папкі, якія адпавядаюць любым са спіса.';
...
$_lang['prop_s3.skipFiles_desc'] = 'Падзелены коскамі спіс. MODX прапусціць і схавае файлы і папкі, якія адпавядаюць любым са спіса.';
