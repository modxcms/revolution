...
<p>Існуюць іншыя метады і серверы, якія вы можаце выкарыстоўваць, азнаёміўшыся з <a href="https://docs.modx.com/current/en/getting-started/maintenance/securing-modx">Кіраўніцтвам па «загартоўцы» MODX</a> для атрымання дадатковай інфармацыі пра бяспеку вашага сайта.</p>
