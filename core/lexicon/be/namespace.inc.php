...
$_lang['namespace_assets_path_desc'] = 'Пазначце тут абсалютны шлях да актываў для гэтай прасторы імёнаў. Мы можаце выкарыстоўваць запаўняльнікі накшталт {assets_path}. Прыклад: {assets_path}components/democomponent/';
$_lang['namespace_name_desc'] = 'Пазначце імя для прасторы імёнаў тут.';
$_lang['namespace_path'] = 'Шлях да ядра';
$_lang['namespace_path_desc'] = 'Пазначце тут абсалютны шлях да ядра для гэтай прасторы імёнаў. Мы можаце выкарыстоўваць запаўняльнікі накшталт {core_path}. Прыклад: {core_path}components/democomponent/';
