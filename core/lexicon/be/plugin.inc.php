...
$_lang['plugin_lock'] = 'Заблакаваць плагін для рэдагавання';
...
$_lang['plugin_msg'] = 'Тут вы можаце дадаваць/рэдагаваць плагіны. Плагіны гэта звычайны PHP код які выклікаецца кожны раз, калі адбываюцца выбранныя сістэмныя падзеі.';
