...
$_lang['plugin_desc_category'] = 'Катэгорыя, да якой належыць плагін.';
$_lang['plugin_desc_description'] = 'Кароткае апісанне гэтага плагіна.';
$_lang['plugin_desc_name'] = 'Імя гэтага плагіна.';
$_lang['plugin_delete_confirm'] = 'Вы сапраўды жадаеце выдаліць гэты плагін?';
$_lang['plugin_disabled'] = 'Неактыўны плагін';
$_lang['plugin_disabled_msg'] = 'Плагін дэактываваны і не будзе рэагаваць на падзеі.';
...
$_lang['plugin_err_remove'] = 'Адбылася памылка пры выдаленні плагіна.';
...
$_lang['plugin_event_err_remove'] = 'Адбылася памылка пры выдаленні падзеі плагіна.';
...
$_lang['plugin_event_plugin_remove_confirm'] = 'Вы сапраўды жадаеце выдаліць гэты плагін з гэтай падзеі?';
$_lang['plugin_event_update'] = 'Абнавіць падзею плагіна';
$_lang['plugin_lock'] = 'Плагін заблакаваны для рэдагавання';
$_lang['plugin_lock_msg'] = 'Карыстальнікі павінны мець дазвол edit_locked для рэдагавання гэтага плагіна.';
...
$_lang['plugin_msg'] = 'Тут вы можаце дадаваць/рэдагаваць плагіны. Плагін – гэта звычайны PHP код, які выклікаецца кожны раз, калі адбываюцца выбранныя сістэмныя падзеі.';
$_lang['plugin_name'] = 'Імя плагіна';
