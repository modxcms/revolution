...
$_lang['roles'] = 'Ролi';
$_lang['rrg_drag'] = 'Перацягніце рэсурсы ў группы рэсурсаў.';
...
$_lang['user_active_desc'] = 'Ці з\'яўляецца гэты карыстальнік актыўным. Калі карыстальнік не актыўны, то ён не зможа ўвайсці ў аніякі кантэкст або панэль кіравання.';
...
$_lang['user_edit_self_msg'] = 'Вам можа спатрэбіцца выйсці і зноў увайсці ў сістэму пасля захавання, каб цалкам абнавіць вашу інфармацыю.</strong><br>Акрамя таго, вы павінны выбраць ці стварыць новы пароль самастойна ці адправіць яго вам па электроннай пошце.';
...
$_lang['user_err_not_specified_blockedafter'] = 'Калі ласка, пазначце значэнне поля \'заблакаваны пасля\' ў фармаце mm/dd/yyyy. ';
$_lang['user_err_not_specified_blockeduntil'] = 'Калі ласка, пазначце значэнне поля \'заблакаваны да\' ў фармаце mm/dd/yyyy. ';
...
$_lang['user_err_not_specified_fileman_path'] = 'Каталог, які вы пазначылі, альбо:<br />1) Не існуе.<br />2) Не мае дазволу на чытанне<br />3) Не з\'яўляецца каталогам.';
$_lang['user_err_not_specified_manageraccess'] = 'Калі ласка, пазначце, ці павінен карыстальнік мець доступ да панэлі кіравання.';
...
$_lang['user_err_not_specified_managertheme'] = 'Тэма панэлі кіравання, якую вы пазначылі, не была загружана.';
...
$_lang['user_err_not_specified_notification_method'] = 'Калі ласка, пазначце спосаб апавяшчэння для нована пароля.';
...
$_lang['user_err_not_specified_uploadsize'] = 'Калі ласка, пазначце сапраўдны максімальны памер загрузкі ў байтах.';
...
$_lang['user_group_desc_dashboard'] = 'Панэль інструментаў, якую будуць выкарыстоўваць члены гэтай групы (якія маюць гэтую групу ў якасці першаснай групы).';
$_lang['user_group_document_group_err_already_exists'] = 'Карыстацкая група ўжо прывязана да гэтай групы дакументаў.';
...
$_lang['user_group_err_already_exists'] = 'Ужо існуе група карыстальнікаў з гэтым імем.';
...
$_lang['user_remote_data_msg'] = 'Рэдагаваць аддалённыя карыстацкія дадзеныя тут.';
...
$_lang['user_settings_desc'] = 'Тут вы можаце змяніць пэўныя налады для карыстальніка.';
...
$_lang['user_upload_message'] = 'Калі вы жадаеце забараніць гэтаму карыстальніку загрузку ўсіх тыпаў файлаў у гэтай катэгорыі, пераканайцеся, што сцяжок \'Выкарыстоўваць галоўныя сістемныя налады\' не ўсталяваны і пакіньце гэтае поле пустым.';
