...
$_lang['lexicon_import_err_upload'] = 'Адбылася памылка пры спробе загрузіць новы файл тэмы слоўніка. Пераканайцеся ў дакладнасці правоў доступу вашага вэб-сервера, паспрабаваўшы загрузіць файлы ў часовую дырэкторыю, і што файл, які вы спрабуеце загрузіць, не змяшчае ў сабе памылак.';
