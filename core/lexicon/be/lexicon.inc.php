...
$_lang['lexicon_management_desc'] = 'Тут вы можаце перазапісаць любы запіс слоўніка ў гэтай прасторы iменаў і ў адпаведнай тэме. Проста двойчы націсніце на любы параметр запісу, каб змяніць яго. Каб дадаць новы запіс у слоўнік або тэму, проста стварыце для яго файлы тэмы ў каталогу з імем адпаведнай прасторы імёнаў.';
