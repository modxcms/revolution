...
$_lang['tv_elements_desc'] = 'Значэнні параметраў для зменных шаблону з некалькімі выбіраемымі элементамі, напрыклад, выпадны спіс ці тэг (варыянты, раздзеленыя ||, напрыклад Кот||Сабака ці Белы==#000000||Чорны==#ffffff).';
