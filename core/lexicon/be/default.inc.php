...
$_lang['tv_elements_desc'] = 'Значэння параметраў для дадатковых палёў з некалькімі выбіраемымі элементамі, напрыклад, расчыняецца спіс або тэг (варыянты, падзеленыя ||, напрыклад: Кошка||Сабака або Белы==#ffffff||Чорны==#000000).';
