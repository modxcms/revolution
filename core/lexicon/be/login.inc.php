...
$_lang['login_password_reset_act_sent'] = 'Калі карыстальнік ці email ужо існуюсь, вы хутка атрымаеце пісьмо.';
$_lang['login_remember'] = 'Запомніць мяне';
$_lang['login_send_activation_email'] = 'Даслаць ліст для актывацыі';
$_lang['login_title'] = 'Увайсці';
$_lang['login_user_err_nf_email'] = 'Калі карыстальнік ці email ужо існуюсь, вы хутка атрымаеце пісьмо.';
