...
$_lang['dashboard_err_remove'] = 'Адбылася памылка пры спробе выдаліць панэль кіравання.';
$_lang['dashboard_err_remove_default'] = 'Вы не можаце выдаліць панэль кіравання, якая выкарыстоўваецца па змаўчанні!';
