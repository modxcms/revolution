...
$_lang['dashboard_desc_customizable'] = 'Дазволіць карыстальнікам наладжваць гэтую панэль кіравання для сваіх рахункаў: дадаваць, выдаляць і змяняць становішча або памер віджэтаў.';
...
$_lang['dashboard_widgets.intro_msg'] = 'Кіраванне віджэтамі гэтай панэлі. Вы можаце таксама перацягваць радкі ў табліцы, каб памяняць іх месцамі.<br><br>Калі ласка, майце на ўвазе: калі панэль "наладжвальная", гэтыя налады будуць прымяняцца толькі для першай загрузкі для кожнага карыстальніка. Пасля яны будуць мець магчымасць дадаваць, выдаляць або мяняць пазіцыю ці памер сваіх віджэтаў. Доступ карыстальнікаў да віджэтаў можа быць абмежаваны шляхам прымянення дазволаў.';
