...
$_lang['unique_key_desc'] = 'Унікальны ключ, які пазначае, як шукаць аб\'ект. Можа быць радком або паделеным коскамі спісам. Прыклады: <br />"name" для modPlugin<br />"templatename" для modTemplate<br />Ці большо складана, "pluginid,evtid" для modPluginEvent';
