...
$_lang['area_lexicon_string'] = 'Запіс слоўніка для раздела';
...
$_lang['setting_friendly_alias_word_delimiters_desc'] = 'Сімвалы, якія ўяўляюць сабой падзельнікі слоў падчас апрацоўкі псеўданімаў. Гэтыя сімвалы будуць ператвораны і зведзены ў адзіны знак-падельнік.';
