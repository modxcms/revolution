...
$_lang['settings_desc'] = 'Тут вы можаце змяніць асноўныя перавагі і налады сістэмы кіравання MODX, а таксама налады працы самога сайта. Двойчы клікніце па слупку значэння пэўнай налады, якую вы жадаеце адрэдагаваць, для хуткага рэдагавання праз табліцу, або клікніце правай кнопкай мышы для іншых дзеянняў. Каб убачыць апісанне налады, націсніце на «+».';
