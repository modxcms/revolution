...
$_lang['source_remove_multiple'] = 'Удалить источники файлов';
...
$_lang['source_update'] = 'Обновить источник файлов';
...
$_lang['source_type.file_desc'] = 'Файловый источник, использует файловую систему сервера.';
