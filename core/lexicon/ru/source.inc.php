...
$_lang['source.access.intro_msg'] = 'Здесь вы можете дать доступ к источнику файлов определённым группам пользователей и назначить политики доступа для этих групп пользователей. Источник файлов, не имеющий связанной с ним группы пользователей, будет доступен всем пользователям панели управления.';
...
$_lang['prop_file.basePathRelative_desc'] = 'Выберите «Нет», если параметр «базовый путь» указан не относительно пути установки MODX.';
...
$_lang['prop_file.baseUrlRelative_desc'] = 'Выберите «Нет», если параметр «базовый URL» указан не относительно URL установки MODX.';
