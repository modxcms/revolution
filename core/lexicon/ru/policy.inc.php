...
$_lang['permission_new'] = 'Создать разрешение';
...
$_lang['policy_desc_description'] = 'Необязательный параметр. Краткое описание политики доступа. Также вы можете использовать ключи словарей здесь.';
...
$_lang['policy_update'] = 'Редактировать политику доступа';
...
$_lang['policy_template_desc_description'] = 'Необязательный параметр. Краткое описание шаблона политики доступа. Также вы можете использовать ключи словарей здесь.';
...
$_lang['policy_template_administrator_desc'] = 'Шаблон политики администрирования контекста со всеми разрешениями.';
$_lang['policy_template_resource_desc'] = 'Шаблон политики доступа к ресурсу со всеми атрибутами.';
$_lang['policy_template_object_desc'] = 'Шаблон политики доступа к объектам со всеми атрибутами.';
$_lang['policy_template_element_desc'] = 'Шаблон политики доступа к элементу со всеми атрибутами.';
$_lang['policy_template_mediasource_desc'] = 'Шаблон политики доступа к файлам со всеми атрибутами.';
$_lang['policy_template_context_desc'] = 'Шаблон политики доступа к контекстам со всеми атрибутами.';
$_lang['policy_template_namespace_desc'] = 'Шаблон политики имён со всеми атрибутами.';
$_lang['policy_template_group_administrator_desc'] = 'Все шаблоны политики администратора.';
$_lang['policy_template_group_object_desc'] = 'Все шаблоны политики доступа на основе ресурсов.';
$_lang['policy_template_group_resource_desc'] = 'Все шаблоны политики доступа на основе объектов.';
$_lang['policy_template_group_element_desc'] = 'Все шаблоны политики доступа на основе элементов.';
$_lang['policy_template_group_mediasource_desc'] = 'Все шаблоны политики доступа, основанные на источниках файлов.';
...
$_lang['policy_resource_desc'] = 'MODX политика ресурсов со всеми атрибутами.';
$_lang['policy_administrator_desc'] = 'Политика администрирования контекстов со всеми разрешениями.';
$_lang['policy_load_only_desc'] = 'Минимальная политика с разрешением на загрузку объекта.';
$_lang['policy_load_list_and_view_desc'] = 'Разрешает только загрузку, перечисление и просмотр разрешений.';
$_lang['policy_object_desc'] = 'Политика объектов со всеми разрешениями.';
$_lang['policy_element_desc'] = 'MODX политика элементов со всеми атрибутами.';
...
$_lang['policy_media_source_admin_desc'] = 'Политика администрирования медиа файлов.';
$_lang['policy_media_source_user_desc'] = 'Политика исходных файлов для источников файловс  базовым просмотром и использованием, но без редактирования.';
...
$_lang['policy_context_desc'] = 'Стандартная политика контекстов, которая может применяться при создании ACL контекста для базового доступа для чтения/записи и view_unpublished в контексте.';
