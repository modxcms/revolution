...
$_lang['policy_err_ae'] = 'Уже существует политика доступа с именем `[[+name]]`. Пожалуйста, укажите другое имя.';
...
$_lang['policy_template_err_ae'] = 'Уже существует шаблон политики доступа с именем `[[+name]]`. Пожалуйста, укажите другое имя.';
