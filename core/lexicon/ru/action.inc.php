...
$_lang['action_desc'] = 'Действия это абстракция контроллеров MODx. Они могут быть использованы для создания пользовательских страниц в бэкенде сайта, а также для перестраивания верхнего меню в бэкенде сайта.';
