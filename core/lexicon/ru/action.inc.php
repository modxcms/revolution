...
$_lang['action_desc'] = 'Действия это абстракция контроллеров MODx. Они могут быть использованы для создания пользовательских страниц в административной части системы управления сайтом, а также для перестраивания главного меню системы управления сайтом.';
...
$_lang['action_place_here'] = 'Создать пункт меню здесь';
