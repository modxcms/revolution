...
$_lang['action_confirm_remove'] = 'Вы уверены, что хотите удалить это действие? Это может нарушить работу бэкенда MODX.';
$_lang['action_create'] = 'Создать действие';
$_lang['action_create_here'] = 'Создать действие здесь';
$_lang['action_desc'] = 'Действия это абстракции контроллеров. Они могут быть использованы для создания пользовательских страниц менеджера, а также для реорганизации верхнего меню в бэкенде  MODx.';
