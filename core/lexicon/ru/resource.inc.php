...
$_lang['resource_change_template_confirm'] = 'Вы уверены, что хотите изменить шаблон? <br /><br />ВНИМАНИЕ: При этом будут сохранены все изменения и перезагружена страница, убедитесь, что вы готовы сделать это перед продолжением.';
