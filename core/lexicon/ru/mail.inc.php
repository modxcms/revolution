...
$_lang['mail_err_unset_spec'] = 'класс modPHPMailer не поддерживает отмену отправки по некоторым адресам. Используйте метод reset() для очистки всех получателей и после этого добавьте нужных получателей снова.';