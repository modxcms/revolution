...
$_lang['rest.err_field_ns'] = 'Поле [[+field]] не указано!';
$_lang['rest.err_field_required'] = 'Это поле обязательно.';
$_lang['rest.err_fields_required'] = 'Следующие поля обязательны для заполнения: [[+fields]]';
