...
$_lang['user_group_context_policy_desc'] = 'Политика доступа которую будет использовать эта группа пользователей для этого контекста. Для всех пользователей в этой группе с указанной минимальной ролью будет предоставлен доступ ко всем разрешения выбранной политики .';
...
$_lang['user_group_resourcegroup_policy_desc'] = 'The Policy to apply to this Context with Resources in the Resource Group for this User Group. Для всех пользователей в этой группе с указанной минимальной ролью будет предоставлен доступ ко всем разрешения выбранной политики .';
...
$_lang['user_group_source_policy_desc'] = 'Политика доступа которую будет использовать эта группа пользователей для этого источника файлов. Для всех пользователей в этой группе с указанной минимальной ролью будет предоставлен доступ ко всем разрешения выбранной политики .';
