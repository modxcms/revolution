...
$_lang['access_category_err_remove'] = 'Произошла ошибка при попытке удалить категорию контроля доступа.';
...
$_lang['access_context_err_remove'] = 'Произошла ошибка при попытке удалить контекст контроля доступа.';
...
$_lang['access_err_remove'] = 'Произошла ошибка при попытке удалить контроль доступа.';
...
$_lang['resource_group_err_name_ns'] = 'Пожалуйста, введите имя для группы ресурсов.';
...
$_lang['user_group_aw_desc'] = 'Внимание: После создания группы ресурсов необходимо завершить все сеансы, если выбран один из вариантов ниже.';
