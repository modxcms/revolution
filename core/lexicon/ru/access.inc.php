...
$_lang['access_err_ae'] = 'ACL-запись уже существует!';
$_lang['access_err_create_md'] = 'Невозможно создать ACL-запись, потеряны данные!';
$_lang['access_err_nf'] = 'Невозможно найти указанную ACL-запись!';
...
$_lang['access_permissions_links_tab'] = 'Здесь мы указываем какой группе пользователей предоставлен доступ к группе ресурсов(т.е. какие пользователи могут редактировать ресурсы и создавать дочерние ресурсы) . Для связи группы ресурсов и группы пользователей выбирите группу из выпадающего меню и щелкните &laquo;Link&raquo;. Для удаления связи нажмите &laquo;Remove ->&raquo;. Это немедленно удалит связь группы пользователей и группы ресурсов.';
...
$_lang['roles_msg'] = 'Роль это положение или статус налагаемые в определённых условиях. Роли могут быть использованны для объединения пользователей в группы по положению или для определения статуса пользователя в групе пользователей. У ролей в MODx есть свойство называемое «ранг». Это числовое значение, которое может быть любым целым числом. Ранг роли "наследуется вниз", в том смысле,что роль с рангом 1 будет наследовать  политики доступа любой роли с рангом больше, чем 1.';
$_lang['user_group_category_access'] = 'Доступ к категории элементов';
$_lang['user_group_category_access_msg'] = 'Здесь вы можете определить к элементам в каких категориях элементов эта группа имеет доступ.';
$_lang['user_group_category_err_ae'] = 'Группа пользователей уже имеет доступ к этой категории.';
$_lang['user_group_category_remove_confirm'] = 'Вы уверенны, что хотите удалить доступ к этой категории у этой группы ппользователей?';
...
$_lang['user_group_context_remove_confirm'] = 'Вы уверенны, что хотите удалить доступ к этому контексту из этой группы пользователей?';
