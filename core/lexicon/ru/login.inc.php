...
$_lang['login_blocked_admin'] = 'Вы были заблокированы администратором.';
$_lang['login_blocked_error'] = 'Вы временно заблокированы и не можете войти в систему управления сайтом. Пожалуйста, попробуйте позже.';
$_lang['login_blocked_ip'] = 'Вам запрещено входить в систему управления сайтом с этого IP-адреса.';
$_lang['login_blocked_time'] = 'В настоящее время вам запрещено входить в систему управления сайтом. Пожалуйста, попробуйте позже.';
