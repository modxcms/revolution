...
$_lang['help_main_subhead'] = 'Смотрите ниже, если хотите получить помощь для вашего MODX проекта<br>Более подробная информация на <a href="https://modx.com/community/free-support-options">modx.com/community/free-support-options</a> или по телефону +1 (469) 777-6639';
$_lang['forums'] = 'Форумы';
...
$_lang['localization'] = 'Локализация MODX';
$_lang['localization_title'] = 'Локализация MODX';
$_lang['localization_description'] = 'Помогите нам с локализацией MODX';
...
$_lang['email_sub_description'] = 'Подпишитесь на <b>новости MODX</b>, чтобы получать все важные уведомления о MODX. Просто введите ваш электронный ящик ниже — мы обещаем никогда не рассылать спам.';
