...
$_lang['content_type_desc'] = 'Тип содержимого для ресурсов это то, что MODX будет отправлять в строчке «Content-Type» заголовка сервера. Здесь вы можете управлять ими и сопоставлять с расширениями файлов(MODX будет добавлять расширение файла после псевдонима, если включены дружественные урлы).';
...
$_lang['content_type_err_ns_name'] = 'Пожалуйста, укажите корректное имя для типа содержимого.';
...
$_lang['file_extensions_desc'] = 'Это расширение файла для этого типа содержимого.';