...
$_lang['content_type_desc'] = 'Тип содержимого для ресурсов это то, что MODx  будет отправлять в строчке &laquo;Content-Type&raquo; заголовка сервера. Здесь вы можете управлять ими и сопоставлять с расширениями файлов(MODx будет добавлять расширение файла после псевдонима, если включены дружественные урлы).';
