...
$_lang['content_type_desc'] = 'Тип содержимого для ресурсов — это то, что MODX будет отправлять в строчке «Content-Type» заголовка сервера. Здесь вы можете управлять типами и сопоставлять с расширениями файлов (MODX будет добавлять расширение файла после псевдонима, если включены дружественные URL).';
