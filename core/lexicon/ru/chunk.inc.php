...
$_lang['chunk_msg'] = 'Здесь вы можете создавать/редактировать чанк. Помните, чанки – чистый HTML-код, и любые PHP-скрипты выполняться в них не будут.';
$_lang['chunk_name'] = 'Название чанка';
