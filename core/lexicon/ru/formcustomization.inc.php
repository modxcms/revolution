...
$_lang['form_customization_msg'] = 'Вот список применяемых в настоящий момент правил. Более подробную информацию о правилах и настройке форм можно найти <a href="<a href="https://docs.modx.com/3.x/en/building-sites/client-proofing/form-customization" target="_blank">" target="_blank">здесь</a>. Пожалуйста, обратите внимание, что некорректные правила могут привести к проблемам с вашим MODX Revolution. Неактивные правила помечены серым цветом.';
