...
$_lang['field'] = 'Поле';
$_lang['field_desc'] = 'Это область, к которой применяется правило. Это может быть поле, вкладка или дополнительное поле (TV). Если это дополнительное поле (TV), то указывайте его в формате: &laquo;tv#&raquo;, где # это ID дополнительного поля.';
