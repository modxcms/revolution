...
$_lang['form_customization_msg'] = 'Подробную информацию о правилах и настройке форм можно найти  <a href="http://rtfm.modx.com/display/revolution20/Customizing+the+Manager" target="_blank">здесь</a> . Пожалуйста, обратите внимание, что неправильное правило может привести к проблемам в работе бэкенда MODX. Неактивные правила помечены серым цветом.';
