...
$_lang['set_tvs_msg'] = 'Здесь можно изменить настройки для <abbr title="Дополнительное поле">TV</abbr> ресурса, их видимость, название, значение по умолчанию и указать вкладку, в которой они должны отображаться. Внимание: Если вы перемещаете TV в другую вкладку, то порядок показа TV можно настроить с помощью поля «Порядок сортировки».';
