...
$_lang['configcheck_installer_msg'] = 'Папка setup/ содержит файлы установки системы MODx. Злоумышленник может найти эту папку и запустить процесс установки! Удалите эту папку с сервера.';
