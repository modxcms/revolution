...
$_lang['configcheck_allowtagsinpost_context_enabled'] = 'Настройка allow_tags_in_post включена для контекста, отличного от `mgr`';
$_lang['configcheck_allowtagsinpost_context_enabled_msg'] = 'Настройка allow_tags_in_post включена в вашей системе для не-mgr контекста. MODX рекомендует отключать эту настройку, кроме случаев, когда пользователям нужно явно разрешить отправку MODX-тегов, числовых HTML-сущностей, или HTML script тегов POST-методом через форму на вашем сайте. В общем случае эта настройка должна быть отключена для всех контекстов, кроме "mgr".';
$_lang['configcheck_allowtagsinpost_system_enabled'] = 'Системная настройка allow_tags_in_post включена';
$_lang['configcheck_allowtagsinpost_system_enabled_msg'] = 'Системная настройка allow_tags_in_post включена в вашей системе. MODX рекомендует отключать эту настройку, кроме случаев, когда пользователям нужно явно разрешить отправку MODX-тегов, числовых HTML-сущностей, или HTML script тегов POST-методом через форму на вашем сайте. Лучше всего включить эту настройку непосредственно в настройках нужного контекста.';
