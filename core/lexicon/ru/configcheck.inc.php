...
$_lang['configcheck_installer_msg'] = 'Каталог setup/ содержит файлы установки для MODx. Только представьте себе, что может произойти, если злой человек найдёт его и запустит установку! Удалите этот каталог с вашего сервера.';
