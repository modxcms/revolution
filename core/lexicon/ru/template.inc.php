...
$_lang['template_msg'] = 'Создание и редактирование шаблонов. Измененные или новые шаблоны не будут видны на кэшированных страницах вашего сайта до тех пор, пока кэш не будет очищен, вы можете использовать функцию предпросмотра страницы для того что бы просмотреть шаблон  в действии.';
