...
$_lang['template_icon_description'] = 'Необязательный. Пользовательский класс значков CSS для всех ресурсов с этим шаблоном. Например, класс Font Awesome (бесплатный), такой как icon-home или fa-home.';
...
$_lang['template_msg'] = 'Создание и редактирование шаблонов. Измененные или новые шаблоны не будут видны на кэшированных страницах вашего сайта до тех пор, пока кэш не будет очищен; однако вы можете использовать функцию предварительного просмотра на странице, чтобы увидеть шаблон в действии.';
$_lang['template_name'] = 'Название шаблона';
...
$_lang['template_source'] = 'Источник файлов';
$_lang['template_source_description'] = 'Источник файлов для выбора статического файла или предварительного просмотра. Если источник не задан, предполагается, что вы укажите абсолютный путь.';
$_lang['template_preview'] = 'Предварительный просмотр шаблона';
$_lang['template_preview_description'] = 'Скриншот шаблона, используемый в качестве предварительного просмотра. Наилучший размер 335 x 236 (ш x в)';
