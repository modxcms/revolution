...
$_lang['snippet_msg'] = 'Здесь вы можете создавать/редактировать сниппеты. Помните, сниппеты — это «сырой» PHP-код, и если вы собираетесь делать вывод из сниппета, который будет в определенном месте шаблона, вам необходимо вернуть значение из сниппета.';
