...
$_lang['setting_friendly_alias_max_length_desc'] = 'Если указано больше нуля, заданное значение будет использаться как максимальное число символов, допускаемое в псевдониме ресурсов. Ноль означает отсутствие ограничения.';
...
$_lang['setting_modx_browser_default_viewmode_desc'] = 'Режим просмотра по умолчанию, при использовании контекстного меню файлового менеджера в админке. Доступные значения: сетка, список.';
...
$_lang['setting_xhtml_urls_desc'] = 'Если выбрано «Да», все ссылки, генерируемые MODX, будут XHTML-совместимыми (символ &amp; будет заменен на соответствующую сущность &amp;amp;).';
