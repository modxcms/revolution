...
$_lang['settings_desc'] = 'Здесь вы можете изменить основные опции и настройки панели управления MODX, а также сайта. <b>Каждая настройка будет доступа через плейсхолдер [[++key]].</b><br />Дважды нажмите по параметру в колонке «Значение» для редактирования, или нажмите правой кнопкой мыши для других действий. Чтобы увидеть описание настройки, нажмите на «+».';
...
$_lang['setting_login_allowed_days_desc'] = 'Укажите дни, в которые пользователю разрешено входить в панель управления сайтом.';

$_lang['setting_login_allowed_ip'] = 'Разрешённые IP адреса';
$_lang['setting_login_allowed_ip_desc'] = 'Укажите IP-адреса, через запятую, с которых пользователю разрешено входить в панель управления сайтом.';
