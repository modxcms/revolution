...
$_lang['setting_create'] = 'Новые настройки';
...
$_lang['setting_allow_tv_eval_desc'] = 'Выберите этот параметр, чтобы разрешить или запретить исполнение кода в TV. Если этот параметр имеет значение «Нет», код или значение обработается как обычный текст.';
...
$_lang['setting_settings_version'] = 'Версия дистрибутива';
