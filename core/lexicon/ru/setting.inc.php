...
$_lang['area_lexicon_string'] = 'Область ввода словаря';
...
$_lang['setting_login_allowed_days'] = 'Разрешенные дни';
...
$_lang['setting_cache_context_settings_desc'] = 'Когда включено, настройки контекста будут кешироваться для уменьшения времени загрузки.';
...
$_lang['setting_cache_db_expires'] = 'Время жизни кэша БД';
...
$_lang['setting_cache_disabled_desc'] = 'Выберите «Да» для отключения всех особенностей кэширования MODx';
...
$_lang['setting_cache_lang_js'] = 'Кэшировать  JS с записями словаря';
$_lang['setting_cache_lang_js_desc'] = 'Если включено, то будут добавлены кэширующие заголовки сервера в JavaScript с записями словаря(используется для перевода интерфейса бэкэнда сайта).';
...
$_lang['setting_cache_system_settings_desc'] = 'При включении этой опции системные настройки будут кешироваться для уменьшения времени загрузки.MODx рекомендует оставить эту настройку включенной.';
...
$_lang['setting_editor_css_path_desc'] = 'Укажите путь к файлу CSS, который Вы будете использовать в редакторе. Лучше всего указать путь от корневого каталога Вашего сервера, например: /assets/site/style.css. Оставьте это поле пустым, если не хотите использовать в стили редакторе.';
...
$_lang['setting_emailsender'] = 'E-mail адрес';
...
$_lang['setting_manager_language_desc'] = 'Установите язык, используемый системой MODx.';
...
$_lang['setting_signupemail_message'] = 'Зарегистрировать e-mail';
