...
$_lang['setting_allow_tv_eval_desc'] = 'Выберите этот параметр, чтобы включить или отключить исполнение кода в TV. Если этот параметр имеет значение «Нет», значение кода обработается как обычный текст.';
...
$_lang['log_snippet_not_found'] = 'Лог сниппетов не найден';
