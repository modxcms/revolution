...
$_lang['setting_upload_check_exists'] = 'Проверять файлы при загрузке на существование';
$_lang['setting_upload_check_exists_desc'] = 'Если включено, при загрузке файла с таким же именем будет показано сообщение с ошибкой. Если отключено, то существующий файл будет заменён новым.';
