...
$_lang['namespace_desc'] = 'Пространство имён с которым этот параметр связан. Тема словаря «default» для этого пространства имён будет использованапри при просмотре.';
...
$_lang['setting_allow_forward_across_contexts_desc'] = 'Если выбрано «Да», то символические ссылки и метод АПИ modX::sendForward() могут перенаправлять запросы на ресурсы в других контекстах.';
$_lang['setting_allow_manager_login_forgot_password'] = 'Разрешить «Забыл пароль» на странице входа в систему.';
$_lang['setting_allow_manager_login_forgot_password_desc'] = 'Выбор «Нет» отключит опцию «Забыл пароль» на странице входа в систему.';
...
$_lang['setting_compress_js_groups_desc'] = 'Group the core MODX manager JavaScript using minify\'s groupsConfig. Установите «Да» если используете suhosin или другие ограничивающие факторы.';
...
$_lang['setting_debug_desc'] = 'Включает/выключает режим отладки в MODX и/или устанавливает уровень отображения ошибок для PHP. \'\' = использовать текущий error_reporting, \'0\' = false (error_reporting = 0), \'1\' = true (error_reporting = -1), или любое другое значение error_reporting (как число).';
$_lang['setting_default_content_type'] = 'Тип контента по умолчанию';
$_lang['setting_default_content_type_desc'] = 'Выберите тип контента по умолчанию для новых ресурсов.';
...
$_lang['setting_default_media_source_desc'] = 'Источник файлов по умолчанию.';
...
$_lang['setting_filemanager_url_relative_desc'] = 'Этот парамер устарел - используйте источники файлов. If your filemanager_url setting is relative to the MODX base_url, then please set this setting to Yes. If your filemanager_url is outside the main webroot, set this to No.';
...
$_lang['setting_log_target'] = 'Метод вывода журнал ошибок';
...
$_lang['setting_manager_js_zlib_output_compression'] = 'Включить zlib сжатие для JS/CSS файлов бэкэнда';
...
$_lang['setting_request_method_strict_desc'] = 'Если включен, запросы через параметр ID будут игнорироваться при включённых дружественных урлах. Если дружественные урлы отключены, то запросы с использованием пвсевдонима будут игнорироваться.';
...
$_lang['setting_show_tv_categories_header'] = 'Показывать вкладки с категориями при выводе TV';
$_lang['setting_show_tv_categories_header_desc'] = 'Если «Да», MODX будет группировать дополнительные поля по категориям и создавать для каждой категории отдельную вкладку при редактировании ресурса.';
