...
$_lang['key_desc'] = 'Ключ настройки. Настройка будет доступна в контенте через плейсхолдер [[++key]]';
...
$_lang['setting_failed_login'] = 'Лимит попыток входа в панель управления';
$_lang['setting_failed_login_desc'] = 'Укажите число неудачных попыток входа в панель управления, при превышении которого пользователь будет блокирован.';
...
$_lang['setting_blocked_minutes_desc'] = 'Время (в минутах), на которое пользователь будет блокирован в случае превышения количества попыток входа в панель управления. Вводите только цифры (без запятых, пробелов и т.п.).';
...
$_lang['setting_cache_alias_map_desc'] = 'Если выбрано «Да», все URI ресурсов кэшируются в контекст. Включайте для небольших сайтов и отключайте для больших сайтов для увеличения производительности.';
...
$_lang['setting_cache_db_session_lifetime_desc'] = 'Это значение (в секундах) устанавливает период жизни кэша сессий базы данных.';
...
$_lang['setting_cache_lang_js_desc'] = 'Если выбрано «Да», будут добавлены кэширующие заголовки к javascript-файлам с записями словарей для панели управления.';

$_lang['setting_cache_lexicon_topics'] = 'Кэшировать темы словарей';
$_lang['setting_cache_lexicon_topics_desc'] = 'Если выбрано «Да», все темы словарей будут кэшироваться — это увеличивает скорость загрузки страниц панели управления. MODX рекомендует оставить этот параметр включённым («Да»).';
...
$_lang['setting_failed_login_attempts'] = 'Лимит попыток входа в панель управления';
$_lang['setting_failed_login_attempts_desc'] = 'Число неудачных попыток входа в панель управления, при превышении которого пользователь пользователь будет заблокирован.';
...
$_lang['setting_feed_modx_security_enabled_desc'] = 'Если выбрано «Нет», MODX будет скрывать ленту «Уведомления безопасности MODX» на экране приветствия панели управления.';
...
$_lang['setting_form_customization_use_all_groups'] = 'Учитывать членство во всех группах пользователя для настройки форм';
...
$_lang['setting_modx_charset_desc'] = 'Пожалуйста, укажите какую кодировку вы хотите использовать для панели управления. Обратите внимание, что MODX был протестирован с некоторыми кодировками, но не со всеми. Для большинства языков предпочтительной является кодировка UTF-8.';
...
$_lang['setting_site_unavailable_page'] = 'Страница «Сайт недоступен»';
$_lang['setting_site_unavailable_page_desc'] = 'Введите ID ресурса, который вы хотите использовать в качестве страницы «Сайт недоступен». <strong>ВАЖНО: убедитесь, что этот ID принадлежит существующему ресурсу и этот ресурс опубликован!</strong>';
...
$_lang['setting_which_element_editor_desc'] = 'Здесь вы можете выбрать какой редактор использовать при редактировании кода. Вы можете скачать и установить дополнительные редакторы в разделе управления пакетами.';
