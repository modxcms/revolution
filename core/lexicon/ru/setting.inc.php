...
$_lang['setting_context_group_switch'] = 'Включить переключатель групп контекстов';
$_lang['setting_context_group_switch_desc'] = 'Если включено, над деревом ресурсов показывается выпадающий список групп контекстов, чтобы загружать одну группу за раз.';
$_lang['setting_context_tree_group'] = 'Группировать контексты в дереве ресурсов';
$_lang['setting_context_tree_group_desc'] = 'Если включено и есть группы контекстов, в дереве ресурсов группы показываются папками (при просмотре всех групп).';
...
$_lang['setting_package_installer_at_top'] = 'Закрепить Установщик пакетов наверху';
$_lang['setting_package_installer_at_top_desc'] = 'Если выбран, Установщик будет прикреплен к верхней части меню "Пакетов". В противном случае он будет размещен в соответствии с позицией в меню.';
