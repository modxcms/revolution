...
$_lang['setting_archive_with_desc'] = 'Если выбрано «Да», для работы с zip-архивами будет использоваться PCLZip вместо ZipArchive. Выберите «Да», если возникают ошибки "extractTo" или возникают проблемы с распаковкой пакетов.';

$_lang['setting_auto_menuindex'] = 'Нумерация меню по умолчанию';
$_lang['setting_auto_menuindex_desc'] = 'Выберите «Да», чтобы включить автоматическую нумерацию меню по умолчанию.';
...
$_lang['setting_automatic_alias_desc'] = 'Выберите «Да», чтобы автоматически генерировать псевдонимы на базе заголовка ресурса при его сохранении.';
...
$_lang['setting_cache_default_desc'] = 'Выберите «Да», чтобы сделать все новые ресурсы кэшируемыми по умолчанию.';
...
$_lang['setting_cache_disabled_desc'] = 'Выберите «Да», чтобы отключить весь механизм кэширования MODX. Не рекомендуется отключать.';
...
$_lang['setting_global_duplicate_uri_check_desc'] = 'Выберите «Да», чтобы проверять на дублирование URI во всех контекстах. Если выбрано «Нет», будет проверяться только контекст, в котором ресурс сохраняется.';

$_lang['setting_hidemenu_default'] = 'Скрыть из меню по умолчанию';
$_lang['setting_hidemenu_default_desc'] = 'Выберите «Да», чтобы параметр «Скрыть из меню» был выбран по умолчанию, при создании новых ресурсов.';
...
$_lang['setting_mail_use_smtp_desc'] = 'Выберите «Да», чтобы использовать SMTP при отправки электронной почты.';
...
$_lang['setting_modx_browser_tree_hide_files_desc'] = 'Если выбрано «Да», файлы, располагающиеся в папке не будут отображаться в дереве диспетчера файлов. По умолчанию выключено.';
...
$_lang['setting_publish_default_desc'] = 'Выберите «Да», чтобы все новые ресурсы сразу становились опубликованными.';
...
$_lang['setting_search_default_desc'] = 'Выберите «Да», чтобы сделать все новые ресурсы доступными для поиска по умолчанию.';
...
$_lang['setting_site_status_desc'] = 'Выберите «Да», чтобы опубликовать ваш сайт в сети. Если вы выберите «Нет», ваши посетители увидят «Сообщение о недоступности сайта», и не смогут просматривать содержимое сайта.';
...
$_lang['setting_strip_image_paths_desc'] = 'Если выбрано «Нет», MODX будет использовать абсолютные ссылки для изображений, файлов, flash и тому подобного. Относительные ссылки удобнее, если вы в будущем собираетесь переместить свой сайт, например, с тестового сервера на конечный. Если вы не понимаете о чем идёт речь, оставьте значение «Да».';

$_lang['setting_symlink_merge_fields'] = 'Объединять поля ресурса с полями символической ссылки';
$_lang['setting_symlink_merge_fields_desc'] = 'Если выбрано «Да», то непустые поля символической ссылки заменят поля целевого ресурса при переадресации с использованием символической ссылки.';
...
$_lang['setting_topmenu_show_descriptions_desc'] = 'Если выбрано «Нет», MODX будет скрывать дополнительное описание для пунктов верхнего меню.';
...
$_lang['setting_auto_isfolder_desc'] = 'Если выбрано «Да», ресурс будет помечен как «контейнер» автоматически.';
...
$_lang['setting_manager_use_fullname_desc'] = 'Если выбрано «Да», в шапке панели управления будет отображаться содержимое поля «Полное имя» вместо «Имя пользователя»';
