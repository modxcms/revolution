...
$_lang['area_static_elements'] = 'Все статические Элементы (шаблоны, TV, чанки, сниппеты и плагины)';
...
$_lang['settings_desc'] = 'Здесь вы можете изменить основные опции и настройки панели управления MODX, а также сайта. Дважды нажмите по параметру в колонке «Значение» для редактирования, или нажмите правой кнопкой мыши для других действий. Чтобы увидеть описание настройки, нажмите на «+».';
...
$_lang['setting_automatic_template_assignment'] = 'Выберите, как шаблон будет присваиваться при создании нового ресурса. Опции включают: «system» (шаблон по умолчанию из системных настроек), «parent» (наследуется шаблон родительского ресурса), или «sibling» (наследуется наиболее используемый шаблон соседних ресурсов)';

$_lang['setting_base_help_url'] = 'URL помощи';
$_lang['setting_base_help_url_desc'] = 'URL для ссылки помощи в верхнем правом углу страниц панели управления.';
...
$_lang['setting_use_context_resource_table_desc'] = 'Если выбрано «Да», при обновлении контекста используется таблица «context_resource». Это позволяет программно иметь один ресурс в нескольких контекстах одновременно. Если вы не используете эти ресурсы в нескольких контекстах через API, можно задать это значение равным «false». На крупных сайтах вы можете получить потенциальный прирост производительности в панели управления.';
...
$_lang['setting_cache_lexicon_topics_desc'] = 'Если выбрано «Да», все темы словарей будут кэшироваться, что увеличит скорость загрузки страниц панели управления. MODX рекомендует оставить этот параметр включённым («Да»).';
...
$_lang['setting_error_page_desc'] = 'Введите ID ресурса, который вы хотите использовать в качестве страницы ошибки 404 «Документ не найден». <strong>ВАЖНО: убедитесь, что этот ID принадлежит существующему ресурсу, и что этот ресурс опубликован!</strong>';
...
$_lang['setting_modx_browser_default_viewmode_desc'] = 'Режим просмотра по умолчанию при использовании контекстного меню файлового менеджера в панели управления. Доступные значения: «grid» (таблица), «list» (список).';
...
$_lang['setting_site_unavailable_page_desc'] = 'Введите ID ресурса, который вы хотите использовать в качестве страницы «Сайт недоступен». <strong>ВАЖНО: убедитесь, что этот ID принадлежит существующему ресурсу, и что этот ресурс опубликован!</strong>';
...
$_lang['setting_tvs_below_content_desc'] = 'Если выбрано «Да», дополнительные поля будут размещены ниже поля «Содержимое» при редактировании ресурса.';
...
$_lang['setting_unauthorized_page_desc'] = 'Введите ID ресурса, который вы хотите использовать в качестве страницы ошибки 403 «Доступ запрещен». <strong>ВАЖНО: убедитесь, что этот ID принадлежит существующему ресурсу, и что этот ресурс опубликован и публично доступен!</strong>';
...
$_lang['setting_error_log_filename'] = 'Имя файла журнала ошибок';
$_lang['setting_error_log_filename_desc'] = 'Настройка имени файла журнала ошибок MODX (включая расширение файла).';
