...
$_lang['setting_confirm_navigation'] = 'Подтверждение о потере несохраненных изменений';
$_lang['setting_confirm_navigation_desc'] = 'Если включено, при уходе со страницы, имеющей несохраненные изменения, пользователю будет предложено остаться на странице.';
...
$_lang['setting_ext_debug'] = 'Отладка ExtJS';
$_lang['setting_ext_debug_desc'] = 'Включите для загрузки несжатого файла ext-all-debug.js для облегчения отладки ExtJS кода.';
...
$_lang['setting_session_cookie_httponly'] = 'HttpOnly сессионных cookies';
$_lang['setting_session_cookie_httponly_desc'] = 'Используйте эту настройку, чтобы выставить флаг HttpOnly для сессионных cookies.';
