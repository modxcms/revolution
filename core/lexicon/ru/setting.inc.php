...
$_lang['setting_filemanager_path'] = 'Путь для диспетчера файлов (Deprecated)';
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. Сервер IIS зачастую не определяет свойство document_root, которое используется диспетчером файлов для определения мест, которые вам доступны. Если у вас возникли проблемы с использованием диспетчера файлов, убедитесь что этот путь указывает в корневую папку установки MODX.';
$_lang['setting_filemanager_path_relative'] = 'Путь для диспетчера файлов относительный? (Deprecated)';
$_lang['setting_filemanager_path_relative_desc'] = 'Deprecated - Use Media Sources instead. Если путь для диспетчера файлов(filemanager_path) является относительным к MODX base_path, то установите для этого параметра значение «Да». Если filemanager_path за пределами docroot, установите значение «Нет».';
$_lang['setting_filemanager_url'] = 'URL диспетчера файлов (Deprecated)';
...
$_lang['setting_filemanager_url_relative'] = 'URL диспетчера файлов относительный? (Deprecated)';
...
$_lang['setting_log_target'] = 'Куда выводить журнал ошибок';
$_lang['setting_log_target_desc'] = 'The default logging target where log messages are written. Возможные значения: \'FILE\', \'HTML\', или \'ECHO\'. По умолчанию используется \'FILE\'';
