...
$_lang['combo_forceselection_desc'] = 'Если включено автозаполнение и если выбрано «Да», то будет разрешен ввод элементов только из списка.';
...
$_lang['combo_preserve_selectionorder_desc'] = 'Когда установлено значение «Да», сохраненные элементы отображаются в том порядке, в каком они были изначально выбраны. В противном случае элементы следуют порядку, определенному в параметрах списка. (По умолчанию: Да)';
...
$_lang['combo_typeahead_delay_desc'] = 'Задержка в миллисекундах перед автозавершением набираемого значения, если автозавершение включено (по умолчанию 250).';
$_lang['date'] = 'Дата';
...
$_lang['number_strict_decimalprecision'] = 'Строгая десятичная точность ';
$_lang['number_strict_decimalprecision_desc'] = 'При значении «Да» сохраняет конечные нули в десятичных знаках (по умолчанию «Нет»).';
...
$_lang['required_desc'] = 'Если выбрано «Нет», MODX не разрешит пользователю сохранить ресурс пока это поле не будет заполнено.';
...
$_lang['resourcelist_parents_desc'] = 'Список ID ресурсов, дочерние ресурсы которых будут в списке.';
...
$_lang['hide_time'] = 'Скрыть выбор времени';
