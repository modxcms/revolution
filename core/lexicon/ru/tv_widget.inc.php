...
$_lang['earliest_time_desc'] = 'Самое раннее время, которое может быть выбранно.';
$_lang['email'] = 'Email';
...
$_lang['image_allowedfiletypes'] = 'Допустимые расширения файлов';
...
$_lang['image_basepath'] = 'Базовый путь';
...
$_lang['image_basepath_relative'] = 'Базовый путь относительный';
$_lang['image_basepath_relative_desc'] = 'Если путь указанный в настройке выше, не является относительным к пути установки MODx, установите значение Да.';
$_lang['image_baseurl'] = 'Базовый URL';
...
$_lang['image_baseurl_relative'] = 'Базовый URL относительный';
...
$_lang['resourcelist'] = 'Список ресурсов - Resource List';
...
$_lang['resourcelist_includeparent_desc'] = 'Если «Да», в список будут включаться  ресурсы, указанные в поле «Родители».';
...
$_lang['richtext'] = 'Форматированный текст - RichText';
