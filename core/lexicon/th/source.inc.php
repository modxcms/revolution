...
$_lang['source_access_remove'] = 'ลบการเข้าถึง';
$_lang['source_access_remove_confirm'] = 'คุณแน่ใจว่าต้องการลบการเข้าถึงแหล่งข้อมูลนี้สำหรับกลุ่มผู้ใช้นี้หรือไม่?';
$_lang['source_access_update'] = 'อัปเดตการเข้าถึง';
$_lang['source_create'] = 'สร้างแหล่งข้อมูลมีเดียใหม่';
...
$_lang['source_remove'] = 'ลบแหล่งข้อมูลมีเดีย';
$_lang['source_remove_confirm'] = 'คุณแน่ใจว่าต้องการลบแหล่งข้อมูลมีเดียนี้หรือไม่? นี่อาจจะสร้างความเสียหายให้กับตัวแปรแม่แบบใดๆที่คุณกำหนดมันให้กับแหล่งข้อมูลนี้';
...
$_lang['source_update'] = 'อัปเดตแหล่งข้อมูลมีเดีย';
...
$_lang['prop_file.basePath_desc'] = 'เส้นทางไฟล์เพื่อชี้ไปยังแหล่งข้อมูล';
...
$_lang['prop_file.baseUrl_desc'] = 'URL ที่แหล่งข้อมูลนี้สามารถเข้าถึงได้';
...
$_lang['prop_s3.imageExtensions_desc'] = 'รายการคั่นด้วยเครื่องหมายจุลภาคของนามสกุลไฟล์เพื่อทำเป็นรูปภาพ MODX จะพยายามสร้างรูปขนาดย่อของไฟล์ที่มีนามสกุลเหล่านี้';
