...
$_lang['tv_tab_input_options'] = 'ตัวเลือกอินพุต';
...
$_lang['tv_tab_output_options'] = 'ตัวเลือกเอาต์พุต';
...
$_lang['tv_tab_sources_desc'] = 'คุณสามารถกำหนดแหล่งข้อมูลมีเดียที่จะถูกใช้สำหรับตัวแปรแม่แบบนี้ในทุกๆบริบทที่ระบุ ดับเบิลคลิ๊กบนชื่อแหล่งข้อมูลในกริดเพื่อเปลี่ยนแปลงมัน';
$_lang['tv_tab_tmpl_access'] = 'การเข้าถึงแม่แบบ';
