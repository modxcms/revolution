...
$_lang['setting_archive_with_desc'] = 'ถ้าเลือก จะใช้งาน PCLZip แทนที่ ZipArchive ในนามสกุลของการบีบอัด  เปิดการใช้งานถ้าคุณเกิดข้อผิดพลาดในการแตกไฟล์หรือมีปัญหากับการแตกไฟล์ในตัวจัดการแพคเกจ';
...
$_lang['setting_default_per_page_desc'] = 'ค่าตัวเลขปริยายของผลลัพธ์ที่จะแสดงในกริดทั้งหมดของผู้จัดการ';
...
$_lang['setting_enable_dragdrop'] = 'เปิดการใช้งาน ลาก/วางในแผนผังแหล่งข้อมูล/อีเลเมนต์';
$_lang['setting_enable_dragdrop_desc'] = 'ถ้าปิด จะส่งผลให้การลากและวางในแผนผังแหล่งข้อมูลและอีเลเมนต์ไม่สามารถใช้งานได้';
...
$_lang['setting_extension_packages'] = 'แพคเกจส่วนขยาย';
$_lang['setting_extension_packages_desc'] = 'เครื่องหมายจุลภาคจะเป็นตัวแบ่งรายการของแพคเกจที่จะโหลดขึ้นมาทำงาน โดยมีรูปแบบเป็น packagename:pathtomodel';
...
$_lang['setting_filemanager_url_desc'] = 'เป็นตัวเลือกเสริม ตั้งค่านี้ถ้าคุณต้องการตั้ง URL ที่ชัดเจนในการเข้าถึงไฟล์ในตัวจัดการไฟล์ของ MODx ว่ามาจากไหน(มีประโยชน์ถ้าคุณต้องเปลี่ยน filemanager_path เป็นเส้นทางที่อยู่นอก MODx webroot) โปรดตรวจดูให้แน่ใจว่านี่คือ the web-accessible URL ของการตั้งค่าค่าของ filemanager_path ถ้าปล่อยส่วนนี้ว่างไว้  MODx จะลองคำนวณค่าให้อัตโนมัติ';
...
$_lang['setting_friendly_alias_lowercase_only'] = 'กำหนดใช้นามแฝงด้วยตัวพิมพ์เล็ก';
$_lang['setting_friendly_alias_lowercase_only_desc'] = 'กำหนดว่าจะอนุญาตให้ใช้ได้แค่ตัวพิมพ์เล็กในนามแฝงของแหล่งข้อมูล';

$_lang['setting_friendly_alias_max_length'] = 'กำหนดขนาดสูงสุดของนามแฝง';
$_lang['setting_friendly_alias_max_length_desc'] = 'ถ้าค่ามากกว่าศุนย์จะเป็นขนาดสูงสุดของอักขระที่อนุญาตในการตั้งนามแฝงของแหล่งข้อมูล ถ้าใส่ศูนย์จะเป็นการตั้งว่าไม่จำกัด';

$_lang['setting_friendly_alias_restrict_chars'] = 'กำหนดขั้นตอนการจำกัดลักษณะของนามแฝง';
$_lang['setting_friendly_alias_restrict_chars_desc'] = 'ขั้นตอนนี้ใช้ในการจำกัดอักขระที่ใช้ในนามแฝงของแหล่งข้อมูล "pattern" อนุญาตให้ RegEx pattern ถูกใช้บริการ, "legal" อนุญาตให้อักขระ URL ที่ถูกต้องใดๆ  ก็ได้, "alpha" อนุญาตเฉพาะตัวอักษรที่เป็นพยัญชนะ, และ "alphanumeric" อนุญาตเฉพาะตัวอักษรที่เป็นตัวเลข';

$_lang['setting_friendly_alias_restrict_chars_pattern'] = 'กำหนดรูปแบบการจำกัดอักขระของนามแฝง';
$_lang['setting_friendly_alias_restrict_chars_pattern_desc'] = 'รูปแบบ RegEx ที่ถูกต้องสำหรับการจำกัดอักขระที่ใช้ในนามแฝงของแหล่งข้อมูล';

$_lang['setting_friendly_alias_strip_element_tags'] = 'กำหนด Alias Strip Element Tags';
$_lang['setting_friendly_alias_strip_element_tags_desc'] = 'กำหนดว่าการแท็กอิเลเมนต์ควรจะไม่ถูกปกปิดจากนามแฝงของแหล่งข้อมูล';

$_lang['setting_friendly_alias_translit'] = 'กำหนดการทับศัพท์ของนามแฝง';
$_lang['setting_friendly_alias_translit_desc'] = 'ขั้นตอนของการทับศัพท์เพื่อใช้บนนามแฝงที่ระบุของแหล่งข้อมูล การปล่ยว่างไว้หรือ "none" เป็นค่าปริยายซึ่งจะข้ามการทับศัพท์ ส่วนค่าที่เป็นบวกอื่นๆ คือ "iconv" (ถ้ามีใช้ได้) หรือตั้งชื่อตารางการทับศัพท์ตามที่มีให้ในคลาสให้บริการการทับศัพท์';
...
$_lang['setting_friendly_alias_trim_chars'] = 'กำหนดการตัดอักขระของนามแฝง';
$_lang['setting_friendly_alias_trim_chars_desc'] = 'อักขระที่จะถูกตัดออกจากส่วนท้ายของนามแฝงที่ถูกใช้งาน';
...
$_lang['setting_friendly_alias_word_delimiter'] = 'ตัวคั่นคำของนามแฝง';
$_lang['setting_friendly_alias_word_delimiter_desc'] = 'ตัวคั่นคำที่อยากใช้สำหรับคั่นนามแฝง';

$_lang['setting_friendly_alias_word_delimiters'] = 'ตัวคั่นนามแฝง';
$_lang['setting_friendly_alias_word_delimiters_desc'] = 'อักขระซึ่งจะเป็นตัวทำหน้าที่เป็นตัวแทนของตัวคั่นคำเมื่อประมวลผลนามแฝง อักขระนี้จะถูกแปลงและรวบรวมเป็นตัวคั่นคำของนามแฝง';
...
$_lang['setting_phpthumb_cache_source_enabled'] = 'ไฟล์แคชซอร์สของ phpThumb';
$_lang['setting_phpthumb_cache_source_enabled_desc'] = 'ทำการแคชซอร์สไฟล์ไม่ว่ามันจะถูกโหลดหรือไม่ก็ตาม เราแนะนำว่าควรปิด';
...
$_lang['setting_topmenu_show_descriptions_desc'] = 'ถ้าตั้งเป็น \'ไม่\' MODx จะซ่อนคำอธิบายของไอเท็มของท็อปเมนูในส่วนของผู้จัดการ';
...
$_lang['setting_welcome_screen_url_desc'] = 'URL สำหรับหน้าจอต้อนรับที่จะโหลดขึ้นมาตอนแรกที่โหลด MODx Revolution.';
