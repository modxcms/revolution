...
$_lang['setting_filemanager_path'] = 'เส้นทางตัวจัดการไฟล์ (Deprecated)';
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. IIS บ่อยครั้งที่ไม่ populate the document_root setting properly, ซึ่งถูกใช้โดยตัวจัดการไฟล์เพื่อกำหนดว่าคุณสามารถดูอะไรได้ ถ้าคุณกำลังมีปัญหาในการใช้ตัวจัดการไฟล์ ตรวจสอบให้แน่ใจว่าเส้นทางนี้ชี้ไปยังรากของการติดตั้ง MODX ของคุณ.';
