...
$_lang['setting_syncsite_default'] = 'Check Empty Cache Checkbox';
$_lang['setting_syncsite_default'] = 'If set to Yes, the Empty Cache checkbox in the Settings tab of a resource will be checked by default';
