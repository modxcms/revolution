...
$_lang['setting_extension_packages_desc'] = 'A JSON array of packages to load on MODX installation. In the format [{"packagename":{"path":"path/to/package"}},{"anotherpackagename":{"path":"path/to/otherpackage"}}]';
