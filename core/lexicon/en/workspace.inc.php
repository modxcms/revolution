...
$_lang['dir_err_assets'] = 'Your assets/ directory was not able to be created at: [[+path]] <br />You will need to create this directory and make it writable if you want to use Package Management or 3rd-Party Extras.';
$_lang['dir_err_assets_comp'] = 'Your assets/components/ directory was not able to be created at: [[+path]] <br />You will need to create this directory and make it writable if you want to use Package Management or 3rd-Party Extras.';
$_lang['dir_err_core_comp'] = 'Your core/components/ directory was not able to be created at: [[+path]] <br />You will need to create this directory and make it writable if you want to use Package Management or 3rd-Party Extras.';
$_lang['download'] = 'Download';
$_lang['download_success'] = 'The Package was downloaded successfully!';
$_lang['downloaded'] = 'Downloaded';
$_lang['downloading'] = 'Downloading...';
$_lang['download_extras'] = 'Download Packages';
...
$_lang['packages_desc'] = 'Packages are collections of MODX extras that can be used within MODX in a variety of ways. Here you can manage them, update their installation status, disable or enable installed packages, or download new ones from remote providers.';
...
$_lang['preexisting_mode_preserve_desc'] = 'This will uninstall the newer version, keeping the prior, but also will keep any new settings or values for the extra.';
...
$_lang['provider_home_title'] = 'Download Packages';
...
$_lang['providers_desc'] = 'Providers are repositories for MODX extra packages. They are remote URLs that contain lists of MODX packages that you can download and install extras from.';
