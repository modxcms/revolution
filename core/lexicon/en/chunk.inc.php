...
$_lang['chunk_err_id_not_found'] = 'Chunk with ID %s not found!';
$_lang['chunk_err_locked'] = 'Chunk is locked.';
$_lang['chunk_err_not_specified_name'] = 'Please specify a name.';
...
$_lang['chunk_err_not_found'] = 'Chunk not found!';
