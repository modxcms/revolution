...
$_lang['access_contextgroup_create'] = 'Add Context Group Access';
$_lang['access_contextgroup_err_ae'] = 'An ACL for that Context Group already exists!';
$_lang['access_contextgroup_err_nf'] = 'Context Group ACL not found.';
$_lang['access_contextgroup_err_ns'] = 'Context Group ACL not specified.';
$_lang['access_contextgroup_err_remove'] = 'An error occurred while trying to delete the Context Group ACL.';
$_lang['access_contextgroup_remove'] = 'Delete Context Group Access';
$_lang['access_contextgroup_update'] = 'Edit Context Group Access';
...
$_lang['user_group_contextgroup_access'] = 'Context Groups';
$_lang['user_group_contextgroup_access_msg'] = 'Grant access to all Contexts in a Context Group with one ACL. Useful for multilingual sites where editors need every language in a site group. The first ACL on a group closes those Contexts to users without matching Context or Context Group access.';
$_lang['user_group_contextgroup_authority_desc'] = 'The minimum Role that will have access to the Permissions in the selected Policy for Contexts in this group. Roles with stronger Authority (lower numbers) will inherit this access as well. Most situations can leave this at "Member".';
$_lang['user_group_contextgroup_context_group_desc'] = 'The Context Group to grant access to. All Contexts assigned to this group receive the Policy.';
$_lang['user_group_contextgroup_policy_desc'] = 'The Policy to apply to member Contexts of this group for this User Group. This will grant all Users in this User Group with the selected minimum Role all the Permissions in the Policy.';
$_lang['user_group_contextgroup_remove_confirm'] = 'Are you sure you want to delete this Context Group ACL from this User Group?';
$_lang['context_group_add'] = 'Add Context Group';
