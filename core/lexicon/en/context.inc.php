...
$_lang['context_group'] = 'Context Group';
$_lang['context_group_all'] = 'All Context Groups';
...
$_lang['context_group_err_save'] = 'An error occurred while saving the Context Group.';
$_lang['context_group_filter'] = 'Filter by Context Group';
$_lang['context_group_none'] = 'Ungrouped';
$_lang['context_groups'] = 'Context Groups';
$_lang['context_groups_management_message'] = 'Create and order Context Groups. Assign Contexts to a group when editing a Context, then use the Resource tree switcher (when enabled) to show one group at a time.';
