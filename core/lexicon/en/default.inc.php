...
$_lang['tv_default_desc'] = 'The value to output if the user leaves this TV blank.';
$_lang['tv_default_datetime'] = 'Default Date and Time';
...
$_lang['tv_default_tag'] = 'Default Tag';
