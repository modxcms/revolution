...
$_lang['setting_search_max_results'] = 'Max Search Results';
$_lang['setting_search_max_results_desc'] = 'Number of results to show for each element type in the menu bar search';
