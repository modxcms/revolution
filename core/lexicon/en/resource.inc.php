...
$_lang['resource_exclude_alias_in_childs'] = 'Do not use in URL';
$_lang['resource_exclude_alias_in_childs_help'] = 'If enabled, the alias of the resource will not participate in the formation of the child resource URL';
