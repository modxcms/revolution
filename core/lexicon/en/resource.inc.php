...
$_lang['resource_folder_help'] = 'When enabled this will make the resource also act as a container for other resources. A \'container\' is like a folder, only it can also children resources.';
