...
$_lang['login_new_password_note'] = 'Please confirm your new password by entering it twice.';
...
$_lang['login_signup_email'] = '<p>Hello, [[+username]]!</p><p>An account was registered for you on the <strong>[[++site_name]]</strong> website. If you do not know your password, [[++allow_forgot_password:is=`1`:then=`reset it using the forgot password link on login screen`:else=`ask your Site Administrator`]].</p><p class="center"><a href="[[+url_scheme]][[+http_host]][[+manager_url]]" class="btn">Log into [[++site_name]]</a></p>';
