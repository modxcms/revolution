...
$_lang['login_activation_key_err'] = 'Activation key does not match! Please check your activation e-mail and make sure you loaded the right URL.';
...
$_lang['login_password_reset_act_sent'] = 'Password Reset Activation e-mail sent. Please check your inbox.';
$_lang['login_remember'] = 'Remember me';
$_lang['login_send_activation_email'] = 'Send Activation E-mail';
$_lang['login_title'] = 'MODX CMF Manager Login';
$_lang['login_user_err_nf_email'] = 'User not found with that e-mail or username. Please try again.';
$_lang['login_username'] = 'Username';
$_lang['login_username_or_email'] = 'Username or E-mail';
