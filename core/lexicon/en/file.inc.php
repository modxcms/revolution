...
$_lang['file_folder_enter_new'] = 'Enter Directory Name';
...
$_lang['file_folder_err_invalid_path'] = 'Invalid path to create the new directory in.';
$_lang['file_folder_err_nf'] = 'Directory does not exist!';
