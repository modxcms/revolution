...
$_lang['tv_access_msg'] = 'Select the resource groups that are allowed to modify the content or value of this Template Variable.';
...
$_lang['tv_err_duplicate_error'] = 'An error occurred while trying to duplicate the template variable.';
...
$_lang['tv_err_exists_name'] = 'A template variable already exists with this name.';
$_lang['tv_err_locked'] = 'Template variable locked!';
$_lang['tv_err_nf'] = 'Template variable not found.';
$_lang['tv_err_nfs'] = 'Template variable not found with key: %s';
$_lang['tv_err_ns'] = 'Template variable not specified.';
$_lang['tv_err_not_found'] = 'Template variable not found!';
