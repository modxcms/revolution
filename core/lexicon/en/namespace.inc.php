...
$_lang['namespace_assets_path_desc'] = 'Specify an absolute path to the assets for this Namespace here. You may use placeholders like {assets_path}. Example: {assets_path}components/demoextra/';
$_lang['namespace_name_desc'] = 'Specify a name for the Namespace here.';
$_lang['namespace_path'] = 'Core Path';
$_lang['namespace_path_desc'] = 'Specify an absolute path to the core for this Namespace here. You may use placeholders like {core_path}. Example: {core_path}components/demoextra/';
...
$_lang['namespaces_desc'] = 'Namespaces are global identifiers for packages and extras, registering their vehicles, lexicon entries and resources all together.';
