...
$_lang['extjs_version'] = '<a href="https://docs.sencha.com/extjs/3.4.0/" target="_blank">ExtJS</a> Version';
$_lang['simplepie_version'] = '<a href="https://github.com/simplepie/simplepie" target="_blank">SimplePie</a> Version';
$_lang['xpdo_version'] = '<a href="http://xpdo.org" target="_blank">xPDO</a> Version';
$_lang['parsedown_version'] = '<a href="http://parsedown.org" target="_blank">Parsedown</a> Version';
$_lang['phpmailer_version'] = '<a href="https://github.com/PHPMailer/PHPMailer" target="_blank">PHPMailer</a> Version';
$_lang['phpthumb_version'] = '<a href="http://phpthumb.sourceforge.net" target="_blank">phpThumb</a> Version';
