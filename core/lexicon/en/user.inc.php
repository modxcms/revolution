...
$_lang['user_backup_email'] = 'Backup email';
$_lang['user_backup_email_desc'] = 'Alternative email for passwordless login when the primary email is unavailable.';
...
$_lang['user_err_backup_email_same'] = 'Backup email cannot be the same as the primary email.';
