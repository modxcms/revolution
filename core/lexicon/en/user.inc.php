...
$_lang['user_settings_desc'] = 'You can override any of the settings available System --> System Settings menu on a per-user basis, or you can create new settings available only to this user.';
