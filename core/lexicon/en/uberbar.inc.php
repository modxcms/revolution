...
/* Errors */
$_lang['uberbar_error_onknown_element_header'] = '<strong>Error:</strong> Unknown element';
$_lang['uberbar_error_onknown_element_msg'] = 'You are searching for an unknown element: <strong>{element}</strong>. Please check your syntax.';
