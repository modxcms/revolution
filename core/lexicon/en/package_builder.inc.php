...
$_lang['package_build_xml_desc'] = 'Please select a valid build XML file for your extra.';
...
$_lang['resolver_source_desc'] = 'The absolute path of the source of the resolver. If it is a file resolver, select the directory of the files you\'d like to copy. If a PHP Script, specify the script. Example: <br /><br />/public_html/modx/_build/components/demoextra/';
