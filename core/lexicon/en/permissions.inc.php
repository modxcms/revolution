...
$_lang['perm.edit_context_desc'] = 'To edit any Contexts. **WARNING: exposes Context Settings which can override security-related System Settings, such as uploadable file types and API credentials.';
...
$_lang['perm.edit_snippet_desc'] = 'To edit any Snippets. **WARNING: combined with save_snippet permissions, grants ability to execute arbitrary server-side code.';
$_lang['perm.edit_template_desc'] = 'To edit any Templates.';
$_lang['perm.edit_tv_desc'] = 'To edit any Template Variables. **WARNING: combined with save_tv permissions, grants access to execute TV Bindings, which can be used to expose secrets such as passwords and System Settings.';
$_lang['perm.edit_user_desc'] = 'To edit any User. **WARNING: exposes User Settings which can override security-related System Settings, such as uploadable file types and API credentials.';
...
$_lang['perm.file_update_desc'] = 'To update the content of physical files. **WARNING: grants ability to execute arbitrary server-side code.';
...
$_lang['perm.settings_desc'] = 'To view and edit any System Settings. **WARNING: secrets such as API keys are commonly stored in System Settings. User may change uploadable file types, allowing execution of arbitrary code.';
...
$_lang['perm.usergroup_edit_desc'] = 'To edit a User Group. **WARNING: exposes UserGroup Settings which can override security-related System Settings, such as uploadable file types and API credentials.';
