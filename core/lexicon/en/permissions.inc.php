 ...
 * @subpackage lexicon
 */
$_lang['perm.access_permissions_desc'] = 'Pages and actions under Access that use this key (Resource Groups, ACLs, Flush Permissions). The Access parent menu uses menu_access.';
...
$_lang['perm.error_log_view_desc'] = 'To view the Error Log under Reports (menu item, system/event page, and ErrorLog processors).';
$_lang['perm.file_create_desc'] = 'To create a file.';
$_lang['perm.file_list_desc'] = 'To list files within a given physical directory.';
$_lang['perm.file_manager_desc'] = 'To use the Media Browser (and related file manager actions). The Media parent menu uses menu_media.';
...
$_lang['perm.menu_site_desc'] = 'Show the main menu item "Content".';
$_lang['perm.menu_system_desc'] = 'Show the main menu item "Gear" (System). Does not grant the System Settings page; that uses settings.';
$_lang['perm.menu_trash_desc'] = 'Show the main menu item "Trash Manager".';
$_lang['perm.menu_user_desc'] = 'Show the main menu item "User".';
$_lang['perm.menus_desc'] = 'To view and manage Gear → Menus (system/action page and Menu processors).';
...
$_lang['perm.settings_desc'] = 'To view and edit System Settings. The Gear parent menu uses menu_system. <strong>WARNING: secrets such as API keys are commonly stored in System Settings. User may change uploadable file types, allowing execution of arbitrary code.</strong>';
