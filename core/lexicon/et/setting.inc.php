...
$_lang['setting_filemanager_path'] = 'Failide Manageri Path (Deprecated)';
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. IIS tihtipeale ei täida document_root välja õigesti, mida ksutatakse faili manageri poolt. Kui teil on probleeme faili managerigia, kontrollige, et see oath oleks õige root kataloogi peale, kui asub teie MODX installatsioon..';
$_lang['setting_filemanager_path_relative'] = 'Kas Is Faili Manager Path on Relatiivne? (Deprecated)';
$_lang['setting_filemanager_path_relative_desc'] = 'Deprecated - Use Media Sources instead. Kui teie filemanager_path seade on relatiivne MODX base_path suhtes, siis palun määrake see sede Jah asendisse. Kui teie filemanager_path on väljaspool docroot-i, määrakse see Ei peale.';
$_lang['setting_filemanager_url'] = 'Failide Manageri Url (Deprecated)';
$_lang['setting_filemanager_url_desc'] = 'Deprecated - Use Media Sources instead. Valikuline. Määra juhul, kui soovite määrata kindla URL-i, et juurdepääseda failidele Failide Manageri kaudu (kasulik, kui olete filemanager_path määranud kataloogi peale, mis asub väljaspool MODX webroot-i). Olge kindlad, et see on veebist ligipääsetav URL vastavalt filemanager_path seade väärtusele. Kui jätate tühjaks, siis MODX üritab automaatselt selle välja arvutada.';
$_lang['setting_filemanager_url_relative'] = 'On Faili Manager URL Relatiivne? (Deprecated)';
$_lang['setting_filemanager_url_relative_desc'] = 'Deprecated - Use Media Sources instead. Kui teie filemanager_url seade on relatiivne MODX base_url suhtes, siis palun määrake see seade jah asendisse. Kui teie filemanager_url on väljaspool põhi webroot-i, määrakse see Ei asendisse.';
