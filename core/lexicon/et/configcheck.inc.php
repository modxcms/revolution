...
$_lang['configcheck_configinc_msg'] = 'Teie leht on haavatav häkkerite poolt, kes võivad palju kahju teha sellele lehele. Palun muuda config fail ainult loetavaks (read-only)! Kui Te ei ole lehe administraator, siis palun teavitage süsteemi administraatorit ja edastage see sõnum! Fail asub [[+path]]';
...
$_lang['configcheck_installer_msg'] = 'Kataloog setup/ sisaldab MODX installerit. Kujuta ette, mis võib juhtuda, kui võõras leiab selle kausta ja jooksutab installerit! Ta arvatavasti ei jõuaks kaugele, kuna ta peab sisestama informatsiooni andmebaasi kasutaja kohta aga ikkagi parim oleks eemaldada see kaust serverist. It is located at: [[+path]]';
