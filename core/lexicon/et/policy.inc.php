...
$_lang['permission_err_remove'] = 'Tekkis viga selle õiguse eemaldamisel.';
$_lang['permission_err_save'] = 'Tekkis viga selle õiguse salvestamisel.';
$_lang['permission_new'] = 'Uus Õigus';
$_lang['permission_remove'] = 'Eemalda Õigus';
$_lang['permission_remove_confirm'] = 'Oled kindel, et soovid eemaldada selle õiguse?';
$_lang['permission_update'] = 'Uuenda Õigust';
...
$_lang['policy_err_remove'] = 'Tekkis viga Poliisi eemaldadamisl.';
...
$_lang['policy_property_new'] = 'Uus Poliisi Omadus';
...
$_lang['policy_remove_confirm'] = 'Oled kindel, et soovid eemaldada selle juudepääsu poliisi?';
$_lang['policy_remove_multiple'] = 'Eemalda Poliisid';
$_lang['policy_remove_multiple_confirm'] = 'Olete kindel, et soovite eemaldada need Juurdepääsu Poliisid? See tegevus on pöördumatu.';
$_lang['policy_update'] = 'Uuenda Juudepääsu Poliisi';
$_lang['policy_template'] = 'Poliisi Template';
$_lang['policy_template.desc'] = 'Poliisi Template deineerib millised Õiguseid ilmuvad Õiguste tabelis, kui muudetakse spetsiifilist Poliisi. Võite lisada või eemaldada spetsiifilisi Õigusi sellest templatest allpool. Pange tähele, et Õiguse eemaldamisel Templatest eemaldab selle kõikidest Poliisidest, mis rakendavad seda templatet.';
...
$_lang['policy_template_err_remove'] = 'Tekkis viga Poliisi Template eemaldamisel.';
...
$_lang['policy_template_remove_confirm'] = 'Olete kindel, et soovite eemaldada selle Poliisi Template? See eemaldab kõik Poliisid, mis on seotud selle Templatega - see võib lõhkuda teie MODX installaatsiooni, kui aktiivsed Poliisid kasutavad seda Templatet.';
$_lang['policy_template_remove_multiple'] = 'Eemalda Valitud Poliisi Templated';
$_lang['policy_template_remove_multiple_confirm'] = 'Olete kindel, et soovite eemaldada need Poliisi Templated? See eemaldab kõik Poliisid, mis on seotud nende Templatetega - see võib lõhkuda teie MODX installaatsiooni, kui aktiivsed Poliisid kasutavad neid Templatesid.';
$_lang['policy_template_update'] = 'Uuenda Poliisi Templatet';
