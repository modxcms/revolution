...
$_lang['is_static_msg'] = 'يدل على أن مصدر العنصر مخزن في ملف خارجي.';
...
$_lang['properties_export'] = 'تصدير الخصائص';
$_lang['properties_import'] = 'استيراد الخصائص';
$_lang['property_preprocess'] = 'وسوم قبل المعالجة ضمن قيم الخاصية';
$_lang['property_preprocess_msg'] = 'اذا كان مفعل، الوسوم في الخاصية الافتراضية/قيم مجموعة الخاصية سوف تتم معالجتها قبل أن يتم استخدامهن من أجل معالجة العناصر.';
$_lang['static_file'] = 'ملف ثابت';
$_lang['static_file_msg'] = 'موقع ملف خارجي حيث مصدر العنصر مخزن.';
$_lang['static_source'] = 'مصدر الوسائط من أجل ملف ثابت';
$_lang['static_source_msg'] = 'مودكس سوف يستخدم مصدر الوسائط كمسار رئيسي عندما يبحث عن ملف العنصر الثابت. عندما تستخدم "لا شيء" سوف يفترض أنك مخصص مسار ثابت.';
$_lang['tv_elements'] = 'خيارات قيم الدخل';
$_lang['tv_default'] = 'القيم الافتراضية';
$_lang['tv_type'] = 'أنواع الدخل';
$_lang['tv_output_type'] = 'نوع الإخراج';
$_lang['tv_output_type_properties'] = 'خصائص نوع الإخراج';
$_lang['static_file_ns'] = 'يجب أن تحدد ملف ثابت.';