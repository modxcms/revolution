...
$_lang['dashboard_description_desc'] = 'وصف مختصر للوحة التحكم.';
...
$_lang['dashboard_hide_trees_desc'] = 'اختيار هذا سوف يخفي الأشجار على اليسار عندما يتم عرض لوحة التحكم في صفحة الترحيب.';
$_lang['dashboard_name_desc'] = 'اسم لوحة التحكم.';
...
$_lang['dashboard_err_ae_name'] = 'لوحة التحكم ذات الاسم [[name+]] موجودة مسبقاً! الرجاء حاول باسم آخر.';
$_lang['dashboard_err_duplicate'] = 'حصل خطأ أثناء محاولة تكرار لوحة التحكم.';
$_lang['dashboard_err_name_reserved'] = 'The dashboard name “[[+reservedName]]” is reserved. Please choose another name.';
$_lang['dashboard_err_nf'] = 'لوحة المعلومات غير موجودة.';
$_lang['dashboard_err_ns'] = 'لوحة التحكم غير محددة.';
$_lang['dashboard_err_ns_name'] = 'الرجاء تخصيص اسم للشريط.';
...
$_lang['dashboard_err_save'] = 'حصل خطأ أثناء محاولة حفظ لوحة التحكم.';
$_lang['dashboard_usergroup_add'] = 'إسناد لوحة تحكم إلى مجموعة مستخدم';
...
$_lang['widget_err_nf'] = 'لم يتم العثور على الشريط!';
$_lang['widget_err_ns'] = 'لم يتم تحديد الشريط!';
$_lang['widget_err_ns_name'] = 'الرجاء تخصيص اسم للشريط.';
$_lang['widget_err_remove'] = 'An error occurred while trying to delete the Widget.';
$_lang['widget_err_save'] = 'حصل خطأ أثناء محاولة حفظ الشريط.';
$_lang['widget_file'] = 'ملف';
$_lang['widget_dashboards.intro_msg'] = 'بالأسفل يوجد قائمة بكافة لوحات التحكم التي تم وضع هذه الشريط فيها.';
...
$_lang['widget_namespace'] = 'فضاء الأسماء';
$_lang['widget_namespace_desc'] = 'فضاء الأسماء الذي سيتم تحميل الشريط عليه. مفيد للمسارات المخصصة.';
...
$_lang['w_newsfeed_desc'] = 'عرض مزود اخبار مودكس';
$_lang['w_recentlyeditedresources'] = 'المصادر المعدلة مؤخراً';
$_lang['w_recentlyeditedresources_desc'] = 'تظهر لائحة بالمصادر التي تم التعديل عليها مؤخرا من قبل المستخدم.';
