...
$_lang['setting_filemanager_path'] = 'Chemin du gestionnaire de fichier (Deprecated)';
$_lang['setting_filemanager_path_desc'] = 'Deprecated - Use Media Sources instead. Souvent, IIS ne détermine pas correctement l\'option document_root, qui est utilisé par le gestionnaire de fichier pour déterminer ce que vous pouver explorer. Si vous avez des problèmes en utilisant le gestionnaire de fichier, assurez-vous que ce chemin pointe vers la racine de votre installation MODX.';
$_lang['setting_filemanager_path_relative'] = 'Le chemin vers le gestionnaire de fichier est-il relatif? (Deprecated)';
$_lang['setting_filemanager_path_relative_desc'] = 'Deprecated - Use Media Sources instead. Si votre paramètre filemanager_path est relatif à base_path, veuillez sélectionner Oui. Si votre paramètre filemanager_path est en dehors du docroot, veuillez sélectionner non.';
$_lang['setting_filemanager_url'] = 'Adresse du gestionnaire de fichier (Deprecated)';
$_lang['setting_filemanager_url_desc'] = 'Deprecated - Use Media Sources instead. Optionel. Définissez ce paramètre pour utiliser une URL spécifique afin d\'accèder aux fichiers depuis le gestionnaire de fichier de MODX (utile si vous avez changé filemanager_path pour un répertoire en dehors de la racine web de MODX). Assurez-vous que ce paramètre soit l\'URL du paramètre filemanager_path. Laissez vide pour que MODX essaie de déterminer ce paramètre.';
$_lang['setting_filemanager_url_relative'] = 'URL du gestionnaire de ficher relative? (Deprecated)';
$_lang['setting_filemanager_url_relative_desc'] = 'Deprecated - Use Media Sources instead. Si votre paramètre filemanager_url est relatif à base_url, veuillez alors sélectionner oui. Si votre paramètre filemanager_url est en dehors de la racine web, sélectionnez non.';
