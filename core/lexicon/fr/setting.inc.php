...
$_lang['setting_login_allowed_ip_desc'] = 'Entrez l\'adresse IP depuis laquelle cet utilisateur peut se connecter. <strong>NOTE: Séparez les différentes adresses IP par une virgule (,)</strong>';
...
$_lang['setting_auto_check_pkg_updates_desc'] = 'Si \'Oui\' est sélectionné, MODX vérifiera automatiquement la présence de mise à jour des packages dans le gestionnaire de packages. Cela ralentit le chargement de la grille.';
...
$_lang['setting_blocked_minutes_desc'] = 'Entrez ici le nombre de minutes qu\'un utilisateur sera bloqué s\'il atteint le nombre maximal de tentatives de connexions. Veuillez n\'entrer qu\'un nombre (pas de virgule, espace, etc.)';

$_lang['setting_cache_action_map'] = 'Activer la mise en cache de "plan d\'action"';
$_lang['setting_cache_action_map_desc'] = 'Activé, les actions (ou plans de contrôleurs) seront mises en cache pour réduire le temps de chargement des pages du manager.';

$_lang['setting_cache_alias_map'] = 'Activer la mise en cache des alias';
$_lang['setting_cache_alias_map_desc'] = 'Si activé, les URIs des ressources seront mises en cache dans le Contexte. Pour des raisons de performance il est conseillé de n\'activer cette option que pour de "petits" sites.';
...
$_lang['setting_cache_db_session_lifetime_desc'] = 'Cette valeur (en secondes) définie le délai de mise en cache des sessions (in the DB result-set cache).';
...
$_lang['setting_cache_resource_desc'] = 'La mise en cache partiel de ressource est configurable par ressource quand cette fonction est activée. Désactiver cette fonction la désactive globalement.';
...
$_lang['setting_editor_css_path_desc'] = 'Indiquez le chemin vers votre fichier CSS que vous souhaitez utiliser à l\'intérieur de votre éditeur de texte riche. Le meilleur moyen est d\'entrer le chemin depuis la racine de votre serveur, par exemple : /assets/site/style.css. Si vous ne souhaitez pas charger une feuille de style dans votre éditeur de texte riche, laissez ce champ vide.';
...
$_lang['setting_enable_dragdrop_desc'] = 'Active ou désactive le glisser-déposer dans l\'arborescence de ressources et d\'éléments.';
...
$_lang['setting_failed_login_attempts_desc'] = 'Nombre de tentatives échouées de connexion qu\'un utilisateur est autorisé à commettre avant d\'être \'bloqué\'.';
...
$_lang['setting_filemanager_path_relative'] = 'Le chemin vers le gestionnaire de fichiers est-il relatif?';
...
$_lang['setting_filemanager_url'] = 'Adresse du gestionnaire de fichiers';
$_lang['setting_filemanager_url_desc'] = 'Optionel. Définissez ce paramètre pour utiliser une URL spécifique afin d\'accéder aux fichiers depuis le gestionnaire de fichier de MODX (utile si vous avez changé filemanager_path pour un répertoire en dehors de la racine web de MODX). Assurez-vous que ce paramètre soit l\'URL du paramètre filemanager_path. Laissez vide pour que MODX essaie de déterminer ce paramètre.';
...
$_lang['setting_forgot_login_email_desc'] = 'Le modèle de l\'email qui est envoyé quand un utilisateur a oublié ses identifiants et/ou mots de passe de MODX.';
...
$_lang['setting_lock_ttl_desc'] = 'Nombre de secondes qu\'une ressource restera verrouillée lorsque l\'utilisateur l\'éditant est inactif.';

$_lang['setting_log_level'] = 'Niveau de log';
$_lang['setting_log_level_desc'] = 'Le niveau par défaut de log; plus le niveau est bas, moins les informations seront log. Options disponibles : 0 (FATAL), 1 (ERROR), 2 (WARN), 3 (INFO) et 4 (DEBUG).';
...
$_lang['setting_mail_smtp_helo_desc'] = 'Défini les messages HELO du SMTP (nom d\'hôte par défaut).';
...
$_lang['setting_mail_smtp_keepalive_desc'] = 'Évite que la connexion SMTP soit fermée après chaque envoi d\'email. Non recommandé.';
...
$_lang['setting_mail_smtp_single_to_desc'] = 'Donne la possibilité d\'effectuer un champ TO individuel, au lieu d\'envoyer à toutes les adresses TO.';

$_lang['setting_mail_smtp_timeout'] = 'Timeout SMTP';
$_lang['setting_mail_smtp_timeout_desc'] = 'Défini le délai de timeout en second du serveur SMTP. Cette fonction ne fonctionne pas sur win32.';
...
$_lang['setting_manager_date_format_desc'] = 'Le format de chaine de caractères, au format PHP date(), pour les dates représentées dans le manager.';
...
$_lang['setting_manager_html5_cache_desc'] = 'Expérimental. Active le cache local HTML5 pour le manager. Recommandé uniquement avec l\'utilisation de navigateurs récents (supportant le cache HTML5).';
...
$_lang['setting_modx_browser_default_viewmode'] = 'Vue des fichiers';
$_lang['setting_modx_browser_default_viewmode_desc'] = 'La vue d\'affichage des fichiers par défaut lors de l\'utilisation de la popup du navigateur de fichier dans le manager. Les valeurs acceptées sont : grid, list.';
...
$_lang['setting_rb_base_dir_desc'] = 'Entrez le chemin physique du navigateur de ressource. Cette option est généralement générée automatique. Cependant, si vous utilisez IIS, MODX peut ne pas trouver le chemin d\'accès par lui même, entrainant un message d\'erreur dans la navigateur de ressource. Dans ce cas, veuillez entrer le chemin d\'accès du répertoire d\'images (comme vous le verriez dans l\'explorateur Windows). <strong>NOTE:</strong> Le répertoire de ressource doit contenir les sous-répertoires images, files, flash et média afin que le navigateur de ressource fonctionne correctement.';
...
$_lang['setting_upload_files_desc'] = 'Ici vous pouvez indiquer une liste de fichiers qui peuvent être uploadés dans \'assets/files/\' en utilisant le gestionnaire de ressource. Veuillez entrer les extensions pour chaque type de fichier, séparées par des virgules.';

$_lang['setting_upload_flash'] = 'Types de fichiers Flash uploadables';
$_lang['setting_upload_flash_desc'] = 'Ici vous pouvez indiquer une liste de fichiers qui peuvent être uploadés dans \'assets/flash/\' en utilisant le gestionnaire de ressource. Veuillez entrer les extensions pour chaque type de fichier flash, séparées par des virgules.';

$_lang['setting_upload_images'] = 'Types d\'images uploadables';
$_lang['setting_upload_images_desc'] = 'Ici vous pouvez indiquer une liste de fichiers qui peuvent être uploadés dans \'assets/images/\' en utilisant le gestionnaire de ressource. Veuillez entrer les extensions pour chaque type d\'images, séparées par des virgules.';

$_lang['setting_upload_maxsize'] = 'Taille maximale des uploads';
$_lang['setting_upload_maxsize_desc'] = 'Entrez la taille maximale des fichiers qui peuvent être uploadés via le gestionnaire de fichiers. La taille doit être indiquée en octects (bytes). <strong>NOTE: Les fichiers volumineux peuvent demander beaoucp de temps pour être uploadés!</strong>';

$_lang['setting_upload_media'] = 'Types de média uploadables';
$_lang['setting_upload_media_desc'] = 'Ici vous pouvez indiquer une liste de fichiers qui peuvent être uploadés dans \'assets/média/\' en utilisant le gestionnaire de ressource. Veuillez entrer les extensions pour chaque type de média, séparées par des virgules.';
...
$_lang['setting_use_browser'] = 'Activer le navigateur de ressource';
$_lang['setting_use_browser_desc'] = 'Sélectionnez oui pour activer le navigateur de ressource. Ceci autorisera vos utilisateurs à naviguer et uploader des ressources, telles que des images, du flash et d\'autres fichiers média sur le serveur.';
