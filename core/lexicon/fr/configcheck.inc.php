...
$_lang['configcheck_cache_msg'] = 'MODX ne peut pas écrire dans le répertoire de cache. MODX fonctionnera toujours comme prévu, mais la mise en cache n\'aura pas lieu. Pour résoudre ce problème, rendez le répertoire /cache/ accessible en écriture.';
