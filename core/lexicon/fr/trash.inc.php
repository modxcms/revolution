...
$_lang['trash.purge_all'] = 'Supprimer tout';
$_lang['trash.restore_all'] = 'Tout rétablir';
$_lang['trash.selected_purge'] = 'Purger les ressources sélectionnées';
$_lang['trash.selected_restore'] = 'Restaurer les ressources sélectionnées';
$_lang['trash.purge'] = 'Purger la ressource';
$_lang['trash.purge_confirm_title'] = 'Purger la(les) ressource(s) ?';
$_lang['trash.purge_confirm_message'] = 'Voulez-vous vraiment supprimer les ressources suivantes ? Cette action est irréversible.<hr>[[+list]]';
$_lang['trash.purge_all_confirm_message'] = 'Voulez-vous vraiment supprimer définitivement les [[+count]] ressources listées ?<br><br><strong>Ceci ne peut pas être annulé, et cela affecte toutes les ressources actuellement mises à la corbeille dans la grille.</strong><hr>[[+list]]';
$_lang['trash.purge_all_empty_status'] = '[[+count]] ressource(s) ont été purgées définitivement.';
$_lang['trash.purge_err_delete'] = '[[+count]] ressources n\'ont pas été purgées à cause d\'erreurs : [[+list]]';
$_lang['trash.purge_err_nothing'] = 'Rien n\'a été purgé, aucune erreur n\'est survenue.';
$_lang['trash.purge_success_delete'] = '[[+count]] ressource(s) purgée(s) définitivement.';
