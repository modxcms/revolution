...
$_lang['trash.purge_all'] = 'Tout supprimer';
$_lang['trash.restore_all'] = 'Tout rétablir';
$_lang['trash.selected_purge'] = 'Supprimer les ressources sélectionnées';
$_lang['trash.selected_restore'] = 'Restaurer les ressources sélectionnées';
$_lang['trash.purge'] = 'Erase';
$_lang['trash.purge_confirm_title'] = 'Effacer la/les ressource(s) ?';
...
$_lang['trash.purge_err_delete'] = '[[+count]] ressources n\'ont pas été effacées à cause d\'erreurs : [[+list]]';
$_lang['trash.purge_err_nothing'] = 'Rien n\'a été effacé, aucune erreur n\'est survenue.';
