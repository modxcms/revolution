...
$_lang['widget_err_ae_name'] = 'Un widget nommé "[[+name]]"  existe déjà ! Merci d\'essayer un autre nom.';
...
$_lang['widget_permission'] = 'Autorisation';
...
$_lang['widget_remove_confirm'] = 'Êtes-vous sûr de vouloir supprimer ce widget du tableau de bord ? Cette opération est irréversible et supprimera le Widget de tous les tableaux de bord.';
$_lang['widget_remove_multiple_confirm'] = 'Êtes-vous sûr de vouloir supprimer ces widgets du tableau de bord ? Cette opération est irréversible et supprimera les Widgets de tous les tableaux de bord.';
...
$_lang['widget_size_half'] = 'Moitié (50%)';
