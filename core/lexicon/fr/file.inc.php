...
$_lang['file_open'] = 'Ouvrir l\'Url de fichier';
$_lang['file_err_ae'] = 'Le fichier %s existe déjà';
$_lang['file_err_visibility_ns'] = 'Merci de spécifier la visibilité, public ou privée';
...
$_lang['file_folder_enter_new'] = 'Entrez le nom du dossier';
...
$_lang['file_folder_copy_path'] = 'Copier le chemin du dossier';
...
$_lang['file_folder_err_perms_parent'] = 'Le serveur web n\'a pas les permissions nécessaires pour créer un répertoire.';
...
$_lang['file_folder_remove_confirm'] = 'Êtes-vous sûr de vouloir supprimer le répertoire&nbsp;: "[[+directory]]"?<br />Cela pourrait potentiellement casser votre site web.';
...
$_lang['file_remove_confirm'] = 'Êtes-vous sûr de vouloir supprimer le fichier&nbsp;: "[[+file]]"?<br />Supprimer un fichier pourrait potentiellement casser votre site web. Assurez vous d\'avoir une sauvegarde avant de le supprimer.';
