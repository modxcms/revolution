...
$_lang['file_folder_parent_desc'] = 'Relatif au répertoire basePath du Media Source';
$_lang['file_folder_remove'] = 'Supprimer le répertoire';
$_lang['file_folder_remove_confirm'] = 'Etes-vous sûre de vouloir supprimer le répertoire : "[[+directory]]" ?<br />Cela pourrait potentiellement rendre votre site web inutilisable.';
...
$_lang['file_remove_confirm'] = 'Etes-vous sûre de vouloir supprimer le fichier : "[[+file]]" ?<br />Supprimer certains fichiers peut rendre inutilisable votre site web. Assurez vous de savoir à quoi sert ce fichier avant de le supprimer.';
