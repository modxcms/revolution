...
$_lang['action_err_remove'] = 'Une erreur s\'est produite lors de la suppression de l\'action.';
$_lang['action_err_save'] = 'Une erreur s\'est produite lors de l\'enregistrement de l\'action.';
$_lang['action_none'] = 'Aucune action';
$_lang['action_parent_err_nf'] = 'Le parent de cette action est introuvable!';
$_lang['action_parent_err_ns'] = 'Le parent de cette action n\'est pas spécifié!';
$_lang['action_place_here'] = 'Placer une action ici';
$_lang['action_remove'] = 'Supprimer l\'action';
...
$_lang['lang_topics'] = 'Langue du sujet';
$_lang['lang_topics_desc'] = 'Ceci est une liste de chaînes de caractères qui représentent des sujets de lexique que cette action doit charger.';