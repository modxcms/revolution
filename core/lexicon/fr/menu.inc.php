...
$_lang['menu_confirm_remove'] = 'Êtes-vous sûr de vouloir supprimer cette action du menu ?';
...
$_lang['menu_err_remove'] = 'Une erreur est survenue lors de la suppression de l\'action du menu.';
...
$_lang['menu_remove'] = 'Supprimer l\'élément du menu';
