...
$_lang['access_category_create'] = 'Ajout d\'un accès à la catégorie';
...
$_lang['access_err_remove'] = 'Une erreur est survenue en essayant de supprimer l\'ACL';
...
$_lang['access_permissions_documents_tab'] = 'Ici vous pouvez voir quels groupes de documents ont été mis en place. Vous pouvez également créer de nouveaux groupes, renommer des groupes, supprimer des groupes et voir quels documents sont dans les différents groupes (survolez l\'identifiant du document pour voir son nom). Pour ajouter un document à un groupe ou supprimer un document d\'un groupe, éditez le document directement.';
...
$_lang['access_permissions_links_tab'] = 'C\'est ici que nous spécifions quels groupes d\'utilisateurs ont un accès (c\'est-à-dire peuvent modifier ou créer des enfants) pour les groupes de documents. Pour lier un groupe de documents à un groupe d\'utilisateurs, sélectionnez le groupe dans la liste déroulante, puis cliquez sur \'Lien\'. Pour supprimer le lien pour un groupe donné, appuyez sur \'Supprimer ->\'. Cela supprimera immédiatement le lien.';
...
$_lang['access_permissions_users_tab'] = 'Ici vous pouvez voir quels groupes d\'utilisateurs ont été configurés. Vous pouvez également créer de nouveaux groupes, renommer des groupes, supprimer des groupes et voir quels utilisateurs sont membres des différents groupes. Pour ajouter un nouvel utilisateur à un groupe ou pour supprimer un utilisateur d\'un groupe, éditez l\'utilisateur directement.';
...
$_lang['access_rgroup_err_remove'] = 'Une erreur est survenue lors de la suppression de l\'ACL du groupe de ressources.';
...
$_lang['access_source_update'] = 'Modifier l\'accès au Media Source';
...
$_lang['resource_group_access_remove'] = 'Supprimer la ressource du groupe';
$_lang['resource_group_access_remove_confirm'] = 'Êtes-vous sûr de vouloir supprimer cette ressource du groupe de ressources?';
...
$_lang['resource_group_resource_err_remove'] = 'Une erreur est survenue en essayant de supprimer la ressource du groupe de ressources.';
$_lang['resource_group_untitled'] = 'Groupe de ressources sans titre';
$_lang['resource_group_update'] = 'Modifier le groupe de ressources';
...
$_lang['resource_group_automatic_access_desc'] = 'Note : Vous devrez peut-être purger les sessions après avoir créé le groupe de ressources si vous cochez l\'une des options ci-dessous.';
...
$_lang['user_group_aw_desc'] = 'Remarque : Vous devrez peut-être vider les sessions après avoir créé le groupe d\'utilisateurs si vous cochez l\'une des options ci-dessous.';
...
$_lang['user_group_category_access'] = 'Catégories d\'éléments';
$_lang['user_group_category_access_msg'] = 'Définir les catégories d\'éléments auxquelles ce groupe d\'utilisateurs peut accéder.';
...
$_lang['user_group_category_remove_confirm'] = 'Êtes-vous sûr de vouloir supprimer cette catégorie de ce groupe d\'utilisateurs ?';

$_lang['user_group_context_access'] = 'Contextes';
$_lang['user_group_context_access_msg'] = 'Définissez les contextes auxquels ce groupe d\'utilisateurs peut accéder.';
...
$_lang['user_group_context_remove_confirm'] = 'Êtes-vous sûr de vouloir supprimer ce contexte de ce groupe d\'utilisateurs ?';

$_lang['user_group_resourcegroup_access'] = 'Groupes de ressources';
$_lang['user_group_resourcegroup_access_msg'] = 'Définir les groupes de ressources auxquels ce groupe d\'utilisateurs peut accéder.';
...
$_lang['user_group_resourcegroup_remove_confirm'] = 'Êtes-vous sûr de vouloir supprimer ce groupe de ressources de ce groupe d\'utilisateurs ?';
...
$_lang['user_group_source_access_msg'] = 'Définissez les Media Sources auxquelles ce groupe d\'utilisateurs peut accéder.';
...
$_lang['user_group_source_remove_confirm'] = 'Êtes-vous sûr de vouloir supprimer ce Media Source de ce groupe d\'utilisateurs ?';
...
$_lang['user_group_namespace_access'] = 'Espaces de noms';
$_lang['user_group_namespace_access_desc'] = 'Définissez les espaces de noms auxquels ce groupe d\'utilisateurs peut accéder.';

$_lang['user_group_namespace_namespace_desc'] = 'The Namespace to grant access to.';
$_lang['user_group_namespace_authority_desc'] = 'Le rôle minimum requis pour avoir accès aux permissions de la règle sélectionnée. Les rôles avec une forte autorité (les nombres les plus bas) héritent également de ces permissions. Dans la plupart des cas, vous pouvez laisser « Member ».';
