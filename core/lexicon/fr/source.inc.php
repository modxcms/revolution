...
$_lang['prop_file.basePath_desc'] = 'Le chemin du fichier vers lequel la source doit être dirigée, par exemple : assets/images/<br>Le chemin peut dépendre du paramètre "basePathRelative".';
...
$_lang['prop_file.baseUrl_desc'] = 'L\'URL à partir de laquelle on peut accéder à cette source, par exemple : assets/images/<br>Le chemin peut dépendre du paramètre "baseUrlRelative".';
$_lang['baseUrlPrependCheckSlash'] = 'Vérification de l\'ajout de slash en tête de l\'URL de base';
