...
$_lang['package_details_for'] = 'Détails du paquet : [[+package]]';
...
$_lang['packages_desc'] = 'Les paquets sont des collections de composants pour MODX qui peuvent être utilisés de plusieurs façons dans MODX. Ici vous pouvez les gérer, mettre à jour leurs statuts d\'installation, activer ou désactiver ceux installés ou en télécharger de nouveaux depuis des fournisseurs.';
$_lang['please_wait'] = 'Veuillez patienter…';
$_lang['preexisting_mode_preserve'] = 'Préserver';
$_lang['preexisting_mode_preserve_desc'] = 'Ceci désinstallera la version la plus récente en conservant l\'ancienne, mais conservera la nouvelle configuration ou valeur pour le composant.';
...
$_lang['preexisting_mode_restore_desc'] = 'Ceci va restaurer les options de la version antérieure telles qu\'elles étaient avant l\'installation de la nouvelle version.';
...
$_lang['provider_err_no_client'] = '<p><b>Vous ne possédez pas de client REST viable pour votre système.</b></p><p>Veuillez installer l\'extension PHP cURL ou activer fsockopen puis essayer de nouveau.';
