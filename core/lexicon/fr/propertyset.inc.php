...
$_lang['properties_import_err_upload'] = 'Veuillez spécifier un fichier de propriétés valide à charger.';
...
$_lang['property_name_desc'] = 'Nom de la propriété qui sera accessible via : [[+propertyName]]';
...
$_lang['property_xtype_desc'] = 'Type de champ de la propriété.';
$_lang['propertyset'] = 'Ensemble de propriétés';
$_lang['propertyset_add'] = 'Ajouter un jeu de propriétés';
$_lang['propertyset_create'] = 'Créer un jeu de propriétés';
$_lang['propertyset_create_new'] = 'Créer un jeu de propriétés';
$_lang['propertyset_duplicate'] = 'Dupliquer le jeu de propriétés';
$_lang['propertyset_duplicate_copyels'] = 'Copier les associations de l\'élément ?';
$_lang['propertyset_element_add'] = 'Attacher un élément au jeu de propriétés';
...
$_lang['propertyset_err_associate'] = 'Une erreur est survenue lors de l\'association du jeu de propriété à l\'élément.';
$_lang['propertyset_err_create'] = 'Une erreur est survenue lors de la création du jeu de propriétés.';
$_lang['propertyset_err_element_add'] = 'Une erreur est survenue lors de l\'association de l\'élément au jeu de propriétés.';
...
$_lang['propertyset_new'] = 'Créer un jeu de propriétés';
$_lang['propertyset_panel_desc'] = 'Ici vous pouvez créer un jeu de propriétés ou en sélectionner un existant pour l\'attacher à cet élément.';
