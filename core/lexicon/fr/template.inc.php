...
$_lang['template_assignedtv_tab'] = 'TV assignées';
...
$_lang['template_icon_description'] = 'Optionnel. Une classe d\'icône CSS personnalisée pour toutes les ressources utilisant ce modèle. Par exemple une classe Font Awesome (gratuit) comme icon-home ou fa-home.';
...
$_lang['template_source_description'] = 'Le Media Source pour sélectionner un fichier statique ou un aperçu. L\'utilisation de "None" supposera que vous spécifiez un chemin absolu.';
$_lang['template_preview'] = 'Prévisualisation du modèle';
$_lang['template_preview_description'] = 'Une capture d\'écran du modèle à utiliser comme aperçu dans le sélecteur de modèles. La taille idéale est 335x236px (lxh)';
