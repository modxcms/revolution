...
require_once MAGPIE_DIR . 'magpierss.class.php';
require_once MAGPIE_DIR . 'rsscache.class.php';
...
function fetch_rss ($url) {
    ...
    // else cache is ON
        ...
        if ( $cache_status == 'STALE' ) {
            $rss = $cache->get( $cache_key );
            if ( $rss and isset($rss->etag) and !empty($rss->etag) and isset($rss->last_modified) and !empty($rss->last_modified) ) {                $request_headers['If-None-Match'] = $rss->etag;
