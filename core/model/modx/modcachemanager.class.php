...
class modCacheManager extends xPDOCacheManager {
    ...
    public function generateActionMap($cacheKey, array $options = array()) {
        ...
        $c->select(array(
            $this->modx->escape('modAction') . '.*',
            $this->modx->escape('Namespace') . '.' . $this->modx->escape('name') . ' AS ' . $this->modx->escape('namespace_name'),
            $this->modx->escape('Namespace') . '.' . $this->modx->escape('path') . ' AS ' . $this->modx->escape('namespace_path')
        ));
