...
class modDashboardWidget extends xPDOSimpleObject
{
    ...
    public function toArray($keyPrefix = '', $rawValues = false, $excludeLazy = false, $includeRelated = false)
    {
        ...
        if (!empty($this->xpdo->lexicon) && $this->xpdo->lexicon instanceof modLexicon) {
            ...
            $array['name_trans'] = $this->xpdo->lexicon->exists($this->get('name'))
                ? $this->xpdo->lexicon($this->get('name')) : $this->get('name');
            $array['description_trans'] = $this->xpdo->lexicon->exists($this->get('description'))
                ? $this->xpdo->lexicon($this->get('description')) : $this->get('description');
        }
