        ...
        switch ($this->get('rule')) {
            case 'fieldVisible':
                if (!$this->get('value')) {
                    ...
                    $rule = 'MODx.hideField("' . $this->get('container') . '",' . json_encode($fields) . ');';
                }
                break;
            case 'fieldLabel':
            case 'fieldTitle':
                ...
                $rule = 'MODx.renameLabel("' . $this->get('container') . '",' . json_encode($fields) . ',' . json_encode($values) . ');';
                break;
            case 'panelTitle':
            case 'tabTitle':
            case 'tabLabel':
            ...
            case 'tvMove':
                ...
                $rule = 'MODx.moveTV(' . json_encode($tvs) . ',"' . $this->get('value') . '");';
                break;
            default:
                break;
        }
