...
class GetList extends modObjectGetListProcessor
{
    ...
    public function getData()
    {
        ...
        $pkgList = $this->modx->call('MODX\Transport\modTransportPackage', 'listPackages', [
            &$this->modx,
    ...
    public function prepareRow(xPDOObject $object)
    {
        ...
        $packageArray['textaction'] = empty($packageArray['installed']) ? $this->modx->lexicon('install')
