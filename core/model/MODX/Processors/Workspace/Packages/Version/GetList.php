...
class GetList extends modObjectGetListProcessor
{
    ...
    public function getData()
    {
        ...
        $pkgList = $this->modx->call('transport.modTransportPackage', 'listPackageVersions', [&$this->modx, $criteria, $limit > 0
            ? $limit : 0, $this->getProperty('start')]);
    ...
    public function parseVersion(modTransportPackage $package, array $packageArray)
    {
        ...
        $packageArray['name'] = !empty($packageArray['package_name']) ? $packageArray['package_name']
            : $signatureArray[0];
    ...
    public function prepareMenu(modTransportPackage $package, array $packageArray)
    {
        ...
        $packageArray['textaction'] = $notInstalled ? $this->modx->lexicon('install')
            : $this->modx->lexicon('uninstall');
