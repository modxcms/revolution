...
class Create extends modObjectCreateProcessor
{
    ...
    protected function addAdminAccess(array $contexts = [])
    {
        ...
        $adminGroup = $this->modx->getObject('modUserGroup', ['name' => 'Administrator']);
    ...
    {
        /** @var modAccessPolicy $policy */
        $policy = $this->modx->getObject('modAccessPolicy', ['name' => 'Load, List and View']);
        if (!$policy) return false;
    ...
    protected function addParallelUserGroup(array $contexts = [])
    {
        ...
        $userGroup = $this->modx->getObject('modUserGroup', [
    ...
    protected function addOtherUserGroups(array $userGroupNames = [], array $contexts = [])
    {
        ...
        foreach ($userGroupNames as $userGroupName) {
            /** @var modUserGroup $userGroup */
            $userGroup = $this->modx->getObject('modUserGroup', ['name' => trim($userGroupName)]);
