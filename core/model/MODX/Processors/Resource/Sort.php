...
class Sort extends modProcessor
{
    ...
    public function fixParents($node)
    {
        ...
        if (!empty($oldParent)) {
            $oldParentChildrenCount = $this->modx->getCount('modResource', ['parent' => $oldParent->get('id'), 'id:!=' => $node->id]);
