...
class Duplicate extends modObjectDuplicateProcessor
{
    ...
    {
        $duplicatedSettings = [];
        $settings = $this->modx->getCollection('modContextSetting', [
    ...
    {
        $duplicatedACLs = [];
        $permissions = $this->modx->getCollection('modAccessContext', [
    ...
    {
        $duplicatedElements = [];
        $mediaSourcesElements = $this->modx->getCollection('sources.modMediaSourceElement', [
            'context_key' => $this->object->get('key'),
        ]);
