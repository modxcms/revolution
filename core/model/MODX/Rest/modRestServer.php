...
class modRestServer
{
    ...
    /**
     * @var array|string $error The current error message
     * @access protected
     */
    ...
    public function authenticate()
    {
        ...
        /** @var modUser $user */
        $user = $this->modx->getObject('MODX\modUser', [
     ...
     * @return string
     */
    public function deny($message, array $data = [])
    {
     ...
     * @return string
     */
    public function error($message = '', $data = [], $type = '404')
    {
        $this->error = true;
    ...
    public function encode($data, $root = '')
    {
        ...
        switch ($format) {
            ...
            default:
                ...
                if (is_array($data)) {
                    $list = $data;
                } elseif ($data instanceof xPDOObject) {
                    $list = $data->toArray();
                }
     ...
     * @return string
     */
    private function _err404($scriptProperties = [])
    {
