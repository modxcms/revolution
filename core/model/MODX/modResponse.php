...
class modResponse
{
    ...
    public function outputContent(array $options = [])
    {
        ...
        if (!$this->contentType->get('binary')) {
            ...
            $this->modx->parser->processElementTags('', $this->modx->resource->_output, true, false, '[[', ']]', [], $maxIterations);
            $this->modx->parser->processElementTags('', $this->modx->resource->_output, true, true, '[[', ']]', [], $maxIterations);
