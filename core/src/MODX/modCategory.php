    ...
    public function findPolicy($context = '')
    {
        ...
        if ($enabled) {
            if (empty($this->_policies) || !isset($this->_policies[$context])) {
                $aclSelectColumns = $this->xpdo->getSelectColumns('modAccessCategory', 'modAccessCategory', '', ['id', 'target', 'principal', 'authority', 'policy']);
                ...
                $c->sortby($this->xpdo->getSelectColumns('modCategoryClosure', 'CategoryClosure', '', ['depth']) . ' DESC, ' . $this->xpdo->getSelectColumns('modAccessCategory', 'modAccessCategory', '', ['authority']) . ' ASC', '');
