...
class Sort extends modProcessor
{
    ...
    {
        return $this->modx->hasPermission(['usergroup_save' => true]);
    }
    ...
    public function sortUsers(array $data)
    {
        ...
        foreach ($users as $userArray) {
            ...
            if ($userArray['new_group'] != 0 && $userArray['new_group'] != $userArray['old_group']) {
                ...
                $membership = $this->modx->getObject('modUserGroupMember', [
                ...
                if ($membership->save()) {
                    ...
                    if (!empty($userArray['old_group'])) {
                        ...
                        $oldMembership = $this->modx->getObject('modUserGroupMember', [
