 ...
 */
class UpdateRemote extends modProcessor
{
    ...
    {
        $this->modx->log(MODX::LOG_LEVEL_INFO, $this->modx->lexicon('package_update_info_provider_scan', ['provider' => $this->provider->get('name')]));
