...
namespace MODX\Processors\Resource\ResourceGroup;
...
class GetList extends modProcessor
{
    ...
    public function process()
    {
        ...
        $resourceGroupList = $this->resource->getGroupsList([$this->getProperty('sort') => $this->getProperty('dir')], $isLimit
            ? $this->getProperty('limit') : 0, $this->getProperty('start'));
