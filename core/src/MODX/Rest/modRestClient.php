...
class modRestClient
{
     ...
     *
     * @return modRestResponse|bool The response object.
     */
    public function request($host, $path, $method = 'GET', array $params = [], array $options = [])
    {
        ...
        $responseClass = $this->modx->getOption(modRestClient::OPT_RESPONSE_CLASS, $this->config, 'MODX\Rest\modRestResponse');
