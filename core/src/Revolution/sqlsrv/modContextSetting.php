...
class modContextSetting extends \MODX\Revolution\modContextSetting
{
    ...
    public static function listSettings(
        ...
        $c->leftJoin(\MODX\Revolution\modLexiconEntry::class, 'Entry', "'setting_' + modContextSetting.{$xpdo->escape('key')} = Entry.name");
        $c->leftJoin(\MODX\Revolution\modLexiconEntry::class, 'Description', "'setting_' + modContextSetting.{$xpdo->escape('key')} + '_desc' = Description.name");
        $c->where($criteria);
