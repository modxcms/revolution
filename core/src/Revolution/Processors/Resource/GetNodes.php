    ...
    public function prepareContextNode(modContext $context)
    {
        ...
        return [
            ...
            'settings' => [
                ...
                'show_in_tree_default' => $context->getOption('show_in_tree_default'),
                'hide_children_in_tree_default' => $context->getOption('hide_children_in_tree_default'),
                'alias_visible_default' => $context->getOption('alias_visible_default'),
            ],
            'leaf' => false,
            'cls' => implode(' ', $class),
