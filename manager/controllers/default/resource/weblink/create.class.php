...
class WebLinkCreateManagerController extends ResourceCreateManagerController {
    ...
    public function loadCustomCssJs() {
        ...
        $this->modx->regClientStartupScript($mgrUrl.'assets/modext/widgets/resource/modx.panel.resource.weblink.js');
        $this->modx->regClientStartupScript($mgrUrl.'assets/modext/sections/resource/weblink/create.js');
