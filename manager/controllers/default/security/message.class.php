...
class SecurityMessageManagerController extends modManagerController {
    ...
    public function loadCustomCssJs() {
        ...
        $this->modx->regClientStartupScript($mgrUrl.'assets/modext/widgets/security/modx.grid.message.js');
        $this->modx->regClientStartupScript($mgrUrl.'assets/modext/sections/security/message/list.js');
    }
