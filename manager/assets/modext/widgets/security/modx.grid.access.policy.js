        ...
        columns: [this.sm, {
            ...
            renderer: {
                fn: function(value, metaData, record) {
                    const renderValue = MODx.util.Render.translatedValue('name', record.json);
            ...
            renderer: {
                fn: function(value, metaData, record) {
                    const renderValue = MODx.util.Render.translatedValue('description', record.json);
                    // eslint-disable-next-line no-param-reassign
                    metaData.css = this.setEditableCellClasses(record, [record.json.isProtected]);
            ...
            renderer: {
                fn: function(value, metaData, record) {
                    const
                        renderValue = MODx.util.Render.translatedValue('template_name', record.json, false),
                        objPermissions = record.json.permissions
                    ;
                    // console.log('tpl record', record);
        ...
        tbar: [
            {
                ...
                menu: [{
                    ...
                    handler: this.removeSelected.createDelegate(this, ['policy', 'Security/Access/Policy/RemoveMultiple', 'int']),
                    scope: this
                }],
                listeners: {
                    render: {
...
MODx.combo.AccessPolicyTemplate = function(config = {}) {
    Ext.applyIf(config, {
        ...
        tpl: new Ext.XTemplate(
            '<tpl for="."><div class="x-combo-list-item"><span style="font-weight: bold">{name:htmlEncode}</span>',
